...
<div id="settings-container" class="content-inner">
	...
	<div id="yui-main" >
              	<div class="content-header">
	               	<h1><s:text name="profile.page.yourprofile" /></h1>
				</div>
			<div id="tabs">
                     	<ul>
                         	<li><a href="#tabs-1"><s:text name="profile.page.general" /></a></li>
                     	</ul>
                      <div id="tabs-1">
                      	<fieldset>
						...
						<ul>
							...
							<fieldset>
 							...
 							<fieldset>
                             	...
                             	<ul>
									...
									<li class="checkbox">
										...
										<label><s:text name="action.pagesize.dialog.preferences" /></label>
									</li>
									-->
                             	</ul>
 							</fieldset>
 							<sec:authorize access="hasAnyRole('ROLE_Role.Admin', 'ROLE_Role.System Operator', 'ROLE_Role.Customer Support')">	
	                          	<fieldset>
	                              	<legend><s:text name="profile.page.monitorrequeststatus" /></legend>
	                               <ul id="prompt-monitor">
		                                <li class="radio monitor"><input type="radio" value="1" name="monitor"/><label><s:text name="profile.page.alwaysmonitor" /></label></li>
		                                <li class="radio monitor"><input type="radio" value="2" name="monitor"/><label><s:text name="profile.page.alwaysdismiss" /> <a id="user-profile-event-history" href="process/ajax.processPageAction.action" class="alist"><s:text name="profile.page.eventhistory" /></a> </label></li>
		                                <li class="radio monitor"><input type="radio" value="3" name="monitor" checked="checked" /><label><s:text name="profile.page.promptme" /></label></li>
	                               </ul>
								</fieldset>
							</sec:authorize>
                          <fieldset>
					...
					<form id="user-form" name="userForm" class="register" method="post" action="#" >
                              <fieldset>
                                <legend>Change Password</legend> 
                                    ...
                                    <ul>
                          			<li class="submit-row"><a id="user-profile-save" href="#" class="button save-profile-main"><s:text name="profile.page.save" /></a> <s:text name="profile.page.or" /> <a id="user-profile-cancel" href="profile/ajax.list.action" class="cancel alist"><s:text name="profile.page.cancel" /></a></li>
                                    </ul>                                
