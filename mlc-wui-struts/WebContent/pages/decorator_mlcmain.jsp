...
<ul class="first-of-type">
	...
	<li><a id="menu-dicionario" class="alist"
		href="<s:url includeParams="none" value="dicionario/ajax.list.action"/>"
		title="<s:text name="menu.main.dicionario"/>"><s:text
		name="menu.main.dicionario" /></a></li>
	<li><a id="menu-table" class="alist"
		href="<s:url includeParams="none" value="dicionario/ajax.list.table.action"/>"
		title="<s:text name="menu.main.table"/>"><s:text
		name="menu.main.table" /></a></li>
</ul>
</div>
</div>
</div>
