$(document).ready(function() {
	...
	$.ajax({
		dataType    : 'json',
		type        : "POST",
		url         : "user/fillUserContext.action",
		async       : false,
		success     : function(oData) {
			sensus.settings.userContext = oData;
		}
	});
	...
	$.ajax({
		dataType    : 'json',
		type        : "POST",
		url         : "systemsettings/fillEnuns.action",
		async       : false,
		success     : function(oData) {
			sensus.settings.enums = oData;
		}
	});
	...
	var sDefaultUrl  = 'dashboard/ajax.list.action',
		sContainer   = $('#load'),
