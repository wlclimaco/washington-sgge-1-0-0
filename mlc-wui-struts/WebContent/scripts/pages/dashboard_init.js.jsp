...
$(document).ready(function() {
	...
	$.address.parameter('di', $.datepicker.formatDate(sensus.settings.dateFormatMask, new Date(), null, true));
	$.address.parameter('de', $.datepicker.formatDate(sensus.settings.dateFormatMask, new Date(), null, true));
