...
<div class="status-viewport">
	<div class="point-detail-container sunrise-sunset">
		<div class="alarms point-detail-container ">
			<h3><div class="left"><s:text name="smartpointdetail.status.alerts" /></div>
				<sec:authorize access="hasAnyRole('ROLE_Role.Admin', 'ROLE_Role.System Operator')">
					<a id="light-clear-all" href="#" class="button small right clear-all"><s:text name="smartpointdetail.status.clearall" /></a>
				</sec:authorize>
			</h3>      
