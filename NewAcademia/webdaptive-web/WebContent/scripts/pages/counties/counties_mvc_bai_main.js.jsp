...
(function($)
{
	function RemoteModel()
	{
		...
		function callRefreshWS(_i)
		{
			...
			rest_post_call('qat-webdaptive/county/api/refreshBAI', oData, fill_data, process_error);
		}
		</sec:authorize>
		...
		function callFetchWS()
		{
			...
			if (viewLoadedObject == null)
			{
				...
				rest_post_call('qat-webdaptive/county/api/fetchAllBAI', oData, fill_data, process_error);
			}
			else
			{
...
<sec:authorize access="hasRole('ROLE_DOMAIN ADMINS')">
$('#refreshcountiesBAI').click(function() {
	ciloader.callRefreshWS(16);
});
</sec:authorize>
$('#listcountiesBAI').click(function() {
