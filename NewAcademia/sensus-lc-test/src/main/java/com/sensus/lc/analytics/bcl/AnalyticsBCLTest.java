...
public class AnalyticsBCLTest extends AbstractTestBaseBusiness
{
	...
	public void testParseAnalyticsGroupAlarm()
	{
		...
		originalList.add(new AnalyticsGroupAlarm(ANALYTICS_GROUP_3, WOODSTOCK, ANALYTICS_GROUP_5, ANALYTICS_GROUP_6,
				ANALYTICS_GROUP_11));
	...
	public void testParseAnalyticsGroupWarning()
	{
		...
		originalList.add(new AnalyticsGroupWarning(ANALYTICS_GROUP_3, WOODSTOCK, ANALYTICS_GROUP_5, ANALYTICS_GROUP_6,
				ANALYTICS_GROUP_11));
	...
	public void testParseAnalyticsGroupTypeLight()
	{
		...
		originalList.add(new AnalyticsGroupTypeLight(2, I5, ANALYTICS_GROUP_3_0, ANALYTICS_GROUP_4_0,
				ANALYTICS_GROUP_5_0, ANALYTICS_GROUP_12_0));
		originalList.add(new AnalyticsGroupTypeLight(ANALYTICS_GROUP_3, WOODSTOCK, ANALYTICS_GROUP_5_0,
				ANALYTICS_GROUP_6_0, ANALYTICS_GROUP_7_0, ANALYTICS_GROUP_18_0));
	...
	public void testParseAnalyticsGroupCarbonCredits()
	{
		...
		originalList.add(new AnalyticsGroupCarbonCredits(1, BEAVERTON, 1.0, 2.0, ANALYTICS_GROUP_3_0,
				ANALYTICS_GROUP_4_0));
		originalList.add(new AnalyticsGroupCarbonCredits(2, I5, ANALYTICS_GROUP_3_1, ANALYTICS_GROUP_4_2,
				ANALYTICS_GROUP_5_0, ANALYTICS_GROUP_6_0));
		originalList.add(new AnalyticsGroupCarbonCredits(ANALYTICS_GROUP_3, WOODSTOCK, ANALYTICS_GROUP_5_1,
				ANALYTICS_GROUP_6_7, ANALYTICS_GROUP_7_0, ANALYTICS_GROUP_8_2));
	...
	public void testGenerateFileCSV()
	{
		...
		request.setFileName(TestBaseUtil.FILE_NAME);
		request.setUserContext(inquiryAnalyticsRequest.getUserContext());
		request.getUserContext().setLocaleString(TIME_ZONE);
		request.setProcessId(new Integer(1));
		request.setInquiryAnalyticsRequest(inquiryAnalyticsRequest);
		CSVInternalResponse response = getAnalyticsBCL().generateFileCSV(request);
		assertNotNull(response);
		...
		request.setProcessId(new Integer(1));
		request.setInquiryAnalyticsRequest(inquiryAnalyticsRequest);
		response = getAnalyticsBCL().generateFileCSV(request);
		assertNotNull(response);
		assertNotNull(response.getFileName());
	...
	{
		AnalyticsRequest request = TestBaseUtil.createAnalyticsRequest();
		request.setGroup(new AnalyticsGroup(10));

		InternalResponse response = getAnalyticsBCL().insertAnalyticsSummarized(request);
		TestBaseUtil.assertResponse(response);
	}

	@Test
	public void testUdateAnalyticsAlarmWarning()
	{
		AnalyticsRequest request = TestBaseUtil.createAnalyticsRequest();
		getAnalyticsBCL().updateAnalyticsAlarmWarning(request);
	}

	@Test
	public void testfetchAllGroupsByTenantForDashboard()
	{
		Tenant tenant = TestBaseUtil.createTenant();
		InternalResultsResponse<AnalyticsGroup> response = getAnalyticsBCL().fetchAllGroupsByTenantForDashboard(tenant);
	...
	public void testinsertCSVProcess()
	{
		...
		ProcessResponse response = getAnalyticsBCL().insertCSVProcess(request);
