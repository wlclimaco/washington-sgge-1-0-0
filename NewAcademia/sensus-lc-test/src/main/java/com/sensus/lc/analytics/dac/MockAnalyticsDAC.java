...
public class MockAnalyticsDAC extends AbstractMockBase implements IAnalyticsDAC
{
	 ...
	 * (non-Javadoc)
	 * @see
	 * com.sensus.lc.analytics.dac.IAnalyticsDAC#fetchAnalyticsAlarmsByStatusId(com.sensus.lc.analytics.model.request
	 * .AnalyticsRequest)
	 */
	@Override
	 ...
	 * (non-Javadoc)
	 * @see
	 * com.sensus.lc.analytics.dac.IAnalyticsDAC#fetchAnalyticsAlertsByType(com.sensus.lc.analytics.model.request.
	 * AnalyticsRequest)
	 */
	@Override
	 ...
	 * (non-Javadoc)
	 * @see
	 * com.sensus.lc.analytics.dac.IAnalyticsDAC#fetchAllAnalyticsInstalledByGroup(com.sensus.lc.analytics.model.request
	 ...
	 * (non-Javadoc)
	 * @see
	 * com.sensus.lc.analytics.dac.IAnalyticsDAC#fetchAllAnalyticsConsumptionByGroup(com.sensus.lc.analytics.model
	 ...
	 * (non-Javadoc)
	 * @see
	 * com.sensus.lc.analytics.dac.IAnalyticsDAC#fetchAllAnalyticsAlarmsByGroup(com.sensus.lc.analytics.model.request
	 * .InquiryAnalyticsRequest)
	 */
	@Override
	 ...
	 * (non-Javadoc)
	 * @see
	 * com.sensus.lc.analytics.dac.IAnalyticsDAC#fetchAllAnalyticsWarningsByGroup(com.sensus.lc.analytics.model.request
	 * .InquiryAnalyticsRequest)
	 */
	@Override
	 ...
	 * (non-Javadoc)
	 * @see
	 * com.sensus.lc.analytics.dac.IAnalyticsDAC#fetchAllAnalyticsCarbonCreditsByGroup(com.sensus.lc.analytics.model
	 ...
	 * (non-Javadoc)
	 * @see
	 * com.sensus.lc.analytics.dac.IAnalyticsDAC#fetchAllAnalyticsInstalledByDate(com.sensus.lc.analytics.model.request
	 * .AnalyticsRequest)
	 */
	@Override
	 ...
	 * (non-Javadoc)
	 * @see
	 * com.sensus.lc.analytics.dac.IAnalyticsDAC#fetchAllAnalyticsAlarmsByDate(com.sensus.lc.analytics.model.request
	 * .AnalyticsRequest)
	 */
	@Override
	 ...
	 * (non-Javadoc)
	 * @see
	 * com.sensus.lc.analytics.dac.IAnalyticsDAC#fetchAllAnalyticsWarningsByDate(com.sensus.lc.analytics.model.request
	 * .AnalyticsRequest)
	 */
	@Override
	 ...
	 * (non-Javadoc)
	 * @see
	 * com.sensus.lc.analytics.dac.IAnalyticsDAC#fetchAllAnalyticsConsumptionByDate(com.sensus.lc.analytics.model.
	 ...
	 * (non-Javadoc)
	 * @see
	 * com.sensus.lc.analytics.dac.IAnalyticsDAC#fetchAllAnalyticsCarbonCreditsByDate(com.sensus.lc.analytics.model
	...
	/*
	 * (non-Javadoc)
	 * @see com.sensus.lc.analytics.dac.IAnalyticsDAC#fetchDashboarHeader(com.sensus.lc.analytics.model.request.
	...
	/*
	 * (non-Javadoc)
	 * @see com.sensus.lc.analytics.dac.IAnalyticsDAC#fetchDashboardResume(com.sensus.lc.analytics.model.request.
	 * AnalyticsRequest, java.lang.Double)
	 */
	@Override
			...
			Double metricOfCOFactor)
	{
		...
		response.addResult(new AnalyticsGroupColumns(AnalyticsTypeEnum.LIGHTING_ALARM, ANALYTICS_GROUP_10_0,
				ANALYTICS_GROUP_12_0, ANALYTICS_GROUP_12_0,
				DashboardViewTypeEnum.TODAY));
		response.addResult(new AnalyticsGroupColumns(AnalyticsTypeEnum.LIGHTING_WARNING, ANALYTICS_GROUP_12_0,
				ANALYTICS_GROUP_22_0, ANALYTICS_GROUP_10_0,
				DashboardViewTypeEnum.MONTH));
		response.addResult(new AnalyticsGroupColumns(AnalyticsTypeEnum.LIGHTING_INSTALLED, ANALYTICS_GROUP_13_0,
				ANALYTICS_GROUP_13_0, ANALYTICS_GROUP_20_0,
				DashboardViewTypeEnum.WEEK));
		response.addResult(new AnalyticsGroupColumns(AnalyticsTypeEnum.ECOMODE_CONSUMPTION, ANALYTICS_GROUP_14_0,
				ANALYTICS_GROUP_12_0, ANALYTICS_GROUP_11_0,
				DashboardViewTypeEnum.TODAY));
		response.addResult(new AnalyticsGroupColumns(AnalyticsTypeEnum.LIGHTING_ECOMODE, ANALYTICS_GROUP_11_0,
				ANALYTICS_GROUP_1_0, ANALYTICS_GROUP_6_0,
				DashboardViewTypeEnum.MONTH));
		response.addResult(new AnalyticsGroupColumns(AnalyticsTypeEnum.ECOMODE_CARBON_CREDITS, ANALYTICS_GROUP_12_0,
				ANALYTICS_GROUP_2_0, ANALYTICS_GROUP_16_0,
				DashboardViewTypeEnum.WEEK));
	...
	/*
	 * (non-Javadoc)
	 * @see com.sensus.lc.analytics.dao.IAnalyticsDAO#generateFileCSV(com.sensus.lc.analytics.model.request.
	 * InquiryAnalyticsRequest)
	 */
	@Override
	 ...
	 * (non-Javadoc)
	 * @see
	 * com.sensus.lc.analytics.dao.IAnalyticsDAO#fetchAllAnalyticsGroup(com.sensus.lc.analytics.model.request.
	 * AnalyticsRequest)
	 */
	@Override
	 ...
	 * (non-Javadoc)
	 * @see
	 * com.sensus.lc.analytics.dac.IAnalyticsDAC#fetchAllAnalyticsEcoModeGroup(com.sensus.lc.analytics.model.request
	 * .InquiryAnalyticsRequest)
	 */
	@Override
			...
			InquiryAnalyticsRequest inquiryAnalyticsRequest)
	{
		...
		response.addResult(new AnalyticsGroupEcoMode(1, "Eco-Mode Percent", ANALYTICS_GROUP_55_0,
				ANALYTICS_GROUP_220_0, ANALYTICS_GROUP_330_0));
		response.addResult(new AnalyticsGroupEcoMode(1, "Eco-Mode Measured", ANALYTICS_GROUP_70_0,
				ANALYTICS_GROUP_300_0, ANALYTICS_GROUP_500_0));
		response.addResult(new AnalyticsGroupEcoMode(1, "Eco-Mode Baseline", ANALYTICS_GROUP_40_0,
				ANALYTICS_GROUP_100_0, ANALYTICS_GROUP_220_0));
	 ...
	 * (non-Javadoc)
	 * @see
	 * com.sensus.lc.analytics.dac.IAnalyticsDAC#fetchAllAnalyticsEcoModeByDate(com.sensus.lc.analytics.model.request
	 * .AnalyticsRequest)
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see com.sensus.lc.analytics.dac.IAnalyticsDAC#calculateDashboardResume(java.lang.Double,
	 * com.sensus.lc.tenant.model.Tenant, com.sensus.lc.analytics.model.AnalyticsGroup)
	 */
	@Override
	 ...
	 * (non-Javadoc)
	 * @see
	 * com.sensus.lc.analytics.dac.IAnalyticsDAC#fetchAllGroupsByTenantForDashboard(com.sensus.lc.tenant.model.Tenant)
	 */
	@Override
	public InternalResultsResponse<AnalyticsGroup> fetchAllGroupsByTenantForDashboard(Tenant tenant)
	{
		InternalResultsResponse<AnalyticsGroup> response = new InternalResultsResponse<AnalyticsGroup>();
		AnalyticsGroup ag = new AnalyticsGroup();
		ag.setId(1);
		ag.setName(BEAVERTON);
		response.addResult(ag);
		return response;
	...
	/*
	 * (non-Javadoc)
	 * @see com.sensus.lc.analytics.dac.IAnalyticsDAC#deleteDashboarResumeByTenant(com.sensus.lc.tenant.model.Tenant)
	 */
	@Override
