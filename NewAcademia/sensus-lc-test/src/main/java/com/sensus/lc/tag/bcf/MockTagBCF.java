...
public class MockTagBCF extends AbstractMockBase implements ITagBCF
{
	...
	/*
	 * (non-Javadoc)
	 * @see com.sensus.lc.tag.bcf.ITagBCF#fetchAllTags(com.sensus.lc.tag.model.request.InquiryTagRequest)
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see com.sensus.lc.tag.bcf.ITagBCF#fetchTagByName(com.sensus.lc.tag.model.request.TagRequest)
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see com.sensus.lc.tag.bcf.ITagBCF#insertLightToTag(com.sensus.lc.tag.model.request.TagRequest)
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see com.sensus.lc.tag.bcf.ITagBCF#insertTag(com.sensus.lc.tag.model.request.TagRequest)
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see com.sensus.lc.tag.bcf.ITagBCF#fetchTagsByLight(com.sensus.lc.light.model.request.LightRequest)
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see com.sensus.lc.tag.bcf.ITagBCF#deleteTag(com.sensus.lc.tag.model.request.TagRequest)
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see com.sensus.lc.tag.bcf.ITagBCF#updateAutoGroupTag(com.sensus.lc.tag.model.request.TagRequest)
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see com.sensus.lc.tag.bcf.ITagBCF#deleteLightFromTag(com.sensus.lc.tag.model.request.TagRequest)
	 */
	@Override
