...
<div id="tags" class="point-detail-container">
	...
	<ul>
		<li class="chzn-row">
			<select  multiple class="chzn-select" id="select-tags" name="select_tags"
				<sec:authorize access="hasAnyRole('ROLE_Role.Customer Support')">disabled</sec:authorize>  style="width:100%; "></select>
		</li>
	</ul>
</div>
<script src="scripts/pages/light/modules/module_light_tags.js"></script>