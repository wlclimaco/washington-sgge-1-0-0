...
<ul>
	<li class="ui-widget">
		<label for="event_schedule_add_select">
			<s:message code="action.addtoschedule.label.eventschedulehint" />&nbsp;
			<span class="required">*</span>
		</label>
		<br />
		<div id="select-event-schedule">
			<select name="add_schedule_select" list="eventScheduleList" listKey="id" id="add-schedule-select" cssClass="combobox" listValue="value" multiple="false" size="1" required="false">
...
<div class="highlight"><small><!--<input type="checkbox">--><s:message code="action.addtoschedule.label.eventschedulehintReplace" /></small></div>
</fieldset>
</form>
</div>
