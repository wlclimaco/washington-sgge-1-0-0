	...
	<div id="action-messaging" class="messaging"><span class="message"></span></div>
        <fieldset class="two-line chzn-container">
                <ul>
                    ...
                    <li>
						<p class="highlight sui-pad dialog-instructions"><s:message code="smartpoint.tags.description1"/> <strong><s:message code="smartpoint.tags.added"/></strong> <s:message code="smartpoint.tags.description2"/> <span class="smartpoint-count">0</span> <s:message code="smartpoint.tags.description3"/></p>
                    </li>
                </ul>
   		 </fieldset>
      </form>
