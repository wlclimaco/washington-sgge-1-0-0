                ...
                <div id="yui-main">
                	<div class="yui-b">
                        <div class="content-header">
                            <h1><s:message code="analytics.page.consumption" /></h1>
                            <p class="description"><s:message code="analytics.page.monitorConsumption" /></p>
                        </div>
	                        ...
	                        <!-- START : summary data -->
                                <thead>
                                    <tr class="">
                                        ...
                                        <th><span><s:message code="analytics.table.totalConsumption" /><sup></sup></span></th>
