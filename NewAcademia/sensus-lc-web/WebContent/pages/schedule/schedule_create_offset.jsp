...
<div id="schedule-list">
	...
	<div class="create-action-container">
		<a id="ajax-button" class="alist" href="systemintelligence/schedule"><s:message code="schedulecreate.actions.listschedules" /></a>
	</div>
			...
			<fieldset id="offset" class="sunrise-sunset"><legend><s:message code="schedulecreate.form.sunrise.legend" /></legend>
				...
				<ul class="fields">
					<li class="underline">
						...
						<input type="text" id="offsetSunsetTime" class="date-short validate[required, custom[multiple5],min[0],max[635]]" name="offsetSunsetTime" value="0"/> <s:message code="schedulecreate.page.min" />
					...
					<li class="">
						<label><span class="sunrise"> </span><s:message code="schedulecreate.page.turnlights" /> <strong><s:message code="schedulecreate.page.off" /></strong></label>
							<input type="text" id="offsetSunriseTime" class="date-short validate[required, min[0],max[635]]" name="offsetSunriseTime" value="0"/> <s:message code="schedulecreate.page.min" />
			...
			<fieldset id="override">
				<ul>
					<li class="submit">
						...
						<a href="systemintelligence/schedule" class="cancel alist" id="ajax-button"><s:message code="schedulecreate.actions.cancel" /></a>
					</li>
				</ul>
				<div id="event1"></div>
			</fieldset>
...
<%@ include file="../../scripts/pages/schedule/schedule_create_offset_main.js.jsp" %>
<%@ include file="../../scripts/pages/schedule/schedule_create_offset_init.js.jsp" %>
