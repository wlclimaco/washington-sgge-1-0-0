							...
							<%-- Messaging --%>
								...
								<ul>
									<li>
										...
										<input type="text" id="schedule-name" class="validate[required, maxSize[100]]" name="schedule_name" tabindex="1" value="" />
									</li>
									<li>
										<label for="schedule_description"><s:message code="schedulecreate.form.description.label" /></label>
										<textarea id="schedule-description" class="validate[maxSize[150]]" tabindex="2"></textarea>
									</li>
								</ul>
						</fieldset>
							...
							<fieldset id="override"><legend><s:message code="schedulecreate.form.event.legend1" /> </legend>
								...
								<ul>
									...
									<li class="submit"><label>&nbsp;</label>
										...
										<a href="systemintelligence/schedule" id="ajax-button" class="cancel alist"><s:message code="schedulecreate.actions.cancel" /></a>
									</li>
								</ul>
							</fieldset>
						</div>
...
<%@ include file="../../scripts/pages/schedule/schedule_create_event_main.js.jsp" %>
<%@ include file="../../scripts/pages/schedule/schedule_create_event_init.js.jsp" %>
