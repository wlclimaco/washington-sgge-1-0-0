...
public class LightDetailEcoModeViewControllerTest extends AbstractTestBase
{
	...
	private final String FETCH_LIST = "/ecoMode?id=1";

	@Test
	public void fillDetailEcoMode() throws Exception
	{
