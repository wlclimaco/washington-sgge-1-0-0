package com.sensus.lc.schedule.validation;
...
public class ScheduleValidator implements IValidator
{
	...
	public void validate(ValidationContext context)
	{
		...
		switch (action)
		{
			...
			case FETCH_LIGHT_BY_SCHEDULE_TO_MAP:
				validateScheduleId(list, schedule);
				break;
	...
	private void validateScheduleEvent(List<MessageInfo> list, EventSchedule schedule)
	{
		...
		{
			isNull(event.getIntensity(), SENSUS_MLC_LIGHTVALIDATOR_INTENSITY_REQUIRED, list);
	...
	{
		isNull(schedule.getIntensity(), SENSUS_MLC_LIGHTVALIDATOR_INTENSITY_REQUIRED, list);
