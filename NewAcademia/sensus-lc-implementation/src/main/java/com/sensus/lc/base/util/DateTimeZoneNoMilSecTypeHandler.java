...
import static com.sensus.common.util.SensusConvertUtil.toDate;
 ...
 */
public class DateTimeZoneNoMilSecTypeHandler implements TypeHandler<Object>
{

	/** The Constant DATABASE_DATE_PATTERN. */
	private static final String DATABASE_DATE_PATTERN = "yyyy-MM-dd HH:mm:ss";
	...
	public Object getResult(ResultSet rs, String columnName)
			throws SQLException
	{
		return toDate(rs.getString(columnName), DATABASE_DATE_PATTERN);
	}
	...
	public Object getResult(CallableStatement cs, int columnIndex)
			throws SQLException
	{
		return toDate(cs.getString(columnIndex), DATABASE_DATE_PATTERN);
	}
	...
	{
		return toDate(rs.getString(integ), DATABASE_DATE_PATTERN);
	}
}