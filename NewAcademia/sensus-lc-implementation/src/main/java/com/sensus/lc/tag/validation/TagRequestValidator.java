...
public class TagRequestValidator implements IValidator
{
	...
	/** The Constant SENSUS_MLC_TAGVALIDATOR_INCLUDE_LIGHTS_TO_GROUP_REQUIRED. */
	private static final String SENSUS_MLC_TAGVALIDATOR_INCLUDE_LIGHTS_TO_GROUP_REQUIRED =
			"sensus.mlc.tagvalidator.includelightstogroup.required";
	...
	{
		isNull(tagRequest.getIncludeLightsToGroup(),
				SENSUS_MLC_TAGVALIDATOR_INCLUDE_LIGHTS_TO_GROUP_REQUIRED, list);
	}
}
