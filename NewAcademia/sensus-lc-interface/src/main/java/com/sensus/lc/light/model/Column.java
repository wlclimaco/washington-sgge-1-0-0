...
{
	/** The property enum. */
	private LightColumnEnum columnEnum;
	 ...
	 */
	public LightColumnEnum getColumnEnum()
	{
		return columnEnum;
	}
	 ...
	 */
	public void setColumnEnum(LightColumnEnum columnEnum)
	{
	...
	{
		columnEnum = LightColumnEnum.enumForValue(valueParam);
	}
