...
public enum LCActionTypeEnum implements IIntegerEnum
{
	...
	ADD_LIGHT_TO_GRP(1, LCActionCategoryEnum.MANAGE_GROUPS),

	/** The del light from grp. */
	DEL_LIGHT_FROM_GRP(2, LCActionCategoryEnum.MANAGE_GROUPS),
	...
	/** The del light from schedule event. */
	DEL_LIGHT_FROM_SCHEDULE_EVENT(10, LCActionCategoryEnum.MANAGE_SCHEDULES),

	/** The del light from schedule offset. */
	DEL_LIGHT_FROM_SCHEDULE_OFFSET(11, LCActionCategoryEnum.MANAGE_SCHEDULES),

	/** The add light to schedule event. */
	ADD_LIGHT_TO_SCHEDULE_EVENT(12, LCActionCategoryEnum.MANAGE_SCHEDULES),
	...
	ADD_LIGHT_TO_TAG(20, LCActionCategoryEnum.MANAGE_TAGS),

	/** The del light from tag. */
	DEL_LIGHT_FROM_TAG(21, LCActionCategoryEnum.MANAGE_TAGS),

	/** The CLEAR_ALARM. */
	CLEAR_ALARM(22, LCActionCategoryEnum.MANAGE_LIGHTS),

	/** The CLEAR_ALL_ALARMS. */
	CLEAR_ALL_ALARMS(23, LCActionCategoryEnum.MANAGE_LIGHTS),
	...
	/** The add light to schedule offset. */
	ADD_LIGHT_TO_SCHEDULE_OFFSET(27, LCActionCategoryEnum.MANAGE_SCHEDULES),
	...
	/** The del schedule offset from light. */
	DEL_SCHEDULE_OFFSET_FROM_LIGHT(34, LCActionCategoryEnum.MANAGE_SCHEDULES),
