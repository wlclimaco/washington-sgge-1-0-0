...
public enum PropertyEnum implements IIntegerEnum
{
	...
	/** The subscribe alarm board failure. */
	SUBSCRIBE_ALARM_BOARD_FAILURE(119),

	/** The subscribe alarm lamp failure. */
	SUBSCRIBE_ALARM_LAMP_FAILURE(120),

	/** The subscribe alarm power failure. */
	SUBSCRIBE_ALARM_POWER_FAILURE(121),

	/** The subscribe warn brownout detected. */
	SUBSCRIBE_WARN_BROWNOUT_DETECTED(122),

	/** The subscribe warn commn fail. */
	SUBSCRIBE_WARN_COMMN_FAIL(123),

	/** The subscribe warn power surge. */
	SUBSCRIBE_WARN_POWER_SURGE(124),

	/** The subscribe warn light quality. */
	SUBSCRIBE_WARN_LIGHT_QUALITY(125),

	/** The show subscription dialog. */
	SHOW_SUBSCRIPTION_DIALOG(126),

	/** The subscribe alarm metrology com failure. */
	SUBSCRIBE_ALARM_METROLOGY_COM_FAILURE(127),

	/** The subscribe alarm metrology error. */
	SUBSCRIBE_ALARM_METROLOGY_ERROR(128),

	/** The subscribe warn high current. */
	SUBSCRIBE_WARN_HIGH_CURRENT(129),

	/** The subscribe warn low current. */
	SUBSCRIBE_WARN_LOW_CURRENT(130),

	/** The subscribe warn metrology reset. */
	SUBSCRIBE_WARN_METROLOGY_RESET(131),

	/** The subscribe warn reverse energy. */
	SUBSCRIBE_WARN_REVERSE_ENERGY(132);
