object Form108: TForm108
  ...
  object Query1: TIBQuery
    ...
    SQL.Strings = (
        ...
        'Select v.data, v.codvend,e.nome ,sum(v.valorvenda) as total  fro' +
        'm vendasvendedora v ,empregad e where v.codvend = e.id'
      'group by v.data, v.codvend,e.nome')
    Left = 46
    Top = 17
    object Query1DATA: TDateField
      FieldName = 'DATA'
    end
    object Query1CODVEND: TIntegerField
      FieldName = 'CODVEND'
    end
