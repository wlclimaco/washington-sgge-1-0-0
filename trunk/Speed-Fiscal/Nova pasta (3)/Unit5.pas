...
{$R *.dfm}
    ...
    function TForm5.GravarTitulo():Boolean;
    begin
    ...
    function TForm5.AlterarTitulo():Boolean;
    begin
            QryTiTULOS.Active := False;
      QryTiTULOS.SQL.Clear;
    ...
    function TForm5.ExcluirTitulo():Boolean;
    begin
    QryTiTULOS.SQL.Clear;
    QryTiTULOS.Active := fALSE;
    ...
    function TForm5.Primeiro():Boolean;
    begin
      IBQuery2.First;
    end;
    function TForm5.Proximo():Boolean;
    begin
       IBQuery2.Next;
    end;
    function TForm5.Anterior():Boolean;
    begin
       IBQuery2.Prior;
    end;
    function TForm5.Ultimo():Boolean;
    begin
       IBQuery2.Last;
    end;


    function TForm5.PopularSelectInicial():Boolean;
    begin
     IBQuery2.SQL.Clear();
    ...
    function TForm5.PopularTXT():Boolean;
    begin
    ...
    function TForm5.PopularBanco():Boolean;
    begin
 ...
 function TForm5.GravarALMENTOConta(CONST VALOR :DOUBLE;CONTA :INTEGER ):Boolean;
 begin
 ...
 function TForm5.GravarBaixaConta():Boolean;
...
function TForm5.GravarBaixa(const cdtitulo:Integer ):Boolean;
begin
  QryTiTULOS.SQL.Clear;
...
procedure TForm5.TXTEMPRESAChange(Sender: TObject);
begin
...
procedure TForm5.TXTFILIALChange(Sender: TObject);
begin
...
procedure TForm5.TXTTIPOTITULOChange(Sender: TObject);
begin
 ...
 if(QryTiTULOS.FieldByName('STATUS').AsString <> 'D'  ) then
  ...
  IF ((TXTCONTA.Text <> '' ) OR (TXTCONTA.Text <> ' ')) THEN
   ...
   ShowMessage('Favor prencher o numero da conta para baixa');
       ...
       ShowMEssage('BAIXA NÃO FOI AUTORIZADA PAGAMENTO NAO APROVADO');
  end
  else ShowMEssage('TITULO JA BAIXADO');
 end;
procedure TForm5.TXTFORNECEDORChange(Sender: TObject);
begin
...
procedure TForm5.QryTiTULOSBeforeInsert(DataSet: TDataSet);
begin
ShowMEssage('BeforeInsert');
end;

procedure TForm5.QryTiTULOSBeforeDelete(DataSet: TDataSet);
begin
...
procedure TForm5.TXTTIPOTITULOExit(Sender: TObject);
begin
IF (TXTTIPOTITULO.Text = '8')THEN
 ActNumberEdit1.Visible := tRUE
ELSE
