...
<form id="removeTagForm" name="createTagForm" method="post" >
    ...
    <fieldset class="two-line chzn-container">
            <ul>
                    ...
                    <li>
						<p class="highlight sui-pad dialog-instructions"><s:text name="smartpoint.tags.description1" /> <strong><s:text name="smartpoint.tags.removed" /></strong> <s:text name="smartpoint.tags.description4" /> <span class="smartpoint-count">0</span> <s:text name="smartpoint.tags.description3" /></p>
                    </li>
                </ul>
	 </fieldset>
</form>
