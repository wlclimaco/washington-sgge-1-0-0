package com.sensus.mlc.wui.schedule;
...
public class ScheduleAPIController extends BaseController
{
			...
			HttpServletRequest request)
	{
		...
		{
			setUserContext(scheduleRequest, request);
			scheduleResponse = getScheduleBCF().initiateApplySmartPointToSchedule(scheduleRequest);
		}
		catch (Exception e)
		{
			SensusInterfaceUtil.handleException(LOG, scheduleResponse, e, DEFAULT_EXCEPTION_MSG,
			...
			HttpServletRequest request)
	{
		...
		{
			setUserContext(scheduleRequest, request);
			scheduleResponse = getScheduleBCF().initiateDeleteSmartpointFromSchedule(scheduleRequest);
		}
		catch (Exception e)
		{
			SensusInterfaceUtil.handleException(LOG, scheduleResponse, e, DEFAULT_EXCEPTION_MSG,
