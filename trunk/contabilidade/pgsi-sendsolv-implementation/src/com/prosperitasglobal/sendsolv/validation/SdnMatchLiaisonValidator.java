 ...
 */
public class SdnMatchLiaisonValidator extends PersonValidator
{
	...
	public void validate(ValidationContext validationContext)
	{
		...
		SdnCheckerRequest<Liaison> request =
				(SdnCheckerRequest<Liaison>)validationContext.getObjectToBeValidated(Liaison.class
						.getSimpleName());
