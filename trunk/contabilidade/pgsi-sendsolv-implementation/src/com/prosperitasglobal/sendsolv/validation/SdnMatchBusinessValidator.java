 ...
 */
public class SdnMatchBusinessValidator extends BusinessValidator
{
	...
	public void validate(ValidationContext validationContext)
	{
		...
		SdnCheckerRequest<Business> request =
				(SdnCheckerRequest<Business>)validationContext.getObjectToBeValidated(Business.class
						.getSimpleName());
