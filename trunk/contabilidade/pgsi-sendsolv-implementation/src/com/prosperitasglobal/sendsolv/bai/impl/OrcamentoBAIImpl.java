...
import com.prosperitasglobal.sendsolv.bai.IOrcamentoBAI;
...
public class OrcamentoBAIImpl implements IOrcamentoBAI
{
	...
	/** The Constant LOG. */
	private static final org.slf4j.Logger LOG = LoggerFactory.getLogger(OrcamentoBAIImpl.class);
	 ...
	 * @return the response
	 */
	private OrcamentoResponse handleReturn(OrcamentoResponse response, InternalResponse internalResponse,
