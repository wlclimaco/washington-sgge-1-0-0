...
public class GrupoDACImpl extends SqlSessionDaoSupport implements IGrupoDAC
{
	 ...
	 * (non-Javadoc)
	 * @see
	 * com.prosperitasglobal.cbof.dac.IGrupoDAC#deletePersonGrupo(com.prosperitasglobal.cbof.model.Grupo,
	 * com.qat.framework.model.response.InternalResultsResponse)
	 */
	@Override
	...
	@Override
	public InternalResultsResponse<Grupo> fetchGrupoByParent(Integer parentId)
	{
