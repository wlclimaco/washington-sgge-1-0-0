...
public final class ProductPlanBAD
{
	...
	//
	// /**
	// * Create a new {@link FeeTier} from an existing {@link FeeTier}. The new one will have the
	// <code>modelAction</code>
	// * set to {@link PersistanceActionEnum#INSERT}, the <code>createDateUTC</code> set to the current date/time, and
	// the
	...
	// * The new one will contain a new {@link FeeTier} for each one in the {@link List} of {@link FeeTier}
	// parameter.<br>
	// *
	...
	// *
	// * @param planCategory The {@link TemplateProductPlan} containing the existing {@link List} of {@link
	// PlanCategory}.
	// * @param userContext The {@link UserContext} containing the user information.
	...
	//
	// /**
	// * Create a new {@link ProductPlanApplicability} from an existing {@link ProductPlanApplicability}. The new one
	// will
	// * have the <code>modelAction</code> set to {@link PersistanceActionEnum#INSERT}, the <code>createDateUTC</code>
	// set
	...
	// * instances.
	// *
	// * @param templateProductPlan The {@link TemplateProductPlan} from which the new {@link BusinessProductPlan} will
	// be
	// * created.
