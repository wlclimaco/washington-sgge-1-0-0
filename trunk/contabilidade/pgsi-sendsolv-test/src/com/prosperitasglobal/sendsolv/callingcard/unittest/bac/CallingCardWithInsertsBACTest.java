...
"classpath:com/prosperitasglobal/sendsolv/callingcard/unittest/bac/conf/callingcardwithinsertbacimpltest.xml"})
public class CallingCardWithInsertsBACTest extends AbstractJUnit4SpringContextTests
{
	...
	private static final Logger LOG = LoggerFactory.getLogger(CallingCardWithInsertsBACTest.class);
	...
	public void testGeneratePin()
	{
		...
		Mockito.verify(getCallingCardDAC(), Mockito.times(2)).insertCallingCard(
