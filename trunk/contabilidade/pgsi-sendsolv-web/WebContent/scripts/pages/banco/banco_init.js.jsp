...
$(document).ready(function()
{
	...
	pgsi.pages.banco.locationTable = $('#data_list').dataTable($.pgsi.table.setTable(
	{
		id 			: "#data_list",
		sAjaxSource : "api/pessoa/fetchall/banco",
		bPreLoad	: true,
		...
		[
		{
			headerData 		: "CNPJ",
			order			: "name",
			mRender         : pgsi.pages.banco.fnCreateEmpresaNameLink,
			sDefaultContent : "",
			bSortable 		: false,
			sClass          : "name-col"
		},
		{
			...
			mRender 		: pgsi.pages.banco.fnCreateNomeLink,
			sDefaultContent : "",
			bSortable 		: false
		},
		{
			headerData 		: "Cnae",
			order			: "city_column",
			mRender 		: pgsi.pages.banco.fnCnae,
			mData	 		: "null",
			sDefaultContent : "",
			bSortable 		: false
		},
		{
			headerData 		: "Email",
			order			: "state_column",
			mRender 		: pgsi.pages.banco.fnEmail,
			sDefaultContent : "",
			bSortable 		: false
		},
		{
			...
			mRender 		: pgsi.pages.banco.fnTelefone,
			sDefaultContent : "",
			bSortable 		: false
		},
		{
			...
			mRender 		: pgsi.pages.banco.fnRegime,
			sDefaultContent : "",
			bSortable 		: false
		},
		{
			headerData 		: "Endereco",
			order			: "phone_column",
			mRender 		: pgsi.pages.banco.fnEndereco,
			sDefaultContent : "",
			bSortable 		: false
		},
		{
			...
			order			: "phone_column",
			mRender 		: pgsi.pages.banco.fnDocumento,
			sDefaultContent : "",
			bSortable 		: false
		},
		{
			headerData 		: "Status",
			order			: "phone_column",
			mRender 		: pgsi.pages.banco.fnStatus,
			sDefaultContent : "",
			bSortable 		: false
		},
		],
