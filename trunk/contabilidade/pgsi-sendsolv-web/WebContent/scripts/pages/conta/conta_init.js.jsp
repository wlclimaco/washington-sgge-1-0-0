...
$(document).ready(function()
{
	...
	pgsi.pages.conta.locationTable = $('#data_list').dataTable($.pgsi.table.setTable(
	{
		id 			: "#data_list",
		sAjaxSource : "api/pessoa/fetchall/conta",
		bPreLoad	: true,
		...
		[
		{
			headerData 		: "CNPJ",
			order			: "name",
			mRender         : pgsi.pages.conta.fnCreateEmpresaNameLink,
			sDefaultContent : "",
			bSortable 		: false,
			sClass          : "name-col"
		},
		{
			...
			mRender 		: pgsi.pages.conta.fnCreateNomeLink,
			sDefaultContent : "",
			bSortable 		: false
		},
		{
			headerData 		: "Cnae",
			order			: "city_column",
			mRender 		: pgsi.pages.conta.fnCnae,
			mData	 		: "null",
			sDefaultContent : "",
			bSortable 		: false
		},
		{
			headerData 		: "Email",
			order			: "state_column",
			mRender 		: pgsi.pages.conta.fnEmail,
			sDefaultContent : "",
			bSortable 		: false
		},
		{
			...
			mRender 		: pgsi.pages.conta.fnTelefone,
			sDefaultContent : "",
			bSortable 		: false
		},
		{
			...
			mRender 		: pgsi.pages.conta.fnRegime,
			sDefaultContent : "",
			bSortable 		: false
		},
		{
			headerData 		: "Endereco",
			order			: "phone_column",
			mRender 		: pgsi.pages.conta.fnEndereco,
			sDefaultContent : "",
			bSortable 		: false
		},
		{
			...
			order			: "phone_column",
			mRender 		: pgsi.pages.conta.fnDocumento,
			sDefaultContent : "",
			bSortable 		: false
		},
		{
			headerData 		: "Status",
			order			: "phone_column",
			mRender 		: pgsi.pages.conta.fnStatus,
			sDefaultContent : "",
			bSortable 		: false
		},
		],
