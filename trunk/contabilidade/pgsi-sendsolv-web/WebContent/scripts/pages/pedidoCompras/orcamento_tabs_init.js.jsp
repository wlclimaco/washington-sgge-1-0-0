...
$(document).ready(function()
{
	...
	var iFornecedorId = pgsi.util.page.fnCheckXSS($.address.parameter("pedidoComprasId")) ? null : $.address.parameter("pedidoComprasId");

	//Attach Links to tabs
	$("#infoTab").attr('href', "pedidoCompras/view/info?pedidoComprasId=" + iFornecedorId);
	$('#pricingTab').attr('href',"pedidoCompras/?pedidoComprasId=" + iFornecedorId);
