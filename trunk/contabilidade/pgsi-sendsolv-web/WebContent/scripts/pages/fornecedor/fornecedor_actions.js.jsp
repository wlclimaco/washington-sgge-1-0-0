...
<script type="text/javascript">
	pgsi.pages.fornecedor.dialogSettings = {
			...
			return {
				...
				buttons : (function () {
					...
					oButtons[$.pgsi.locale.get("commons.dialog.insert")] = function () {
						...
						{
							sUrl = "api/fornecedor/insert"
						}
						else
						{
							sUrl = "api/fornecedor/update"
						}
						pgsi.pages.fornecedor.form.ajaxCall(sUrl,sModelAction);
				...
				action : function (actionDialog) {
					...
					actionDialog.load("fornecedor/editView?userId=" + pgsi.settings.userContext.userId+"&locationId=2", function() {
