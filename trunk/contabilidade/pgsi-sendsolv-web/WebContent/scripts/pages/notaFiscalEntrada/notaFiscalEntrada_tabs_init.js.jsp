...
$(document).ready(function()
{
	...
	var iFornecedorId = pgsi.util.page.fnCheckXSS($.address.parameter("notaFiscalEntradaId")) ? null : $.address.parameter("notaFiscalEntradaId");

	//Attach Links to tabs
	$("#infoTab").attr('href', "notaFiscalEntrada/view/info?notaFiscalEntradaId=" + iFornecedorId);
	$('#pricingTab').attr('href',"notaFiscalEntrada/?notaFiscalEntradaId=" + iFornecedorId);
