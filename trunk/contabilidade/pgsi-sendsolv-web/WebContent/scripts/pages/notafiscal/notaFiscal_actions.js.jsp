...
<script type="text/javascript">
	pgsi.pages.notaFiscal.dialogSettings = {
			...
			return {
				...
				buttons : (function () {
					...
					oButtons[$.pgsi.locale.get("commons.dialog.insert")] = function () {
						...
						{
							sUrl = "api/notaFiscal/insert"
						}
						else
						{
							sUrl = "api/notaFiscal/update"
						}
						pgsi.pages.notaFiscal.form.ajaxCall(sUrl,sModelAction);
				...
				action : function (actionDialog) {
					...
					actionDialog.load("notaFiscal/editView?userId=" + pgsi.settings.userContext.userId+"&locationId=2", function() {
