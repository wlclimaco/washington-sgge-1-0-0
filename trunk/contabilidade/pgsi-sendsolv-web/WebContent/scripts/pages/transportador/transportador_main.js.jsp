...
pgsi.pages.transportador = {
	...
	*/
	...
	fnCreatetransportadorNameLink : function (val, type, full)
	{console.log(full)
	var sCnpj="";
		if (type !== "display")
		{
		...
		for(var i=0;i<full.documentos.length;i++){
			...
			return '<a title="View/Edit ' + sCnpj + '" href="#/transportador/view?tab=info&transportadorId=' + full.id + '" class="edit_link">' + sCnpj + '</a>';
	},
	...
	fnCreateNomeLink : function (val, type, full)
	{
		...
		return '<a title="View/Edit ' + full.nome + '" href="#/transportador/view?tab=info&transportadorId=' + full.id + '" class="edit_link">' + full.nome + '</a>';
