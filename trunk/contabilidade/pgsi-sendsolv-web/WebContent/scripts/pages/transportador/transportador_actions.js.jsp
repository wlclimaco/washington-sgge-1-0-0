...
<script type="text/javascript">
	pgsi.pages.transportador.dialogSettings = {
			...
			return {
				...
				buttons : (function () {
					...
					oButtons[$.pgsi.locale.get("commons.dialog.insert")] = function () {
						...
						{
							sUrl = "api/transportador/insert"
						}
						else
						{
							sUrl = "api/transportador/update"
						}
						pgsi.pages.transportador.form.ajaxCall(sUrl,sModelAction);
				...
				action : function (actionDialog) {
					...
					actionDialog.load("transportador/editView?userId=" + pgsi.settings.userContext.userId+"&locationId=2", function() {
