...
console.log(oFuncionario)
	...
	//			<span class="label">CNPJ</span>
				...
				pgsi.pages.phone.view.fillFields(oFuncionario.telefones);

				pgsi.pages.address.view.fillFields(oFuncionario.enderecos);
				var sEmail = "";
				...
				pgsi.pages.funcionario.view.fillCnae(oFuncionario.cnaes)
