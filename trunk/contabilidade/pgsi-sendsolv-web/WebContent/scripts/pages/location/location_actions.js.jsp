...
<script type="text/javascript">
	pgsi.pages.location.dialogSettings = {

		deleteLocations : function (iId, sName) {
			...
			return {
				...
				action : function (actionDialog) {
					...
					actionDialog.load("location/dialogDeleteLocation?userId=" + pgsi.settings.userContext.userId, function() {
