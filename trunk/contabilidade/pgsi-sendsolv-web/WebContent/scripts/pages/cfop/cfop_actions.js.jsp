...
<script type="text/javascript">
	pgsi.pages.cfop.dialogSettings = {
			...
			return {
				...
				buttons : (function () {
					...
					oButtons[$.pgsi.locale.get("commons.dialog.insert")] = function () {
						...
						{
							sUrl = "api/cfop/insert"
						}
						else
						{
							sUrl = "api/cfop/update"
						}
						pgsi.pages.cfop.form.ajaxCall(sUrl,sModelAction);
				...
				action : function (actionDialog) {
					...
					actionDialog.load("cfop/editView?userId=" + pgsi.settings.userContext.userId+"&locationId=2", function() {
