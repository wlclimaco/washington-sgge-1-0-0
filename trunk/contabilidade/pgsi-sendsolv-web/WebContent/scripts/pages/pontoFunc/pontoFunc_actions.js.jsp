...
<script type="text/javascript">
	pgsi.pages.pontoFunc.dialogSettings = {
			...
			return {
				...
				buttons : (function () {
					...
					oButtons[$.pgsi.locale.get("commons.dialog.insert")] = function () {
						...
						{
							sUrl = "api/pontoFunc/insert"
						}
						else
						{
							sUrl = "api/pontoFunc/update"
						}
						pgsi.pages.pontoFunc.form.ajaxCall(sUrl,sModelAction);
				...
				action : function (actionDialog) {
					...
					actionDialog.load("pontoFunc/editView?userId=" + pgsi.settings.userContext.userId+"&locationId=2", function() {
