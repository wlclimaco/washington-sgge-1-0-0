...
<jsp:include page="../../scripts/pages/funcionario/funcionario_create_main.js.jsp" flush="true" />
<jsp:include page="../../scripts/pages/funcionario/funcionario_create_init.js.jsp" flush="true" />