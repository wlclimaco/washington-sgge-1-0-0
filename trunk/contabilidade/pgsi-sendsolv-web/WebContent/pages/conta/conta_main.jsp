...
<jsp:include page="../../scripts/pages/conta/conta_main.js.jsp" flush="true" />
<jsp:include page="../../scripts/pages/conta/conta_actions.js.jsp" flush="true" />
<jsp:include page="../../scripts/pages/conta/conta_init.js.jsp" flush="true" />
