...
<jsp:include page="../../scripts/pages/financeiro/financeiro_main.js.jsp" flush="true" />
<jsp:include page="../../scripts/pages/financeiro/financeiro_init.js.jsp" flush="true" />
