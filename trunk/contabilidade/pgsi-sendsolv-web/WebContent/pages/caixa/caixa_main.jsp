...
<jsp:include page="../../scripts/pages/caixa/caixa_main.js.jsp" flush="true" />
<jsp:include page="../../scripts/pages/caixa/caixa_actions.js.jsp" flush="true" />
<jsp:include page="../../scripts/pages/caixa/caixa_init.js.jsp" flush="true" />
