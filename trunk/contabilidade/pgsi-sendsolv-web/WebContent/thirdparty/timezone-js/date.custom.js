/**
 * QAT - Custom code
 * When the selected Time Zone has no rule, the offset comes as a String and creates a wrong date.
 * Lines changed: 1064~1073
 * Delcides Junior - 04/22/2014 - Version 0.4.4
 * Delcides Junior - 22/07/2014 - Updated to version 0.4.11, the problem persists.
 */
// -----
  ...
  timezoneJS.timezone = new function () {
    ...
    this.getTzInfo = function (dt, tz, isUTC) {
      ...
      if(typeof off === "string"){
          /** If there's no rule, the offset will be a string.
	      *	  Parse it to Number, otherwise it'll change the date incorrectly.
	      */
    	  /*if(window.console){
    		  console.warn("The Time Zone ID used does not contain any rule. Please check your settings.");
    	  }*/
	      off = Number(off);
	  }
