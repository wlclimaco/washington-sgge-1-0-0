	              	...
	              	<div class="yui-u first">
	                	<form name="createUserForm" class="register" method="post" action="#">
	                     ...
	                     <fieldset class="">
                   		...
                   		<fieldset>
								<legend><a href="" class="text_button spindown"><span class="ui-icon-triangle-1-e ui-icon"></span><s:message code="usercreate.page.changepass" /></a></legend>
	                            <div class="spindown_child">
	                             	<ul>
	                                     <li>
	                                         ...
	                                         <span class="note rounded bubble" rel="black" title="<ul><li>1 Upper Case</li><li>1 Lower Case</li><li>1 Alpha</li><li>1 Numeric</li><li>1 Special Character (!@#$%^*&*)</li></ul>"><s:message code="usercreate.page.typepass" /></span>
	                                     </li>
	                                     <li>
...
<%@ include file="../../scripts/pages/create_user_main.js.jsp" %>
<%@ include file="../../scripts/pages/create_user_actions.js.jsp" %>
<%@ include file="../../scripts/pages/create_user_init.js.jsp" %>
</sec:authorize>
