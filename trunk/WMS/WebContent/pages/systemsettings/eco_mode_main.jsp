...
<div id="eco-mode">
<form id="import-eco-mode" name="importEcoModeForm"  method="post" action="#" enctype="multipart/form-data">
	<div id="list-baseline-type-contianer">
    	<fieldset>
        <legend><s:message code="systemsettings.ecomode.page.importdefinitions" /></legend>
      	<p class="desc"><s:message code="systemsettings.ecomode.page.note" /> <span class="note"><a href="#" class="text_button"><s:message code="systemsettings.ecomode.page.importfileformat" /></a></span></p>
             <ul>
                 ...
                 <li class="submit-row-pad">
                     <input type="submit" id="submit-ecomode" class="submit-short-form" value="Import Baseline Definitions" /> or <a href="#" class="cancel-edit cancel"><s:message code="commons.pages.cancel" /></a>
                 </li>
             </ul>
...
<%@ include file="../../scripts/pages/ecomode_main.js.jsp" %>
<%@ include file="../../scripts/pages/ecomode_actions.js.jsp" %>
<%@ include file="../../scripts/pages/ecomode_init.js.jsp" %>
