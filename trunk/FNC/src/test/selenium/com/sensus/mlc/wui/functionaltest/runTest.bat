...
set Dicionariot1host=http://Dicionariot1.davis.sensus.lab:8080/
set Dicionariot2host=http://Dicionariot2.davis.sensus.lab:8080/
set Dicionariot3host=http://Dicionariot3.davis.sensus.lab:8080/
set Dicionariot4host=http://Dicionariot4.davis.sensus.lab:8080/
...
if /I "%1" EQU "Dicionariot1" (set host="%Dicionariot1host%")
if /I "%1" EQU "Dicionariot2" (set host="%Dicionariot2host%")
if /I "%1" EQU "Dicionariot3" (set host="%Dicionariot3host%")
if /I "%1" EQU "Dicionariot4" (set host="%Dicionariot4host%")
