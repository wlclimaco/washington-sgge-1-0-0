...
$layout->blocks["top"][] = "details";$page_layouts["C000007_view"] = $layout;
...
//TELEFONE3 - 
	...
	if($mainTableOwnerID=="TELEFONE3")
		$ownerIdValue=$value;
	$xt->assign("TELEFONE3_value",$value);
	if(!$pageObject->isAppearOnTabs("TELEFONE3"))
		$xt->assign("TELEFONE3_fieldblock",true);
	else
		$xt->assign("TELEFONE3_tabfieldblock",true);
////////////////////////////////////////////
//CELULAR - 
...
//ESTADOCIVIL - 
	...
	if($mainTableOwnerID=="ESTADOCIVIL")
		$ownerIdValue=$value;
	$xt->assign("ESTADOCIVIL_value",$value);
	if(!$pageObject->isAppearOnTabs("ESTADOCIVIL"))
		$xt->assign("ESTADOCIVIL_fieldblock",true);
	else
		$xt->assign("ESTADOCIVIL_tabfieldblock",true);
////////////////////////////////////////////
//CONJUGE - 
	
	$value = $pageObject->showDBValue("CONJUGE", $data, $keylink);
	if($mainTableOwnerID=="CONJUGE")
		$ownerIdValue=$value;
	$xt->assign("CONJUGE_value",$value);
	if(!$pageObject->isAppearOnTabs("CONJUGE"))
		$xt->assign("CONJUGE_fieldblock",true);
	else
		$xt->assign("CONJUGE_tabfieldblock",true);
////////////////////////////////////////////
//NASCIMENTO - 
...
//SEXO - 
	...
	if($mainTableOwnerID=="SEXO")
		$ownerIdValue=$value;
	$xt->assign("SEXO_value",$value);
...
$xt->assign("editlink_attrs","id=\"editLink".$id."\" name=\"editLink".$id."\" onclick=\"window.location.href='C000007_edit.php?".$editlink."'\"");
