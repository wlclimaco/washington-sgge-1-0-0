...
$templatefile = ($inlineedit == EDIT_INLINE) ? "C000046_inline_edit.htm" : "C000046_edit.htm";
...
if ($IsSaved && no_output_done() && $inlineedit == EDIT_SIMPLE)
{
	...
	// redirect
	header("Location: C000046_".$pageObject->getPageType().".php?".$keyGetQ);
...
//	DATA_EMISSAO - Short Date
	...
	$showValues["DATA_EMISSAO"] = $value;
	$showFields[] = "DATA_EMISSAO";
		$showRawValues["DATA_EMISSAO"] = substr($data["DATA_EMISSAO"],0,100);

//	DATA_VENCIMENTO - Short Date
	$value = $pageObject->showDBValue("DATA_VENCIMENTO", $data, $keylink);
	$showValues["DATA_VENCIMENTO"] = $value;
	$showFields[] = "DATA_VENCIMENTO";
		$showRawValues["DATA_VENCIMENTO"] = substr($data["DATA_VENCIMENTO"],0,100);

//	DATA_PAGAMENTO - Short Date
	$value = $pageObject->showDBValue("DATA_PAGAMENTO", $data, $keylink);
	$showValues["DATA_PAGAMENTO"] = $value;
	$showFields[] = "DATA_PAGAMENTO";
		$showRawValues["DATA_PAGAMENTO"] = substr($data["DATA_PAGAMENTO"],0,100);
...
//	VALORPAGO - Number
	...
	$showValues["VALORPAGO"] = $value;
	$showFields[] = "VALORPAGO";
		$showRawValues["VALORPAGO"] = substr($data["VALORPAGO"],0,100);
...
//	ACRESCIMO - Number
	...
	$showValues["ACRESCIMO"] = $value;
	$showFields[] = "ACRESCIMO";
		$showRawValues["ACRESCIMO"] = substr($data["ACRESCIMO"],0,100);

//	DOCUMENTO - 
	$value = $pageObject->showDBValue("DOCUMENTO", $data, $keylink);
	$showValues["DOCUMENTO"] = $value;
	$showFields[] = "DOCUMENTO";
		$showRawValues["DOCUMENTO"] = substr($data["DOCUMENTO"],0,100);
...
//	ESPECIE - 
	...
	$showValues["ESPECIE"] = $value;
	$showFields[] = "ESPECIE";
		$showRawValues["ESPECIE"] = substr($data["ESPECIE"],0,100);
...
//	CODNOTA - 
	...
	$showValues["CODNOTA"] = $value;
	$showFields[] = "CODNOTA";
		$showRawValues["CODNOTA"] = substr($data["CODNOTA"],0,100);

//	MOVIMENTO - 
	$value = $pageObject->showDBValue("MOVIMENTO", $data, $keylink);
	$showValues["MOVIMENTO"] = $value;
	$showFields[] = "MOVIMENTO";
		$showRawValues["MOVIMENTO"] = substr($data["MOVIMENTO"],0,100);

//	CODCAIXA - 
	$value = $pageObject->showDBValue("CODCAIXA", $data, $keylink);
	$showValues["CODCAIXA"] = $value;
	$showFields[] = "CODCAIXA";
		$showRawValues["CODCAIXA"] = substr($data["CODCAIXA"],0,100);
/////////////////////////////////////////////////////////////
//	start inline output
/////////////////////////////////////////////////////////////
...
$xt->assign("viewlink_attrs","id=\"viewButton".$id."\" name=\"viewButton".$id."\" onclick=\"window.location.href='C000046_view.php?".$viewlink."'\"");
