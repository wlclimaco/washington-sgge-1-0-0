...
$layout->blocks["top"][] = "details";$page_layouts["C000054_view"] = $layout;
...
if (!sizeof($data)) {
	header("Location: C000054_list.php?a=return");
	exit();
}
...
//ANO - 
	...
	if($mainTableOwnerID=="ANO")
		$ownerIdValue=$value;
	$xt->assign("ANO_value",$value);
...
//COMBUSTIVEL - 
	...
	$value = $pageObject->showDBValue("COMBUSTIVEL", $data, $keylink);
	if($mainTableOwnerID=="COMBUSTIVEL")
		$ownerIdValue=$value;
	$xt->assign("COMBUSTIVEL_value",$value);
	if(!$pageObject->isAppearOnTabs("COMBUSTIVEL"))
		$xt->assign("COMBUSTIVEL_fieldblock",true);
	else
		$xt->assign("COMBUSTIVEL_tabfieldblock",true);
////////////////////////////////////////////
//PLACA - 
	
	$value = $pageObject->showDBValue("PLACA", $data, $keylink);
	if($mainTableOwnerID=="PLACA")
		$ownerIdValue=$value;
	$xt->assign("PLACA_value",$value);
	if(!$pageObject->isAppearOnTabs("PLACA"))
		$xt->assign("PLACA_fieldblock",true);
	else
		$xt->assign("PLACA_tabfieldblock",true);
////////////////////////////////////////////
//UFPLACA - 
	
	$value = $pageObject->showDBValue("UFPLACA", $data, $keylink);
	if($mainTableOwnerID=="UFPLACA")
		$ownerIdValue=$value;
	$xt->assign("UFPLACA_value",$value);
	if(!$pageObject->isAppearOnTabs("UFPLACA"))
		$xt->assign("UFPLACA_fieldblock",true);
	else
		$xt->assign("UFPLACA_tabfieldblock",true);
////////////////////////////////////////////
//COR - 
...
//SEGURO_OBRIGATORIO - Short Date
	...
	$value = $pageObject->showDBValue("SEGURO_OBRIGATORIO", $data, $keylink);
	if($mainTableOwnerID=="SEGURO_OBRIGATORIO")
		$ownerIdValue=$value;
	$xt->assign("SEGURO_OBRIGATORIO_value",$value);
	if(!$pageObject->isAppearOnTabs("SEGURO_OBRIGATORIO"))
		$xt->assign("SEGURO_OBRIGATORIO_fieldblock",true);
	else
		$xt->assign("SEGURO_OBRIGATORIO_tabfieldblock",true);
////////////////////////////////////////////
//COD_MARCA - 
	
	$value = $pageObject->showDBValue("COD_MARCA", $data, $keylink);
	if($mainTableOwnerID=="COD_MARCA")
		$ownerIdValue=$value;
	$xt->assign("COD_MARCA_value",$value);
	if(!$pageObject->isAppearOnTabs("COD_MARCA"))
		$xt->assign("COD_MARCA_fieldblock",true);
	else
		$xt->assign("COD_MARCA_tabfieldblock",true);
////////////////////////////////////////////
//COD_MODELO - 
	
	$value = $pageObject->showDBValue("COD_MODELO", $data, $keylink);
	if($mainTableOwnerID=="COD_MODELO")
		$ownerIdValue=$value;
	$xt->assign("COD_MODELO_value",$value);
	if(!$pageObject->isAppearOnTabs("COD_MODELO"))
		$xt->assign("COD_MODELO_fieldblock",true);
	else
		$xt->assign("COD_MODELO_tabfieldblock",true);
////////////////////////////////////////////
//LICENCIAMENTO - Short Date
	
	$value = $pageObject->showDBValue("LICENCIAMENTO", $data, $keylink);
	if($mainTableOwnerID=="LICENCIAMENTO")
		$ownerIdValue=$value;
	$xt->assign("LICENCIAMENTO_value",$value);
	if(!$pageObject->isAppearOnTabs("LICENCIAMENTO"))
		$xt->assign("LICENCIAMENTO_fieldblock",true);
	else
		$xt->assign("LICENCIAMENTO_tabfieldblock",true);
////////////////////////////////////////////
//OBS1 - 
...
$xt->assign("editlink_attrs","id=\"editLink".$id."\" name=\"editLink".$id."\" onclick=\"window.location.href='C000054_edit.php?".$editlink."'\"");
