...
if($inlineadd == ADD_INLINE)
	$templatefile = "C000007_inline_add.htm";
else
	$templatefile = "C000007_add.htm";
...
if(isset($_REQUEST['afteradd'])){
		header('Location: C000007_add.php');
...
//	processing CPF - end
//	processing SITUACAO - start
	$inlineAddOption = true;
	$inlineAddOption = $inlineadd==ADD_INLINE;
	if($inlineAddOption)
	{
		$control_SITUACAO = $pageObject->getControl("SITUACAO", $id);
		$control_SITUACAO->readWebValue($avalues, $blobfields, "", false, $afilename_values);
	}
			...
			if($inlineadd==ADD_SIMPLE || $inlineadd==ADD_MASTER)
			{
				...
				if (count($keys))
				{
					...
					if($pageObject->pSet->hasEditPage() && $permis['edit'])
						$message .='&nbsp;<a href=\'C000007_edit.php?'.$keylink.'\'>'."Editar".'</a>&nbsp;';
					if($pageObject->pSet->hasViewPage() && $permis['search'])
						$message .='&nbsp;<a href=\'C000007_view.php?'.$keylink.'\'>'."Exibir".'</a>&nbsp;';
				}
				$mesClass = "mes_ok";	
			}
		}
...
if (no_output_done() && $inlineadd==ADD_SIMPLE && $IsSaved)
{
	...
	// redirect
	header("Location: C000007_".$pageObject->getPageType().".php");
