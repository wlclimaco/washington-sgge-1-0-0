...
$layout->blocks["top"][] = "pdf";$page_layouts["C000071_print"] = $layout;
...
$arr = array();
$arr['fName'] = "CONTATO";
$arr['viewFormat'] = $pageObject->pSet->getViewFormat("CONTATO");
$fieldsArr[] = $arr;
$arr = array();
$arr['fName'] = "CELULAR";
...
$arr = array();
$arr['fName'] = "DIA_PGTO";
$arr['viewFormat'] = $pageObject->pSet->getViewFormat("DIA_PGTO");
$fieldsArr[] = $arr;
$arr = array();
$arr['fName'] = "CNPJ";
...
$fieldsArr[] = $arr;
$arr = array();
$arr['fName'] = "DIA_FECHAMENTO";
$arr['viewFormat'] = $pageObject->pSet->getViewFormat("DIA_FECHAMENTO");
$fieldsArr[] = $arr;
$arr = array();
$arr['fName'] = "DIA_PAGAMENTO";
$arr['viewFormat'] = $pageObject->pSet->getViewFormat("DIA_PAGAMENTO");
$fieldsArr[] = $arr;
$arr = array();
$arr['fName'] = "LIMITE";
$arr['viewFormat'] = $pageObject->pSet->getViewFormat("LIMITE");
$fieldsArr[] = $arr;
...
//	CONTATO - 
			$record["CONTATO_value"] = $pageObject->showDBValue("CONTATO", $data, $keylink);
			$record["CONTATO_class"] = $pageObject->fieldClass("CONTATO");
//	CELULAR - 
			$record["CELULAR_value"] = $pageObject->showDBValue("CELULAR", $data, $keylink);
			$record["CELULAR_class"] = $pageObject->fieldClass("CELULAR");
//	DIA_PGTO - 
			$record["DIA_PGTO_value"] = $pageObject->showDBValue("DIA_PGTO", $data, $keylink);
			$record["DIA_PGTO_class"] = $pageObject->fieldClass("DIA_PGTO");
//	CNPJ - 
...
//	DIA_FECHAMENTO - 
			$record["DIA_FECHAMENTO_value"] = $pageObject->showDBValue("DIA_FECHAMENTO", $data, $keylink);
			$record["DIA_FECHAMENTO_class"] = $pageObject->fieldClass("DIA_FECHAMENTO");
//	DIA_PAGAMENTO - 
			$record["DIA_PAGAMENTO_value"] = $pageObject->showDBValue("DIA_PAGAMENTO", $data, $keylink);
			$record["DIA_PAGAMENTO_class"] = $pageObject->fieldClass("DIA_PAGAMENTO");
//	LIMITE - Number
			$record["LIMITE_value"] = $pageObject->showDBValue("LIMITE", $data, $keylink);
			$record["LIMITE_class"] = $pageObject->fieldClass("LIMITE");
			if($col<$colsonpage)
...
$xt->assign("CONTATO_fieldheadercolumn",true);
$xt->assign("CONTATO_fieldheader",true);
$xt->assign("CONTATO_fieldcolumn",true);
$xt->assign("CONTATO_fieldfootercolumn",true);
...
$xt->assign("DIA_PGTO_fieldheadercolumn",true);
$xt->assign("DIA_PGTO_fieldheader",true);
$xt->assign("DIA_PGTO_fieldcolumn",true);
$xt->assign("DIA_PGTO_fieldfootercolumn",true);
...
$xt->assign("DIA_FECHAMENTO_fieldheadercolumn",true);
$xt->assign("DIA_FECHAMENTO_fieldheader",true);
$xt->assign("DIA_FECHAMENTO_fieldcolumn",true);
$xt->assign("DIA_FECHAMENTO_fieldfootercolumn",true);
$xt->assign("DIA_PAGAMENTO_fieldheadercolumn",true);
$xt->assign("DIA_PAGAMENTO_fieldheader",true);
$xt->assign("DIA_PAGAMENTO_fieldcolumn",true);
$xt->assign("DIA_PAGAMENTO_fieldfootercolumn",true);
$xt->assign("LIMITE_fieldheadercolumn",true);
$xt->assign("LIMITE_fieldheader",true);
$xt->assign("LIMITE_fieldcolumn",true);
$xt->assign("LIMITE_fieldfootercolumn",true);
