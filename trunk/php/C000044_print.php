...
$layout->blocks["top"][] = "pdf";$page_layouts["C000044_print"] = $layout;
...
$fieldsArr[] = $arr;
$arr = array();
$arr['fName'] = "CODOPERADOR";
$arr['viewFormat'] = $pageObject->pSet->getViewFormat("CODOPERADOR");
$fieldsArr[] = $arr;
$arr = array();
$arr['fName'] = "DATA";
$arr['viewFormat'] = $pageObject->pSet->getViewFormat("DATA");
$fieldsArr[] = $arr;
$arr = array();
$arr['fName'] = "SAIDA";
$arr['viewFormat'] = $pageObject->pSet->getViewFormat("SAIDA");
$fieldsArr[] = $arr;
$arr = array();
$arr['fName'] = "ENTRADA";
$arr['viewFormat'] = $pageObject->pSet->getViewFormat("ENTRADA");
$fieldsArr[] = $arr;
$arr = array();
$arr['fName'] = "CODCONTA";
...
//	CODOPERADOR - 
			$record["CODOPERADOR_value"] = $pageObject->showDBValue("CODOPERADOR", $data, $keylink);
			$record["CODOPERADOR_class"] = $pageObject->fieldClass("CODOPERADOR");
//	DATA - Short Date
			$record["DATA_value"] = $pageObject->showDBValue("DATA", $data, $keylink);
			$record["DATA_class"] = $pageObject->fieldClass("DATA");
//	SAIDA - Number
			$record["SAIDA_value"] = $pageObject->showDBValue("SAIDA", $data, $keylink);
			$record["SAIDA_class"] = $pageObject->fieldClass("SAIDA");
//	ENTRADA - Number
			$record["ENTRADA_value"] = $pageObject->showDBValue("ENTRADA", $data, $keylink);
			$record["ENTRADA_class"] = $pageObject->fieldClass("ENTRADA");
//	CODCONTA - 
...
$xt->assign("CODOPERADOR_fieldheadercolumn",true);
$xt->assign("CODOPERADOR_fieldheader",true);
$xt->assign("CODOPERADOR_fieldcolumn",true);
$xt->assign("CODOPERADOR_fieldfootercolumn",true);
...
$xt->assign("SAIDA_fieldheadercolumn",true);
$xt->assign("SAIDA_fieldheader",true);
$xt->assign("SAIDA_fieldcolumn",true);
$xt->assign("SAIDA_fieldfootercolumn",true);
$xt->assign("ENTRADA_fieldheadercolumn",true);
$xt->assign("ENTRADA_fieldheader",true);
$xt->assign("ENTRADA_fieldcolumn",true);
$xt->assign("ENTRADA_fieldfootercolumn",true);
