...
$layout->blocks["top"][] = "details";$page_layouts["C000071_view"] = $layout;
...
if (!sizeof($data)) {
	header("Location: C000071_list.php?a=return");
	exit();
}
...
//CONTATO - 
	...
	$value = $pageObject->showDBValue("CONTATO", $data, $keylink);
	if($mainTableOwnerID=="CONTATO")
		$ownerIdValue=$value;
	$xt->assign("CONTATO_value",$value);
	if(!$pageObject->isAppearOnTabs("CONTATO"))
		$xt->assign("CONTATO_fieldblock",true);
	else
		$xt->assign("CONTATO_tabfieldblock",true);
////////////////////////////////////////////
//CELULAR - 
...
//DIA_PGTO - 
	...
	$value = $pageObject->showDBValue("DIA_PGTO", $data, $keylink);
	if($mainTableOwnerID=="DIA_PGTO")
		$ownerIdValue=$value;
	$xt->assign("DIA_PGTO_value",$value);
	if(!$pageObject->isAppearOnTabs("DIA_PGTO"))
		$xt->assign("DIA_PGTO_fieldblock",true);
	else
		$xt->assign("DIA_PGTO_tabfieldblock",true);
////////////////////////////////////////////
//CNPJ - 
...
//DIA_FECHAMENTO - 
	...
	$value = $pageObject->showDBValue("DIA_FECHAMENTO", $data, $keylink);
	if($mainTableOwnerID=="DIA_FECHAMENTO")
		$ownerIdValue=$value;
	$xt->assign("DIA_FECHAMENTO_value",$value);
	if(!$pageObject->isAppearOnTabs("DIA_FECHAMENTO"))
		$xt->assign("DIA_FECHAMENTO_fieldblock",true);
	else
		$xt->assign("DIA_FECHAMENTO_tabfieldblock",true);
////////////////////////////////////////////
//DIA_PAGAMENTO - 
	
	$value = $pageObject->showDBValue("DIA_PAGAMENTO", $data, $keylink);
	if($mainTableOwnerID=="DIA_PAGAMENTO")
		$ownerIdValue=$value;
	$xt->assign("DIA_PAGAMENTO_value",$value);
	if(!$pageObject->isAppearOnTabs("DIA_PAGAMENTO"))
		$xt->assign("DIA_PAGAMENTO_fieldblock",true);
	else
		$xt->assign("DIA_PAGAMENTO_tabfieldblock",true);
////////////////////////////////////////////
//LIMITE - Number
	
	$value = $pageObject->showDBValue("LIMITE", $data, $keylink);
	if($mainTableOwnerID=="LIMITE")
		$ownerIdValue=$value;
	$xt->assign("LIMITE_value",$value);
	if(!$pageObject->isAppearOnTabs("LIMITE"))
		$xt->assign("LIMITE_fieldblock",true);
	else
		$xt->assign("LIMITE_tabfieldblock",true);
...
$xt->assign("editlink_attrs","id=\"editLink".$id."\" name=\"editLink".$id."\" onclick=\"window.location.href='C000071_edit.php?".$editlink."'\"");
