...
$layout->blocks["top"][] = "pdf";$page_layouts["C000007_print"] = $layout;
...
$arr = array();
$arr['fName'] = "TELEFONE3";
$arr['viewFormat'] = $pageObject->pSet->getViewFormat("TELEFONE3");
$fieldsArr[] = $arr;
$arr = array();
$arr['fName'] = "CELULAR";
...
$fieldsArr[] = $arr;
$arr = array();
$arr['fName'] = "ESTADOCIVIL";
$arr['viewFormat'] = $pageObject->pSet->getViewFormat("ESTADOCIVIL");
$fieldsArr[] = $arr;
$arr = array();
$arr['fName'] = "CONJUGE";
$arr['viewFormat'] = $pageObject->pSet->getViewFormat("CONJUGE");
$fieldsArr[] = $arr;
$arr = array();
...
//	TELEFONE3 - 
			$record["TELEFONE3_value"] = $pageObject->showDBValue("TELEFONE3", $data, $keylink);
			$record["TELEFONE3_class"] = $pageObject->fieldClass("TELEFONE3");
//	CELULAR - 
...
//	ESTADOCIVIL - 
			$record["ESTADOCIVIL_value"] = $pageObject->showDBValue("ESTADOCIVIL", $data, $keylink);
			$record["ESTADOCIVIL_class"] = $pageObject->fieldClass("ESTADOCIVIL");
//	CONJUGE - 
			$record["CONJUGE_value"] = $pageObject->showDBValue("CONJUGE", $data, $keylink);
			$record["CONJUGE_class"] = $pageObject->fieldClass("CONJUGE");
//	NASCIMENTO - 
...
$xt->assign("TELEFONE3_fieldheadercolumn",true);
$xt->assign("TELEFONE3_fieldheader",true);
$xt->assign("TELEFONE3_fieldcolumn",true);
$xt->assign("TELEFONE3_fieldfootercolumn",true);
...
$xt->assign("ESTADOCIVIL_fieldheadercolumn",true);
$xt->assign("ESTADOCIVIL_fieldheader",true);
$xt->assign("ESTADOCIVIL_fieldcolumn",true);
$xt->assign("ESTADOCIVIL_fieldfootercolumn",true);
$xt->assign("CONJUGE_fieldheadercolumn",true);
$xt->assign("CONJUGE_fieldheader",true);
$xt->assign("CONJUGE_fieldcolumn",true);
$xt->assign("CONJUGE_fieldfootercolumn",true);
