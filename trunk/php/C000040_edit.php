...
$templatefile = ($inlineedit == EDIT_INLINE) ? "C000040_inline_edit.htm" : "C000040_edit.htm";
...
if ($IsSaved && no_output_done() && $inlineedit == EDIT_SIMPLE)
{
	...
	// redirect
	header("Location: C000040_".$pageObject->getPageType().".php?".$keyGetQ);
...
//	EMISSAO - Short Date
	...
	$showValues["EMISSAO"] = $value;
	$showFields[] = "EMISSAO";
		$showRawValues["EMISSAO"] = substr($data["EMISSAO"],0,100);

//	VENCIMENTO - Short Date
	$value = $pageObject->showDBValue("VENCIMENTO", $data, $keylink);
	$showValues["VENCIMENTO"] = $value;
	$showFields[] = "VENCIMENTO";
		$showRawValues["VENCIMENTO"] = substr($data["VENCIMENTO"],0,100);

//	DATA_DEPOSITO1 - Short Date
	$value = $pageObject->showDBValue("DATA_DEPOSITO1", $data, $keylink);
	$showValues["DATA_DEPOSITO1"] = $value;
	$showFields[] = "DATA_DEPOSITO1";
		$showRawValues["DATA_DEPOSITO1"] = substr($data["DATA_DEPOSITO1"],0,100);

//	DATA_DEPOSITO2 - Short Date
	$value = $pageObject->showDBValue("DATA_DEPOSITO2", $data, $keylink);
	$showValues["DATA_DEPOSITO2"] = $value;
	$showFields[] = "DATA_DEPOSITO2";
		$showRawValues["DATA_DEPOSITO2"] = substr($data["DATA_DEPOSITO2"],0,100);

//	DATA_DEVOLUCAO1 - Short Date
	$value = $pageObject->showDBValue("DATA_DEVOLUCAO1", $data, $keylink);
	$showValues["DATA_DEVOLUCAO1"] = $value;
	$showFields[] = "DATA_DEVOLUCAO1";
		$showRawValues["DATA_DEVOLUCAO1"] = substr($data["DATA_DEVOLUCAO1"],0,100);

//	DATA_DEVOLUCAO2 - Short Date
	$value = $pageObject->showDBValue("DATA_DEVOLUCAO2", $data, $keylink);
	$showValues["DATA_DEVOLUCAO2"] = $value;
	$showFields[] = "DATA_DEVOLUCAO2";
		$showRawValues["DATA_DEVOLUCAO2"] = substr($data["DATA_DEVOLUCAO2"],0,100);
...
//	CODCLIENTE - 
	...
	$showValues["CODCLIENTE"] = $value;
	$showFields[] = "CODCLIENTE";
		$showRawValues["CODCLIENTE"] = substr($data["CODCLIENTE"],0,100);

//	TITULAR - 
	$value = $pageObject->showDBValue("TITULAR", $data, $keylink);
	$showValues["TITULAR"] = $value;
	$showFields[] = "TITULAR";
		$showRawValues["TITULAR"] = substr($data["TITULAR"],0,100);

//	CODBANCO - 
	$value = $pageObject->showDBValue("CODBANCO", $data, $keylink);
	$showValues["CODBANCO"] = $value;
	$showFields[] = "CODBANCO";
		$showRawValues["CODBANCO"] = substr($data["CODBANCO"],0,100);

//	AGENCIA - 
	$value = $pageObject->showDBValue("AGENCIA", $data, $keylink);
	$showValues["AGENCIA"] = $value;
	$showFields[] = "AGENCIA";
		$showRawValues["AGENCIA"] = substr($data["AGENCIA"],0,100);

//	CONTA - 
	$value = $pageObject->showDBValue("CONTA", $data, $keylink);
	$showValues["CONTA"] = $value;
	$showFields[] = "CONTA";
		$showRawValues["CONTA"] = substr($data["CONTA"],0,100);

//	DATA_CONTA - Short Date
	$value = $pageObject->showDBValue("DATA_CONTA", $data, $keylink);
	$showValues["DATA_CONTA"] = $value;
	$showFields[] = "DATA_CONTA";
		$showRawValues["DATA_CONTA"] = substr($data["DATA_CONTA"],0,100);

//	NUMERO - 
	$value = $pageObject->showDBValue("NUMERO", $data, $keylink);
	$showValues["NUMERO"] = $value;
	$showFields[] = "NUMERO";
		$showRawValues["NUMERO"] = substr($data["NUMERO"],0,100);

//	VALOR - Number
	$value = $pageObject->showDBValue("VALOR", $data, $keylink);
	$showValues["VALOR"] = $value;
	$showFields[] = "VALOR";
		$showRawValues["VALOR"] = substr($data["VALOR"],0,100);

//	DESCONTO - Number
	$value = $pageObject->showDBValue("DESCONTO", $data, $keylink);
	$showValues["DESCONTO"] = $value;
	$showFields[] = "DESCONTO";
		$showRawValues["DESCONTO"] = substr($data["DESCONTO"],0,100);

//	LIQUIDO - Number
	$value = $pageObject->showDBValue("LIQUIDO", $data, $keylink);
	$showValues["LIQUIDO"] = $value;
	$showFields[] = "LIQUIDO";
		$showRawValues["LIQUIDO"] = substr($data["LIQUIDO"],0,100);

//	CODVENDA - 
	$value = $pageObject->showDBValue("CODVENDA", $data, $keylink);
	$showValues["CODVENDA"] = $value;
	$showFields[] = "CODVENDA";
		$showRawValues["CODVENDA"] = substr($data["CODVENDA"],0,100);
...
//	CODCONTAS_PAGAR - 
	...
	$showValues["CODCONTAS_PAGAR"] = $value;
	$showFields[] = "CODCONTAS_PAGAR";
		$showRawValues["CODCONTAS_PAGAR"] = substr($data["CODCONTAS_PAGAR"],0,100);

//	DESTINO - 
	$value = $pageObject->showDBValue("DESTINO", $data, $keylink);
	$showValues["DESTINO"] = $value;
	$showFields[] = "DESTINO";
		$showRawValues["DESTINO"] = substr($data["DESTINO"],0,100);

//	DATA_BAIXA - Short Date
	$value = $pageObject->showDBValue("DATA_BAIXA", $data, $keylink);
	$showValues["DATA_BAIXA"] = $value;
	$showFields[] = "DATA_BAIXA";
		$showRawValues["DATA_BAIXA"] = substr($data["DATA_BAIXA"],0,100);

//	CODCONTA_CORRENTE - 
	$value = $pageObject->showDBValue("CODCONTA_CORRENTE", $data, $keylink);
	$showValues["CODCONTA_CORRENTE"] = $value;
	$showFields[] = "CODCONTA_CORRENTE";
		$showRawValues["CODCONTA_CORRENTE"] = substr($data["CODCONTA_CORRENTE"],0,100);

//	CODCONTA - 
	$value = $pageObject->showDBValue("CODCONTA", $data, $keylink);
	$showValues["CODCONTA"] = $value;
	$showFields[] = "CODCONTA";
		$showRawValues["CODCONTA"] = substr($data["CODCONTA"],0,100);
/////////////////////////////////////////////////////////////
//	start inline output
/////////////////////////////////////////////////////////////
...
$xt->assign("viewlink_attrs","id=\"viewButton".$id."\" name=\"viewButton".$id."\" onclick=\"window.location.href='C000040_view.php?".$viewlink."'\"");
