...
$templatefile = ($inlineedit == EDIT_INLINE) ? "C000054_inline_edit.htm" : "C000054_edit.htm";
...
if ($IsSaved && no_output_done() && $inlineedit == EDIT_SIMPLE)
{
	...
	// redirect
	header("Location: C000054_".$pageObject->getPageType().".php?".$keyGetQ);
...
//	COMBUSTIVEL - 
	...
	$showValues["COMBUSTIVEL"] = $value;
	$showFields[] = "COMBUSTIVEL";
		$showRawValues["COMBUSTIVEL"] = substr($data["COMBUSTIVEL"],0,100);

//	PLACA - 
	$value = $pageObject->showDBValue("PLACA", $data, $keylink);
	$showValues["PLACA"] = $value;
	$showFields[] = "PLACA";
		$showRawValues["PLACA"] = substr($data["PLACA"],0,100);

//	UFPLACA - 
	$value = $pageObject->showDBValue("UFPLACA", $data, $keylink);
	$showValues["UFPLACA"] = $value;
	$showFields[] = "UFPLACA";
		$showRawValues["UFPLACA"] = substr($data["UFPLACA"],0,100);
...
//	SEGURO_OBRIGATORIO - Short Date
	...
	$showValues["SEGURO_OBRIGATORIO"] = $value;
	$showFields[] = "SEGURO_OBRIGATORIO";
		$showRawValues["SEGURO_OBRIGATORIO"] = substr($data["SEGURO_OBRIGATORIO"],0,100);

//	COD_MARCA - 
	$value = $pageObject->showDBValue("COD_MARCA", $data, $keylink);
	$showValues["COD_MARCA"] = $value;
	$showFields[] = "COD_MARCA";
		$showRawValues["COD_MARCA"] = substr($data["COD_MARCA"],0,100);

//	COD_MODELO - 
	$value = $pageObject->showDBValue("COD_MODELO", $data, $keylink);
	$showValues["COD_MODELO"] = $value;
	$showFields[] = "COD_MODELO";
		$showRawValues["COD_MODELO"] = substr($data["COD_MODELO"],0,100);
...
//	LICENCIAMENTO - Short Date
	...
	$showValues["LICENCIAMENTO"] = $value;
	$showFields[] = "LICENCIAMENTO";
		$showRawValues["LICENCIAMENTO"] = substr($data["LICENCIAMENTO"],0,100);
/////////////////////////////////////////////////////////////
//	start inline output
/////////////////////////////////////////////////////////////
...
$xt->assign("viewlink_attrs","id=\"viewButton".$id."\" name=\"viewButton".$id."\" onclick=\"window.location.href='C000054_view.php?".$viewlink."'\"");
