...

{
    ...
    DTSALDO :TdateTime;
      ...
      function  GetSQREMESSA         : Integer;
      function  GetNOCONVENIO        : Integer;
      function  GetVLSALDO           : Double;
      function  GetCDHISTORICO       : integer;
      ...
      procedure  SetSQREMESSA         (Value : Integer);
      procedure  SetNOCONVENIO        (Value : Integer);
      procedure  SetVLSALDO           (Value : double);
      procedure  SetCDHISTORICO       (Value : integer);
      ...
      property  SQNOSSONUMERO     : Integer    read GetSQNOSSONUMERO     write SetSQNOSSONUMERO;
      ...
      property  SQREMESSA         : Integer    read GetSQREMESSA     write SetSQREMESSA;
      property  NOCONVENIO        : Integer    read GetNOCONVENIO     write SetNOCONVENIO;
      property  VLSALDO           : double    read GetVLSALDO      write SetVLSALDO ;
      property  CDHISTORICO       : integer    read GetCDHISTORICO     write SetCDHISTORICO;
...
uses SysUtils,DB, IBCustomDataSet, IBQuery;
      ...
      End;
      function  TCONTACORRENTE.GetSQREMESSA         : Integer;
      Begin
      Result := Self.FSQREMESSA;
      End;
      function  TCONTACORRENTE.GetNOCONVENIO        : Integer;
      Begin
      ...
      End;
      function  TCONTACORRENTE.GetCDHISTORICO       : integer;
      Begin
      ...
      End;
      procedure  TCONTACORRENTE.SetNOTRADUTOR        (Value : Integer);
      Begin
      ...
      End;
      procedure  TCONTACORRENTE.SetSNNOSSONUMAUTO    (Value : String);
      Begin
      ...
      End;
      procedure  TCONTACORRENTE.SetSQREMESSA         (Value : Integer);
      Begin
        Self.FSQREMESSA := Value;
      End;
      procedure  TCONTACORRENTE.SetNOCONVENIO        (Value : integer);
      Begin
      ...
      Begin
        Self.FVLSALDO := Value;
      End;
      procedure  TCONTACORRENTE.SetCDHISTORICO       (Value : Integer);
      Begin
