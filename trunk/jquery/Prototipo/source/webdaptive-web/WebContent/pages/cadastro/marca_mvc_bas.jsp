...
<jsp:include page="../../scripts/pages/cadastro/marca_mvc_bas_main.js.jsp" flush="true"/>
<jsp:include page="../../scripts/pages/cadastreo/marca_mvc_bas_init.js.jsp" flush="true"/>
</body>
</html>