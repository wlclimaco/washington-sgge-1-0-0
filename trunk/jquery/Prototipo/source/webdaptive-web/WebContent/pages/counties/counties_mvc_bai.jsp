...
<body>
	<div style="width:100%;height:100%;float:left;">
		<div class="grid-header" style="width:100%">
		    <span id="listcountiesBAI" style="float:left; width: 16px; height: 16px; background-image:url('../images/text_list.png')" title="List Counties"></span>
		<sec:authorize access="hasRole('ROLE_DOMAIN ADMINS')">
		    <span id="refreshcountiesBAI" style="float:right" class="ui-icon ui-icon-refresh" title="Rebuild Counties"></span>
		</sec:authorize>
		</div>
		<div id="countiesMVCBAIGrid" style="width:100%; height:100%;" class="wdgrid"></div>
	</div>
...
<jsp:include page="../../scripts/pages/counties/counties_mvc_bai_main.js.jsp" flush="true"/>
<jsp:include page="../../scripts/pages/counties/counties_mvc_bai_init.js.jsp" flush="true"/>
</body>
</html>
