...
<body>
	<div style="width:100%;height:100%;float:left;">
		<div class="grid-header" style="width:100%">
		    <span id="listCli" style="float:left; width: 16px; height: 16px; background-image:url('../images/text_list.png')" title="List Procedures"></span>
			<sec:authorize access="hasAnyRole('ROLE_DOMAIN USERS', 'ROLE_DOMAIN ADMINS')">
		    <span id="refreshCli" style="float:right" class="ui-icon ui-icon-refresh" title="Rebuild Procedures"></span>
			</sec:authorize>
		</div>
		<div id="CliGrid" style="width:100%; height:95%;" class="wdgrid" ></div>
...
<jsp:include page="../../scripts/pages/clientes/cliente_mvc_bas_main.js.jsp" flush="true"/>
<jsp:include page="../../scripts/pages/clientes/cliente_mvc_bas_init.js.jsp" flush="true"/>
</body>
</html>