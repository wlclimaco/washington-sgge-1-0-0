package com.qat.samples.sysmgmt.marcamenu.baid;
 ...
 */
public final class MarcaMenuBAID
{
	...
	/** The Constant LOG. */
	private static final Logger LOG = LoggerFactory.getLogger(MarcaMenuBAID.class);

	/**
	 * Required for final classes to insure no one tries to instantiate it.
	 */
	private MarcaMenuBAID()
	{
	}
