...
type
  ...
  public
    ...
    function ProximaAtividade(pDsCreden: AnsiString; pCdUsuari: Integer; var pNrMapa: AnsiString; var pDsAtivid: AnsiString): AnsiString;
    function ConferenciaEntradaIniciar(pDsCreden: AnsiString; pCdUsuari: Integer; pNrMapa: AnsiString; var pNrNota: AnsiString; var pDsLista: AnsiString): AnsiString;
    function ConferenciaEntradaFinalizar(pDsCreden: AnsiString; pCdUsuari: Integer; pNrMapa: string; pDsLista: string; pSnCancel: string): AnsiString;
    function GravarOperacaoLogistica(pDsCreden: AnsiString; pCdUsuari: Integer; pNmFormul: AnsiString; pCdArmaze: Integer; pCdsW005: OleVariant; pCdsW006: OleVariant; pCdsW007: OleVariant): AnsiString;
  end;
...
function TSDmWmsClient.ProximaAtividade(pDsCreden: AnsiString; pCdUsuari: Integer; var pNrMapa: AnsiString; var pDsAtivid: AnsiString): AnsiString;
begin
  ...
  FProximaAtividadeCommand.Parameters[0].Value.SetAnsiString(pDsCreden);
  FProximaAtividadeCommand.Parameters[1].Value.SetInt32(pCdUsuari);
  FProximaAtividadeCommand.Parameters[2].Value.SetAnsiString(pNrMapa);
  FProximaAtividadeCommand.Parameters[3].Value.SetAnsiString(pDsAtivid);
  FProximaAtividadeCommand.ExecuteUpdate;
  pNrMapa := FProximaAtividadeCommand.Parameters[2].Value.GetAnsiString;
  pDsAtivid := FProximaAtividadeCommand.Parameters[3].Value.GetAnsiString;
  Result := FProximaAtividadeCommand.Parameters[4].Value.GetAnsiString;
end;

function TSDmWmsClient.ConferenciaEntradaIniciar(pDsCreden: AnsiString; pCdUsuari: Integer; pNrMapa: AnsiString; var pNrNota: AnsiString; var pDsLista: AnsiString): AnsiString;
begin
  ...
  FConferenciaEntradaIniciarCommand.Parameters[0].Value.SetAnsiString(pDsCreden);
  FConferenciaEntradaIniciarCommand.Parameters[1].Value.SetInt32(pCdUsuari);
  FConferenciaEntradaIniciarCommand.Parameters[2].Value.SetAnsiString(pNrMapa);
  FConferenciaEntradaIniciarCommand.Parameters[3].Value.SetAnsiString(pNrNota);
  ...
  pNrNota := FConferenciaEntradaIniciarCommand.Parameters[3].Value.GetAnsiString;
...
function TSDmWmsClient.ConferenciaEntradaFinalizar(pDsCreden: AnsiString; pCdUsuari: Integer; pNrMapa: string; pDsLista: string; pSnCancel: string): AnsiString;
begin
  ...
  FConferenciaEntradaFinalizarCommand.Parameters[0].Value.SetAnsiString(pDsCreden);
  FConferenciaEntradaFinalizarCommand.Parameters[1].Value.SetInt32(pCdUsuari);
  FConferenciaEntradaFinalizarCommand.Parameters[2].Value.SetWideString(pNrMapa);
  FConferenciaEntradaFinalizarCommand.Parameters[3].Value.SetWideString(pDsLista);
  FConferenciaEntradaFinalizarCommand.Parameters[4].Value.SetWideString(pSnCancel);
...
function TSDmWmsClient.GravarOperacaoLogistica(pDsCreden: AnsiString; pCdUsuari: Integer; pNmFormul: AnsiString; pCdArmaze: Integer; pCdsW005: OleVariant; pCdsW006: OleVariant; pCdsW007: OleVariant): AnsiString;
begin
  ...
  FGravarOperacaoLogisticaCommand.Parameters[4].Value.AsVariant := pCdsW005;
  FGravarOperacaoLogisticaCommand.Parameters[5].Value.AsVariant := pCdsW006;
  FGravarOperacaoLogisticaCommand.Parameters[6].Value.AsVariant := pCdsW007;
  FGravarOperacaoLogisticaCommand.ExecuteUpdate;
  Result := FGravarOperacaoLogisticaCommand.Parameters[7].Value.GetAnsiString;
end;
