inherited Mov0024: TMov0024
  Caption = 'MOV0024 - Recep'#231#227'o de Lote'
  ClientHeight = 473
  ClientWidth = 752
  ExplicitWidth = 760
  ExplicitHeight = 500
  ...
  object DsF012: TDataSource
    DataSet = CpF012
    Left = 72
    Top = 72
  end
  object CpF012: TBrvClientDataSet
    Aggregates = <>
    Params = <>
    AfterScroll = CpF012AfterScroll
