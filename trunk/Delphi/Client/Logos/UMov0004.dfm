inherited Mov0004: TMov0004
  Left = 465
  Top = 152
  Caption = 'Mov0004 - Lan'#231'amentos cont'#225'beis'
  ClientHeight = 494
  ClientWidth = 619
  ExplicitWidth = 635
  ExplicitHeight = 532
  ...
  inherited PnlFundo: TPanel
    ...
    object Panel2: TPanel
      ...
      object BntDebito: TSpeedButton
        Left = 197
        Top = 4
        Width = 23
        Height = 22
        Hint = 'Lan'#231'ar Contas de D'#233'bito'
        Caption = '...'
        ParentShowHint = False
        ShowHint = True
        OnClick = BntDebitoClick
      end
      object BntCredit: TSpeedButton
        Left = 197
        Top = 78
        Width = 23
        Height = 22
        Hint = 'Lan'#231'ar Contas de Cr'#233'dito'
        Caption = '...'
        ParentShowHint = False
        ShowHint = True
        OnClick = BntCreditClick
      end
      ...
      object BntLimDep: TSpeedButton
        ...
        ParentShowHint = False
        ShowHint = True
        OnClick = BntLimDepClick
      end
      object BntLimCre: TSpeedButton
        Left = 221
        Top = 78
        Width = 23
        Height = 22
        Hint = 'Limpar Conta de Cr'#233'dito'
        Glyph.Data = {
          DE010000424DDE01000000000000760000002800000024000000120000000100
          0400000000006801000000000000000000001000000000000000000000000000
          80000080000000808000800000008000800080800000C0C0C000808080000000
      ...
      object EdtMasConCre: TMaskEdit
        ...
        ParentFont = False
        TabOrder = 4
        OnDragDrop = EdtNrConCreDragDrop
        OnDragOver = EdtNrConDebDragOver
        OnExit = EdtNrConCreExit
      end
      object EdtMasConDeb: TMaskEdit
        Left = 105
        Top = 26
        Width = 89
        Height = 22
        ...
        ParentFont = False
        TabOrder = 1
        OnDragDrop = EdtNrConDebDragDrop
        OnDragOver = EdtNrConDebDragOver
        OnExit = EdtNrConDebExit
      end
      object EdtNrDocto: TEdit
        Left = 105
        Top = 149
        Width = 89
        Height = 21
      ...
      object EdtNrConDeb: TBrvEditNum
        Left = 105
        Top = 4
        Width = 89
        Height = 21
        ...
        BrOnBeforeConsulta = EdtNrConDebBrOnBeforeConsulta
        BrDicionario = DmSrvApl.BrvDicionario
        BrQueryCode = 0
        BrRecordar = False
      end
      object EdtNrConCre: TBrvEditNum
        Left = 105
        Top = 78
        Width = 89
        Height = 21
        ...
        BrVisibleButton = True
        BrFunctionButton = TpConsulta
        BrOnBeforeConsulta = EdtNrConCreBrOnBeforeConsulta
        BrDicionario = DmSrvApl.BrvDicionario
        BrQueryCode = 0
        BrRecordar = False
      end
      object LblDsCeCuDe: TBrvRetCon
        Left = 245
        Top = 49
        Width = 358
        Height = 21
      ...
      object EdtCdCeCuCr: TBrvEditNum
        Left = 105
        Top = 123
        Width = 89
        Height = 21
        ...
        BrConfigurar.Strings = (
          'EdtCdCeCuCr;CdCenCus;S;S;'
          'LblDsCeCuCr;DsCenCus;S;N;')
        BrDicionario = DmSrvApl.BrvDicionario
        BrQueryCode = 35
        BrRecordar = False
      end
      object EdtVrLancto: TBrvEditNum
        ...
        BrAsFloatSQL = '0.000'
        BrVisibleButton = True
        BrFunctionButton = TpCalculadora
        BrQueryCode = 0
        BrRecordar = False
      end
      object EdtCdCeCuDe: TBrvEditNum
        Left = 105
        Top = 49
        Width = 89
        Height = 21
        ...
        BrFunctionButton = TpConsulta
        BrConfigurar.Strings = (
          'EdtCdCeCuDe;CdCenCus;S;S;'
          'LblDsCeCuDe;DsCenCus;S;N;')
        BrDicionario = DmSrvApl.BrvDicionario
        BrQueryCode = 35
        BrRecordar = False
      end
  ...
  inherited ImlPopFrm: TImageList
    ...
    Bitmap = {
      ...
      
      000000000000}
  end
