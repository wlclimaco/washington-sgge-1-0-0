...
begin
      ...
      memo1.Lines.Add('		}');
      memo1.Lines.Add('');
      memo1.Lines.Add('		if (!ValidationUtil.isNull(inquiry'+BrvFuncoesXE.PrimeiraMaiscula(Txt)+'Request.get'+BrvFuncoesXE.PrimeiraMaiscula(Txt)+'s()))');
      memo1.Lines.Add('		{');
      memo1.Lines.Add('			paramMap.put('+UpperCase(Txt)+'_ID, inquiry'+BrvFuncoesXE.PrimeiraMaiscula(Txt)+'Request.get'+BrvFuncoesXE.PrimeiraMaiscula(Txt)+'s().get(0).getCodemp());');
      memo1.Lines.Add('		}');
      memo1.Lines.Add('');
      ...
      memo1.Lines.Add('	/*');
      memo1.Lines.Add('	 * (non-Javadoc) ');
      memo1.Lines.Add('	 * @see com.sensus.mlc.'+LowerCase(Txt)+'.dao.I'+BrvFuncoesXE.PrimeiraMaiscula(Txt)+'DAO#fetch'+BrvFuncoesXE.PrimeiraMaiscula(Txt)+'ById(com.sensus.mlc.'+LowerCase(Txt)+'.model.'+BrvFuncoesXE.PrimeiraMaiscula(Txt)+'');
      memo1.Lines.Add('	 */ ');
      memo1.Lines.Add('	@Override');
      ...
      memo1.Lines.Add('	{ ');
      memo1.Lines.Add('		InternalResultsResponse<'+BrvFuncoesXE.PrimeiraMaiscula(Txt)+'> response = new InternalResultsResponse<'+BrvFuncoesXE.PrimeiraMaiscula(Txt)+'>();');
      memo1.Lines.Add('		doQueryForList(getSqlSession(), FETCH_'+UpperCase(Txt)+'_BY_ID, '+LowerCase(Txt)+'Request, response);');
      memo1.Lines.Add('		return response;');
      memo1.Lines.Add('	}');
      memo1.Lines.Add('');
      memo1.Lines.Add('	/*');
      ...
      memo1.Lines.Add('		'+LowerCase(Txt)+'.setCodEmp((Integer)doQueryForObject(getSqlSession(), INSERT_'+UpperCase(Txt)+', '+LowerCase(Txt)+'Request));');
		  memo1.Lines.Add('   '+LowerCase(Txt)+'.setListinsalt((List<Auditoria>)doQueryForObject(getSqlSession(), INSERT_EMPRESA, '+LowerCase(Txt)+'Request));');
      memo1.Lines.Add('		InternalResultsResponse<'+BrvFuncoesXE.PrimeiraMaiscula(Txt)+'> response = new InternalResultsResponse<'+BrvFuncoesXE.PrimeiraMaiscula(Txt)+'>();');
...
begin
      ...
      memo1.Lines.Add('	{ ');
      memo1.Lines.Add('		InternalResultsResponse<Empresa> response = get'+BrvFuncoesXE.PrimeiraMaiscula(Txt)+'DAC().update'+BrvFuncoesXE.PrimeiraMaiscula(Txt)+'('+LowerCase(Txt)+'Request);');
      memo1.Lines.Add('');
      memo1.Lines.Add('		if (!response.isInError()) ');
      memo1.Lines.Add('		{ ');
      ...
      memo1.Lines.Add('		actionParameters.add(new LCActionParameter(PropertyEnum.EMPRESA_ID, String.valueOf(empresa.getCodemp())));');
		  memo1.Lines.Add('   actionParameters.add(new LCActionParameter(PropertyEnum.EMPRESA_ID, empresa.getCodemp().toString()));');
		  memo1.Lines.Add('   InquiryLightRequest lightRequest = createInquiryLightRequest(empresaRequest);');
