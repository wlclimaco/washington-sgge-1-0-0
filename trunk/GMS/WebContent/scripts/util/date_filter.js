...
$.fn.wDateFilters = function(table,fnGraph) {
	...
	$('#actions-options').append('<div class="right">'
			...
			+ '<li id="1d"><a class="0" href="#">1' +  $.sc.locale("analytics.page.day") + '</a></li>'
			+ '<li id="3d"><a class="2" href="#">3' + $.sc.locale("analytics.page.day") + '</a></li>'
			+ '<li id="1w"><a class="6" href="#">1' + $.sc.locale("analytics.page.week") + '</a></li>'
            + '<li id="1m"><a class="29" href="#">1' + $.sc.locale("analytics.page.month") + '</a></li>'
            + '<li id="3m"><a class="90" href="#">3' + $.sc.locale("analytics.page.month") + '</a></li>'
            + '<li id="ytd"><a class="ytd" href="#">YTD</a></li>'
            + '<li id="1y"><a class="365" href="#">1' + $.sc.locale("analytics.page.year")+ '</a></li>');
