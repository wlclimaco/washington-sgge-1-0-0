...
sensus.pages.process = {
	...
	generateCsvFile : function() {
		...
		var data = new inquiryProcessRequest(oSearch);
		if(aSort){

			data.sortExpressions = aSort;

		}

		data.action = "eventHistory";
		sensus.util.exportcsv.bReload = true;
		sensus.util.exportcsv.generateCSV("api/export/initiate", "api/export/download",data,true);
