...
$(document).ready(function() {
	...
	if (nUserId) {
		...
		//$.sc.getJson(sensus.settings.fillUserPage, {'userRequest' : new userRequest(nUserId)}, false, sensus.pages.createUser.fnFillUser);

		//var req = new userRequest({action: "fetchById", user: {id: nUserId}});
