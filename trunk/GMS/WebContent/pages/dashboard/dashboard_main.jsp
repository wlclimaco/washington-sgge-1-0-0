...
<%@ taglib uri="http://www.springframework.org/tags" prefix="s" %>
	...
	<div id="dashboard">
	                ...
	                <tr class="">
	                    <td  class="first">
	                    	...
	                    	<span id="totalinstalled">
	                    		<a class="afilter" href="light/?noFilter=1"> </a>
                    		</span>
	                    ...
	                    <td>
	                    	...
	                    	<span id="totalalarms">
	                    		<a class="afilter" href="light/?status=1|"> </a>
                    		</span>
                    		<small><s:message code="dashboard.page.currenttotal" /></small>
                    	</td>
	                    <td>
	                    	...
	                    	<span id="totalwarnings">
	                    		<a class="afilter" href="light/?status=2|"> </a>
                    		</span>
                    		<small><s:message code="dashboard.page.currenttotal" /></small>
                    	</td>
	                    <td>
	                    	...
	                    	<span id="totalconsumption">
	                    		<a class="afilter" href="analytics/?tb=&ty=4&g=&di=&de=&dt=&db=true"> </a><sup id="kwh-1"></sup>
                    		</span>
						...
						<c:if test="${userContext.getTenant().getEcoModeDisable() == false}">
							<td>
								...
								<span id="totaleco-mode">
									<a class="afilter" href="analytics/?tb=&ty=5&g=&di=&de=&dt=&db=true"> </a>%
								</span>
							...
							<td class="last">
								...
								<span id="totalcarboncredits">
									<a class="afilter" href="analytics/?tb=&ty=6&g=&di=&de=&dt=&db=true"> </a>
									<sup> cc</sup>
								</span>
	            ...
	            <div id="kpi_container">
	                <table>
	                    ...
	                    <tbody>
	                        ...
	                        <tr>
	                            <td id="activity-alarms" class="row-title-sub"><a id="lighting_alarm" class="afilter" href="analytics/?tb=&ty=1&g=1&di=&de=&dt="></a></td>
	                        ...
	                        <tr class="alt">
	                            <td id="activity-warnings" class="row-title-sub"><a id="lighting_warning" class="afilter" href="analytics/?tb=&ty=2&g=1&di=&de=&dt=&db=true"></a></td>
	                            ...
	                            <td id="activity-installed" class="row-title-sub"><a id="lighting_installed" class="afilter" href="analytics/?tb=&ty=3&g=1&di=&de=&dt=&db=true"></a></td>
		...
		<%@ include file="../../scripts/pages/dashboard_main.js.jsp" %>
		<%@ include file="../../scripts/pages/dashboard_init.js.jsp" %>
