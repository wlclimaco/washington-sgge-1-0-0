...
{$R *.dfm}
    ...
    function TFrmCadTitPa.GravarTitulo():Boolean;
    VAR PARCELA   : Integer;
        VALORpAR  :dOUBLE;
        DATA : tDATETIME;
    begin
...
procedure TFrmCadTitPa.SpeedButton1Click(Sender: TObject);
begin
GravarTitulo;
end;

procedure TFrmCadTitPa.DBGrid1DrawColumnCell(Sender: TObject; const Rect: TRect;
  DataCol: Integer; Column: TColumn; State: TGridDrawState);
{var
  BUTTON: Integer;
  R: TRect;
...
procedure TFrmCadTitPa.DBGrid1EditButtonClick(Sender: TObject);
