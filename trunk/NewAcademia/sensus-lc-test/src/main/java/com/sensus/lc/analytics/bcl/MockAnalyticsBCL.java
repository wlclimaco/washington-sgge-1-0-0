...
public class MockAnalyticsBCL extends AbstractMockBase implements IAnalyticsBCL
{
	...
	/*
	 * (non-Javadoc)
	 * @see com.sensus.lc.analytics.bcl.IAnalyticsBCL#fetchAllAnalyticsByGroup(com.sensus.lc.analytics.model.request.
	 ...
	 * (non-Javadoc)
	 * @see
	 * com.sensus.lc.analytics.bcl.IAnalyticsBCL#fetchAnalyticsAlarmsByStatusId(com.sensus.lc.analytics.model.request
	 * .AnalyticsRequest)
	 */
	@Override
	 ...
	 * (non-Javadoc)
	 * @see
	 * com.sensus.lc.analytics.bcl.IAnalyticsBCL#fetchAnalyticsAlertsByType(com.sensus.lc.analytics.model.request.
	 * AnalyticsRequest)
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see com.sensus.lc.analytics.bcl.IAnalyticsBCL#fetchAllAnalyticsByDate(com.sensus.lc.analytics.model.request.
	 * AnalyticsRequest)
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see com.sensus.lc.analytics.bcl.IAnalyticsBCL#fetchDashboardResume(com.sensus.lc.analytics.model.request.
	 * AnalyticsRequest)
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see com.sensus.lc.analytics.bcl.IAnalyticsBCL#fetchDashboarHeader(com.sensus.lc.analytics.model.request.
	 * AnalyticsRequest)
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see com.sensus.lc.analytics.bcl.IAnalyticsBCL#parseAnalyticsGroupAlarm(java.util.List)
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see com.sensus.lc.analytics.bcl.IAnalyticsBCL#parseAnalyticsGroupWarning(java.util.List)
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see com.sensus.lc.analytics.bcl.IAnalyticsBCL#parseAnalyticsEcoMode(java.util.List)
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see com.sensus.lc.analytics.bcl.IAnalyticsBCL#parseAnalyticsGroupTypeLight(java.util.List)
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see com.sensus.lc.analytics.bcl.IAnalyticsBCL#parseAnalyticsGroupCarbonCredits(java.util.List)
	 */
	@Override
	 ...
	 * (non-Javadoc)
	 * @see
	 * com.sensus.lc.analytics.bcl.IAnalyticsBCL#fetchAllAnalyticsGroup(com.sensus.lc.analytics.model.request.
	 * AnalyticsRequest)
	 */
	@Override
			...
			InternalResultsResponse<AnalyticsGroupColumns> response)
	{
		...
		if (getSituationsEnum() == SituationsEnum.SUCCESS)
		{
			...
			response.addResult(new AnalyticsGroupColumns(AnalyticsTypeEnum.LIGHTING_ECOMODE, ANALYTICS_GROUP_41_0,
					ANALYTICS_GROUP_21_0, ANALYTICS_GROUP_10_0));
			response.addResult(new AnalyticsGroupColumns(AnalyticsTypeEnum.ECOMODE_CARBON_CREDITS, ANALYTICS_GROUP_4_0,
					ANALYTICS_GROUP_2_0, ANALYTICS_GROUP_1_0));
			response.setStatus(Status.OperationSuccess);
		}
		if (getSituationsEnum() == SituationsEnum.ERROR)
		{
	 ...
	 * (non-Javadoc)
	 * @see
	 * com.sensus.lc.analytics.bcl.IAnalyticsBCL#insertCSVProcess(com.sensus.lc.base.model.request.LightSelectionRequest
	 * )
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see com.sensus.lc.analytics.bcl.IAnalyticsBCL#deleteDashboardResumeByTenant(com.sensus.lc.tenant.model.Tenant)
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see com.sensus.lc.analytics.bcl.IAnalyticsBCL#calculateDashboardResume(com.sensus.lc.tenant.model.Tenant,
	 * com.sensus.lc.analytics.model.AnalyticsGroup)
	 */
	@Override
	 ...
	 * (non-Javadoc)
	 * @see
	 * com.sensus.lc.analytics.bcl.IAnalyticsBCL#fetchAllGroupsByTenantForDashboard(com.sensus.lc.tenant.model.Tenant)
	 */
	@Override
	...
	{
		CSVInternalResponse response = new CSVInternalResponse(TestBaseUtil.FILE_NAME);
		if (getAreaEnum() != LCAreaEnum.ANALYTICS)
		{
			return response;
		}
