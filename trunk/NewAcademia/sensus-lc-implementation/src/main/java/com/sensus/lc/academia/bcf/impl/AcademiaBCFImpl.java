package com.sensus.lc.academia.bcf.impl;
...
public class AcademiaBCFImpl implements IAcademiaBCF
{
	...
	@Override
	public InquiryAcademiaResponse fetchAllAcademiaByUser(InquiryAcademiaRequest inquiryAcademiaRequest)
	{
		InquiryAcademiaResponse response = new InquiryAcademiaResponse();
		...
		try
		{
			...
			ValidationContext context = new ValidationContext();
			context.putObjectToBeValidated(TenantRequest.class.getSimpleName(), inquiryAcademiaRequest);
			context.putObjectToBeValidated(Academia.class.getSimpleName(), inquiryAcademiaRequest.getAcademias());

			// if (getTenantRequestValidationController().validate(context))
			// {
			internalResponse = getAcademiaBCL().fetchAllAcademiaByUser(inquiryAcademiaRequest);
			response.setAcademias(internalResponse.getResultsList());
			// }
