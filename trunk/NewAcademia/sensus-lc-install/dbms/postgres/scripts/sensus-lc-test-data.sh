...
echo "* /PostgreSQL/9.2/bin as the Postgres bin folder."
echo "* You can change the default data by editing this file."
echo "*************************************************************************"
echo "Press enter to continue"; read line

./test-data/strut-test-data.sh postgres postgres /tmp/dbms/postgres/scripts/test-data /usr/pgsql-9.2/bin
