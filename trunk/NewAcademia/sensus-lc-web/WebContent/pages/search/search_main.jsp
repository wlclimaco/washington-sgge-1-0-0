...
<%@ taglib uri="http://www.springframework.org/tags" prefix="s" %>
         ...
         <div class="yui-ge point-type-navigation header rounded-top-corners">
             <div class="yui-u first">
                 <ul class="tabs">
                    <li><a class="afilter" href="light?sd=true"><s:message code="search.tabs.search" /></a></li>
    ...
    <%@ include file="../../scripts/pages/search/saved_main.js.jsp" %>
	<%@ include file="../../scripts/pages/search/saved_init.js.jsp" %>
