...
<div id="address" class="point-detail-container">
	...
	<sec:authorize access="hasAnyRole('ROLE_Role.Admin', 'ROLE_Role.System Operator')">
		<fieldset class="edit-only hide">
			<div class="edit-only highlight" style="display: block;">
				<span class="icon-small icn-map-edit"></span> <s:message code="smartpointdetail.location.editlocationDrag"/>
			</div>
			<ul>
				<form id="update-coordinates-form">
					...
					<li class="submit-row-pad">
						<input id="submit-edit" type="submit" value="<s:message code='smartpointdetail.location.save'/>" /> <s:message code="smartpointdetail.location.or"/> <a id="cancel-edit" href="#" class="cancel-edit cancel"><s:message code="smartpointdetail.location.cancel"/></a>
					</li>
				</form>
			</ul>
		</fieldset>
...
<script src="scripts/pages/light/modules/module_light_location.js"></script>
<!-- End Address -->