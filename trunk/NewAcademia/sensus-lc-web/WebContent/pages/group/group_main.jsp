...
<div id="actions" class="yui-u add-action first">
	...
	<sec:authorize access="hasAnyRole('ROLE_Role.Admin')">
		<a tabindex="0" id="ajax-button" href="" class="fg-button ui-widget ui-state-default ui-corner-all group-create alist">
...
<table id="group-table" class="list table-selection">
	<thead>
		<tr>
			...
			<th><span id="light_count"><s:message code="group.table.header.smartpoints" /></span></th>
...
<jsp:include page="../../scripts/pages/academia/academia_main.js.jsp" flush="true"/>
<jsp:include page="../../scripts/util/insert_update_actions.js.jsp" flush="true"/>
