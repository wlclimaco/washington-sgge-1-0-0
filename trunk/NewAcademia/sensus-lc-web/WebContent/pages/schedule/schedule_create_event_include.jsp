			...
			<fieldset>
				<div id="radio_light{iCount}">
					<div class="control">
						...
						<input type="radio" id="radio3{iCount}" name="radio{iCount}" class="validate[required] dimmer-options"/><label for="radio3{iCount}"><s:message code="schedulecreate.page.blink" /><span class="label-desc"></span>
						<div id="blink_options{iCount}" class="control_schedule ui-dialog button-options hide">
	                        <ul>
