...
.ui-state-success {
	background: url("thirdparty/jquery/ui/images/ui-bg_inset-soft_95_fef1ec_1x100.png") repeat-x scroll 50% bottom #FFFFEE;
    border: 1px solid #FCEFA1;
    color: #333333;
}

.ui-state-error, .ui-widget-content .ui-state-error, .ui-widget-header .ui-state-error {
    background: url("thirdparty/jquery/ui/images/ui-bg_inset-soft_95_fef1ec_1x100.png") repeat-x scroll 50% bottom #FEF1EC;
...
function init()
{
	...
	if (msg.indexOf("Not a valid Tenant!") != -1) {
	...
	if(msg.indexOf("Maximum sessions of 5 for this principal exceeded") != -1)
	{
		elementMsg.setAttribute("class", "ui-corner-all ui-state-error");
		elementMsg.setAttribute("className", "ui-corner-all ui-state-error");
		elementMsg.innerHTML = "The user exceeded the number of 5 connections allowed.";
	}
			...
			|| msg.indexOf("User does not have permissions!") != -1){
...
<div id="hd" class="yui-gf">
	<div class="logo">
		...
		<h1><a href="/">Sensus</a></h1>
		<h3>Sensus Lighting Control</h3>
...
Sensus. All rights reserved.</div>
</div>
</div>
<%-- Footer Links --%>
