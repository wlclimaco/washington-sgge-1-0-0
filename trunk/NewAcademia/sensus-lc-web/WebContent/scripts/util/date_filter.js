...
$.fn.wDateFilters = function(table,fnGraph) {
	...
	$('#actions-options').append('<div class="right">'
			...
			+ '<li id="1w"><a class="7" href="#">1' + $.sc.locale("analytics.page.week") + '</a></li>'
            + '<li id="1m"><a class="1m" href="#">1' + $.sc.locale("analytics.page.month") + '</a></li>'
            + '<li id="3m"><a class="3m" href="#">3' + $.sc.locale("analytics.page.month") + '</a></li>'
