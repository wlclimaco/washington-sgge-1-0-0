...
/**
 * The Class FilterActionTypes.
 */
@Component
public class FilterActionTypes extends AbstractFilterBase
{
	...
	{
		return ACTION_TYPE.equals(filter);
	}
	...
	{
		filtersResponse.setAction_type(new FiltersModel(FILTER_TYPE_CHECKBOX, getEventActionTypes()));
	}
