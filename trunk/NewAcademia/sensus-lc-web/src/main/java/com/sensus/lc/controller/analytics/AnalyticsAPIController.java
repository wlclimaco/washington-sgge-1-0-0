...
public class AnalyticsAPIController extends BaseController
{
	...
	/** The Constant FETCH. */
	private static final String FETCH_ANALYTICS = "/fetch";

	/** The Constant FETCH_ANALYTICS_GROUP. */
	private static final String FETCH_ANALYTICS_GROUP = "/fetchAllGroup";
	 ...
	 */
	@RequestMapping(value = FETCH_ANALYTICS, method = RequestMethod.POST)
	@ResponseBody
	 ...
	 */
	@RequestMapping(value = FETCH_ANALYTICS_GROUP, method = RequestMethod.POST)
	@ResponseBody
	public AnalyticsResponse fetchGroup(
			...
			HttpServletRequest request)
	{
		...
		try
		{
			...
			analyticsResponse = getAnalyticsBCF().fetchAllAnalyticsGroup(AnalyticsRequest);
