...
/**
 * The Class FilterDateAdded.
 */
@Component
public class FilterDateAdded extends AbstractFilterBase
{
	...
	{
		return DATE_ADDED.equals(filter);
	}
	...
	{
		filtersResponse.setDate_added(new FiltersModel(FILTER_TYPE_TEXT, getCommonTextInputs()));
	}
