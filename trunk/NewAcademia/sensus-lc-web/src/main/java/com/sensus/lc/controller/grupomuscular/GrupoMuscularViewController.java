...
public class GrupoMuscularViewController extends BaseViewController
{
	...
	/** The Constant LOG. */
	private static final Logger LOG = LoggerFactory.getLogger(GrupoMuscularViewController.class);
