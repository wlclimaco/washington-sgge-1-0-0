 ...
 *
 */
public enum IntensityEnum implements IIntegerEnum
{
	/** The LEVEL_0 = OFF. */
	LEVEL_0(0, 0),
	 ...
	 */
	private IntensityEnum(Integer intensityParam, Integer percentageParam)
	{
	 ...
	 */
	public static IntensityEnum enumForValue(Integer value)
	{
		for (IntensityEnum e : values())
		{
	...
	public static String getValidValues()
	{
		...
		for (IntensityEnum i : IntensityEnum.class.getEnumConstants())
		{
