...
public class Event extends SensusModel
{
	...
	/** The blink status. */
	private BlinkStatusEnum lightBlinkEnum;
	 ...
	 */
	public BlinkStatusEnum getLightBlinkEnum()
	{
	 ...
	 */
	public void setLightBlinkEnum(BlinkStatusEnum lightBlinkEnum)
	{
	...
	{
		lightBlinkEnum = BlinkStatusEnum.enumForValue(blink);
	}
