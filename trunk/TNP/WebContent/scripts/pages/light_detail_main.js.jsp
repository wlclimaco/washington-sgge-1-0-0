...
sensus.pages.smartpoint.detail = {
	...
	addSmartpointToGroup : function() {
		...
		$("#groups .submit-short-form").click(function() {
			...
			if (sensus.util.combobox.getOption("#group-add-select") != undefined
				...
				sensus.util.ajaxaction.sendActionDefault($.sc.locale("smartpoint.actions.addgroup.success", sGroupName), $.sc.locale("action.addgroup.error"));
	...
	removeSmartpointFromGroup : function() {
		$("#groups a.delete").click(function() {
			...
			sensus.util.ajaxaction.sendActionDefault($.sc.locale("smartpoint.actions.removegroup.success", sGroupName), $.sc.locale("action.addgroup.error"));
	...
	resetValues :  function() {
		...
		sensus.util.ajaxaction.sendActionDefault($.sc.locale("smartpointdetail.action.resetvalues.success"), $.sc.locale("widgets.customize.errorRequest"));
	...
	*/
	...
	setUpdatedProtected : function() {
		...
		$('.update-light-protected').click(function() {
			...
			sensus.util.ajaxaction.sendActionDefault($.sc.locale("action.longRunningProcessDialog.confirm"), $.sc.locale("action.longRunningProcessDialog.error"));
