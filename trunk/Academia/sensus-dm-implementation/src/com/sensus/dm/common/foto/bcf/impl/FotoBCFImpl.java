package com.sensus.dm.common.foto.bcf.impl;
...
import com.sensus.dm.common.foto.bcf.IFotoBCF;
...
public class FotoBCFImpl implements IFotoBCF
{
	...
	public InquiryFotoResponse fetchAllFotos(InquiryFotoRequest inquiryFotoRequest)
	{
		...
		try
		{
			...
			context.putObjectToBeValidated(BaseSearch.class.getSimpleName(),
					inquiryFotoRequest.getDeviceSearch());
	...
	@Override
	public DeviceResponse fetchDevicesByFoto(FotoRequest fotoRequest)
	{
