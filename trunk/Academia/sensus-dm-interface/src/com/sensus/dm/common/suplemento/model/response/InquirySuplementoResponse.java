package com.sensus.dm.common.suplemento.model.response;
...
public class InquirySuplementoResponse extends InquiryResponse
{
	...
	{
		return "InquirySuplementoResponse [suplementos=" + suplementos + ", fileName=" + fileName + ", getSuplementos()=" + getSuplementos()
