	...
	<div id="action-han-detail" class="action-dialog">
		<form action="" method="post">
			<fieldset id="" class="create-action-container">
				<legend><span class="left"><strong class="field-header-device-type"></strong> <small class="field-flex-net-id"><span></span> <a href="" class="text-button launch"><spring:message code="smartpointdetail.dialog.deviceInformation.viewDetailPage"/></a></small></span></legend>
