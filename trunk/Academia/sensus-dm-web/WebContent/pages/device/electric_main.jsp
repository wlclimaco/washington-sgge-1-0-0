...
<sec:authorize access="hasRole('ROLE_EPM_SERVICE_ELECTRIC') and
	...
	<div class="yui-ge point-type-navigation header rounded-top-corners">
		<div class="yui-u first">
			<ul class="tabs device-tabs">
				<li id="ihd">
					<a href="#HAN_DEVICE|-IHD|">
						<spring:message code="commons.pages.inHomeDisplays" />
					</a>
				</li>
				<li id="sensus-load-control">
					<a href="#LCM|" >
						<spring:message code="smartpoint.page.tab.sensus_load_control" />
					</a>
				</li>
				<li id="meters">
					<a href="#ELECTRIC_METER|" class="gradient-vert">
						<spring:message code="commons.pages.Meters" />
					</a>
				</li>
				<li id="thermostat">
					<a href="#HAN_DEVICE|-THERMOSTAT|">
						<spring:message code="commons.pages.thermostats" />
					</a>
				</li>
			</ul>
		</div>
	...
	<script src="scripts/pages/device/electric_main.js" ></script>
