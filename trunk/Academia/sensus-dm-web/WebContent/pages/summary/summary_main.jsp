...
<sec:authorize access="hasAnyRole('ROLE_EPM_SERVICE_ELECTRIC', 'ROLE_EPM_SERVICE_WATER', 'ROLE_EPM_SERVICE_GAS') and 
	...
	<div id="summary-tabs" class="hide">
		<ul>
			...
			<li id="demandRead">
				<a href="summary/demandRead"><spring:message code="summary.tab.demandRead.title"/></a>
			</li>
			<li id="tamperDetect">
				<a href="summary/tamperDetect"><spring:message code="summary.tab.tamperDetect.title"/></a>
			</li>
			<li id="setupDemandResponse">
				<a href="summary/setupDemandResponse"><spring:message code="summary.tab.getSetDemandResponse.title"/></a>
			</li>
		</ul>
