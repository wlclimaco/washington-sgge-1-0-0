...
<sec:authorize access="hasAnyRole('ROLE_EPM_SERVICE_ELECTRIC', 'ROLE_EPM_SERVICE_WATER', 'ROLE_EPM_SERVICE_GAS') and 
	...
	<div class="summary setup-demand-response-sumary">
		...
		<div class="selected-points selected-point hide">
			...
			<table class="small-table" id="tableSetupDemandResponse">
				<thead>
					<tr>
						...
						<th><spring:message code="smartpointdetail.tabs.about.deviceClass"/></th>
