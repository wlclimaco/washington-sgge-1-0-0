...
public class MlcServerBCFTest extends AbstractTestBaseBusiness
{
	...
	/** The Constant SENSUS_MLC_SMARTPOINTVALIDATOR_MINUTE_REQUIRED. */
	...
	public void testProcessAlarmWarningNotification()
	{
		...
		assertMessages(response, SENSUS_MLC_VALIDATOR_REQUIRED
				, SENSUS_MLC_SMARTPOINTVALIDATOR_LIGHT_RNIID_REQUIRED);
		...
		assertMessages(response, SENSUS_MLC_SMARTPOINTVALIDATOR_VOLTAGE_REQUIRED
				, SENSUS_MLC_SMARTPOINTVALIDATOR_TEMPERATURE_REQUIRED
		...
		assertMessages(response, SENSUS_MLC_SMARTPOINTVALIDATOR_TEMPERATURE_REQUIRED
				, SENSUS_MLC_SMARTPOINTVALIDATOR_LIGHT_STATE_REQUIRED
				, SENSUS_MLC_SMARTPOINTVALIDATOR_LIGHT_TOP_LEVEL_STATE_REQUIRED);
	...
	public void testProcessReadLightStatusNotification()
	{
		...
		assertMessages(response,
				SENSUS_MLC_SMARTPOINTVALIDATOR_SCHEDULE_PROPERTIES_REQUIRED,
				SENSUS_MLC_SMARTPOINTVALIDATOR_PROPERTIES_REQUIRED,
				SENSUS_MLC_SMARTPOINTVALIDATOR_SERIAL_NUMBERS_REQUIRED);
		...
		assertMessages(response, SENSUS_MLC_SMARTPOINTVALIDATOR_LIGHT_STATUS_REQUIRED
				, SENSUS_MLC_SMARTPOINTVALIDATOR_INVALID_HOUR
				, SENSUS_MLC_SMARTPOINTVALIDATOR_INVALID_MINUTE
				, SENSUS_MLC_SMARTPOINTVALIDATOR_HOUR_REQUIRED
				, SENSUS_MLC_SMARTPOINTVALIDATOR_MINUTE_REQUIRED
				, SENSUS_MLC_SMARTPOINTVALIDATOR_VOLTAGE_REQUIRED
				, SENSUS_MLC_SMARTPOINTVALIDATOR_CONSUMPTION_REQUIRED);
		...
		assertEquals(2, response.getMessageInfoList().size());
		assertMessages(response, SENSUS_MLC_SMARTPOINTVALIDATOR_SERIAL_NUMBERS_REQUIRED
				, SENSUS_MLC_SMARTPOINTVALIDATOR_SUNSETOFFSET_REQUIRED);
		...
		response = getMlcServerBCF().processReadLightStatusNotification(request);
		assertEquals(ARBITRARY_MESSAGE_INFO_LIST_SIZE_4, response.getMessageInfoList().size());
		assertMessages(response, SENSUS_MLC_SMARTPOINTVALIDATOR_LOWER_CASE_SERIAL_REQUIRED
		...
		response = getMlcServerBCF().processReadLightStatusNotification(request);
		assertEquals(2, response.getMessageInfoList().size());
		assertMessages(response, SENSUS_MLC_SMARTPOINTVALIDATOR_UPPER_CASE_SERIAL_REQUIRED
				, SENSUS_MLC_SMARTPOINTVALIDATOR_PRODUCT_NUMBER_REQUIRED);
		...
		response = getMlcServerBCF().processReadLightStatusNotification(request);
		assertEquals(1, response.getMessageInfoList().size());
		assertMessages(response, SENSUS_MLC_SMARTPOINTVALIDATOR_PRODUCT_NUMBER_REQUIRED);
	...
	public void testProcessLightStatusNotification()
	{
		...
		assertEquals(2, response.getMessageInfoList().size());
		assertMessages(response, SENSUS_MLC_SMARTPOINTVALIDATOR_INVALID_HOUR
				, SENSUS_MLC_SMARTPOINTVALIDATOR_INVALID_MINUTE);
		...
		assertEquals(1, response.getMessageInfoList().size());
		assertMessages(response, SENSUS_MLC_SMARTPOINTVALIDATOR_INVALID_MINUTE);
	...
	public void testProcessLightBindingNotification()
	{
		...
		assertEquals(2, response.getMessageInfoList().size());
		assertMessages(response, SENSUS_MLC_SMARTPOINTVALIDATOR_PROPERTIES_REQUIRED
				, SENSUS_MLC_SMARTPOINTVALIDATOR_INSTALLATION_INFO_REQUIRED);
