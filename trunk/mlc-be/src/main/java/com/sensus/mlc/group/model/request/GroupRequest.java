package com.sensus.mlc.group.model.request;
...
public class GroupRequest extends LightSelectionRequest
{
	...
	{
		return "GroupRequest [getBottomLeftLat()=" + getBottomLeftLat() + ", getBottomLeftLon()=" + getBottomLeftLon()
				+ ", getTopRightLat()=" + getTopRightLat() + ", getTopRightLon()=" + getTopRightLon()
				+ ", getMaxSmartpointCount()=" + getMaxSmartpointCount() + ", getPercentage()=" + getPercentage()
				+ ", getTagId()=" + getTagId() + ", getGroup()=" + getGroup() + ", getOldName()=" + getOldName()
				+ ", getLightProtected()=" + getLightProtected() + ", getGroupList()=" + getGroupList()
				+ ", getStringGroupIdList()=" + getStringGroupIdList() + "]";
	}
