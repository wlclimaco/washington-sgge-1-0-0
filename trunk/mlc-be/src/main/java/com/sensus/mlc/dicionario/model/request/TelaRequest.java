 ...
 */
public class TelaRequest extends LightSelectionRequest
{
	 ...
	 */
	public TelaRequest(UserContext userContext)
	{
		super(userContext);
	}
	 ...
	 */
	public TelaRequest(UserContext userContext, Tenant tenant)
	{
