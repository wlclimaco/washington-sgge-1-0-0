package com.sensus.mlc.tenant.model;
...
public class Tenant extends com.sensus.common.model.Tenant
{
	...
	/*
	 * (non-Javadoc)
	 * @see com.sensus.common.model.AbstractTenant#toString()
	 */
	@Override
	public String toString()
	{
		return "Tenant [getName()=" + getName() + ", getDescription()=" + getDescription()
				+ ", getRniCode()="
				+ getRniCode() + ", getServerName()=" + getServerName() + ", getGatewayURL()="
				+ getGatewayURL()
				+ ", getLatitude()=" + getLatitude() + ", getLongitude()=" + getLongitude()
				+ ", getMinSmartpointCommTime()=" + getMinSmartpointCommTime() + ", getLightTimeZone()="
				+ getLightTimeZone() + ", getEcoModeDisable()=" + getEcoModeDisable()
				+ ", getBatchProcessTime()="
				+ getBatchProcessTime() + "]";
	}
