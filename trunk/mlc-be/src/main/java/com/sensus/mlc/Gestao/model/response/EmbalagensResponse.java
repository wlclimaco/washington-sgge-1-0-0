...
public class TitularesResponse extends Response
    ...
    private List<Titulares> titularess ;
}
package com.sensus.mlc.wui.Titulares;
import javax.servlet.http.HttpServletRequest;
...
public class TitularesAPIController extends BaseController  
{ 
...
private ITitularesBCF TitularesBCF;

/** The Constant LOG. */
private static final Logger LOG = LoggerFactory.getLogger(LightAPIController.class);

/** The Constant CONTROLLER_EXCEPTION_MSG. */  
public static final String CONTROLLER_EXCEPTION_MSG = "TitularesAPIController";



public ITitularesBCF getTitularesBCF() { 
return TitularesBCF;
}  

public void setTitularesBCF(ITitularesBCF TitularesBCF) {  
this.TitularesBCF = TitularesBCF;
}
...
@RequestMapping(value = MAP_INSERT, method = RequestMethod.POST) 
@ResponseBody   
public Response insert(@RequestBody TitularesRequest TitularesRequest, HttpServletRequest request) 
{ 

TitularesResponse response = new TitularesResponse();
try  
{ 
setUserContext(TitularesRequest, request);

response = getTitularesBCF().insertTitulares(TitularesRequest);
...
@RequestMapping(value = MAP_UPDATE, method = RequestMethod.POST)  
@ResponseBody  
public Response updateTitulares(@RequestBody TitularesRequest TitularesRequest, HttpServletRequest request) 
{ 
...
response = getTitularesBCF().updateTitulares(TitularesRequest);
...
@RequestMapping(value = MAP_DELETE, method = RequestMethod.POST)  
@ResponseBody  
public Response deleteTitulares(@RequestBody TitularesRequest TitularesRequest, HttpServletRequest request) 
{  
...
response = getTitularesBCF().deleteTitulares(TitularesRequest);
...
@RequestMapping(value = MAP_FETCHALL, method = RequestMethod.POST) 
@ResponseBody 
public Response fetch(@RequestBody InquiryTitularesRequest inquiryTitularesRequest, HttpServletRequest request) 
{  

InquiryTitularesResponse response = new InquiryTitularesResponse();
try
{ 
setUserContext(inquiryTitularesRequest, request);

response = getTitularesBCF().fetchAllTitulares(inquiryTitularesRequest);
...
@RequestMapping(value = MAP_FETCH, method = RequestMethod.POST) 
@ResponseBody 
public Response fetch(@RequestBody TitularesRequest TitularesRequest, HttpServletRequest request)   
{ 
...
response = getTitularesBCF().fetchTitularesById(TitularesRequest);
...
public class EmbalagensResponse extends Response
    ...
    private List<Embalagens> embalagenss ;
}
package com.sensus.mlc.wui.Embalagens;
import javax.servlet.http.HttpServletRequest;
...
public class EmbalagensAPIController extends BaseController  
{ 
...
private IEmbalagensBCF EmbalagensBCF;

/** The Constant LOG. */
private static final Logger LOG = LoggerFactory.getLogger(LightAPIController.class);

/** The Constant CONTROLLER_EXCEPTION_MSG. */  
public static final String CONTROLLER_EXCEPTION_MSG = "EmbalagensAPIController";



public IEmbalagensBCF getEmbalagensBCF() { 
return EmbalagensBCF;
}  

public void setEmbalagensBCF(IEmbalagensBCF EmbalagensBCF) {  
this.EmbalagensBCF = EmbalagensBCF;
}
...
@RequestMapping(value = MAP_INSERT, method = RequestMethod.POST) 
@ResponseBody   
public Response insert(@RequestBody EmbalagensRequest EmbalagensRequest, HttpServletRequest request) 
{ 

EmbalagensResponse response = new EmbalagensResponse();
try  
{ 
setUserContext(EmbalagensRequest, request);

response = getEmbalagensBCF().insertEmbalagens(EmbalagensRequest);
...
@RequestMapping(value = MAP_UPDATE, method = RequestMethod.POST)  
@ResponseBody  
public Response updateEmbalagens(@RequestBody EmbalagensRequest EmbalagensRequest, HttpServletRequest request) 
{ 
...
response = getEmbalagensBCF().updateEmbalagens(EmbalagensRequest);
...
@RequestMapping(value = MAP_DELETE, method = RequestMethod.POST)  
@ResponseBody  
public Response deleteEmbalagens(@RequestBody EmbalagensRequest EmbalagensRequest, HttpServletRequest request) 
{  
...
response = getEmbalagensBCF().deleteEmbalagens(EmbalagensRequest);
...
@RequestMapping(value = MAP_FETCHALL, method = RequestMethod.POST) 
@ResponseBody 
public Response fetch(@RequestBody InquiryEmbalagensRequest inquiryEmbalagensRequest, HttpServletRequest request) 
{  

InquiryEmbalagensResponse response = new InquiryEmbalagensResponse();
try
{ 
setUserContext(inquiryEmbalagensRequest, request);

response = getEmbalagensBCF().fetchAllEmbalagens(inquiryEmbalagensRequest);
...
@RequestMapping(value = MAP_FETCH, method = RequestMethod.POST) 
@ResponseBody 
public Response fetch(@RequestBody EmbalagensRequest EmbalagensRequest, HttpServletRequest request)   
{ 
...
response = getEmbalagensBCF().fetchEmbalagensById(EmbalagensRequest);
