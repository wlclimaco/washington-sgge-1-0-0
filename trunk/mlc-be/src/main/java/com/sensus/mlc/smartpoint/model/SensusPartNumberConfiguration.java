...
public class SensusPartNumberConfiguration extends SensusModel implements Serializable,
		Comparator<SensusPartNumberConfiguration>
{
	 ...
	 */
	public SensusPartNumberConfiguration()
	{
	}
	 ...
	 */
	public SensusPartNumberConfiguration(Integer sensusPartNumberConfigurationIdValue, Integer intensityLevelValue,
	 ...
	 * @param percentageValue the percentage value
	 */
	public SensusPartNumberConfiguration(Integer intensityLevelValue, Integer percentageValue)
	{
		setIntensityLevel(intensityLevelValue);
		setPercentage(percentageValue);
	}
	 ...
	 */
	@Override
	public int compare(SensusPartNumberConfiguration o1, SensusPartNumberConfiguration o2)
	{
