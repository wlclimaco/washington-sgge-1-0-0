...
public class GroupRequestValidator implements IValidator
{
	...
	/** The Constant SENSUS_MLC_LIGHT_INTENSITY_REQUIRED. */
	...
	/** The Constant SENSUS_MLC_SMARTPOINTVALIDATOR_PROTECTED_REQUIRED. */
	private static final String SENSUS_MLC_SMARTPOINTVALIDATOR_PROTECTED_REQUIRED =
	...
	public void validate(ValidationContext validationContext)
	{
		...
		switch (action)
		{
			...
			case UPDATE_LIGHT_PROTECTED:
				validateProtected(list, groupRequest);
				return;

			case FETCH_SMARTPOINT_BY_GROUP_TO_MAP:
				validateGroupList(list, groupRequest);
				return;
	...
	{
		ValidationUtil.isNull(percentage, SENSUS_MLC_SMARTPOINTVALIDATOR_INTENSITY_REQUIRED, list);
	}
	 ...
	 * @param groupRequest the group request
	 */
	private void validateProtected(List<MessageInfo> list, GroupRequest groupRequest)
	{
		ValidationUtil.isNull(groupRequest.getLightProtected(),
				SENSUS_MLC_SMARTPOINTVALIDATOR_PROTECTED_REQUIRED, list);
	}
