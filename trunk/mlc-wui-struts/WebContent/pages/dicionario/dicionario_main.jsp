...
<div class="yui-b"><%-- START Tools Bar --%>
	<div class="yui-gc tools"><%-- START Action Container --%>
		...
		<span class='message rounded'><span	id="checked-count" class="checked-count">0</span>&nbsp;<s:text name="smartpoint.table.checkedcount" /></span>
...
<!--                            <ul class="ui-helper-clearfix">
                                <li><button class="ui-state-focus ui-corner-all"><span class="icon-small icn-hand-a"></span></button></li>
                                <li><button class="ui-state-default ui-corner-all"><span class="icon-small icn-poly-a"></span></button></li>
                                <li><button class="ui-state-default ui-corner-all"><span class="icon-small icn-line-a"></span></button></li>
                                <li class="view-port-description">320 of 840 Lights visible on screen. Zoom out to view all.</li>
                            </ul> -->
        </div>
		<div id="map"></div>
	</div>
