        ...
        <fieldset class="two-line">
                <ul>
                   <li class="add-group-control">
                        <label for="controlGroupNameCreate2"><s:text name="action.autogroup.groupName"/> <strong id="auto-no-group-name"></strong></label>
                    </li>
                    <li class="add-group-control">
                        <label for="controlGroupDescription2"><s:text name="action.autonogroup.description"/></label><br/>
