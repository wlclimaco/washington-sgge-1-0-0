...
sensus.pages.process.dialogSettings = {
	...
	abort : {
		...
		buttons : (function() {
			var buttons = {};
			buttons[sensus.locale.get("action.abortprocess.submit")] = function() {
				...
				sensus.util.ajaxaction.sendActionDefault(sensus.locale.get("action.summary.abort.process.success"), sensus.locale.get("action.summary.abort.error"));
				
				sensus.pages.process.processTableCallUpdate();
				
				sensus.pages.process.processId = 0;
			};
			buttons[sensus.locale.get("action.summary.cancel")] = function() {
				$("#action-dialog").dialog('close');
			};
			return buttons;
		})(),
	...
	summaryInclude : {
		 ...
		 * The dialog title.
		 */
		title : sensus.locale.get("action.summary.title"),
