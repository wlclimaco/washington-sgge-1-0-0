...
sensus.util.process = {
	...
	fnFormatDescription : function(iActionId, sStatus, sDescription, iSmartpointId, iPoleId) {
		...
		else if (sDescription.contains($.sc.locale("commons.pages.poleId"))){
	...
	downloadFile : function(fileName, updateCSVDownloaded, id){
		...
		window.location = "export/download?fileName=" + fileName + "&updateCSVDownloaded=" + updateCSVDownloaded + "&id=" + id;
