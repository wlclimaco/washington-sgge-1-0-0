...
<sec:authorize access="hasAnyRole('ROLE_EPM_SERVICE_ELECTRIC', 'ROLE_EPM_SERVICE_WATER', 'ROLE_EPM_SERVICE_GAS') and 
			...
			<div class="yui-b settings-nav-container">
				<ul class="settings-nav">
					<li class="ui-tabs-selected ui-state-active">
						<a class="alist" href="profile"> <spring:message code="profile.page.general"/></a>
					</li>
				</ul>
			</div>
			<div id="yui-main">
				<div class="yui-b settings-content" id="tabs-content">
					<div class="settings-context" >
						...
						<fieldset>
							<legend><spring:message code="profile.page.monitorrequeststatus" /></legend>
							<ul id="prompt-monitor" class="radio-list sui-pad1h">
								<li class="radio">
									<input type="radio" value="1" id="monitor" name="MONITOR_REQUEST" />
									<label>
										<spring:message code="profile.page.alwaysmonitor" /></label>
									</li>

								<li class="radio">
									<input type="radio" value="2" id="dismiss" name="MONITOR_REQUEST" />
										<label>
											<spring:message code="profile.page.alwaysdismiss" />
											<sec:authorize access="!hasAnyRole('ROLE_EPM_CUSTOMER_SUPPORT', 'ROLE_EPM_BILLING_MANAGER')">
												<a class="alist" href="process/history">
								...
								<li class="radio">
									<input type="radio" value="3" id="prompt" name="MONITOR_REQUEST" />
									<label>
										<spring:message code="profile.page.promptme" />
									</label>
								</li>
							</ul>
	...
	<jsp:include page="../../scripts/pages/profile/profile_init.js.jsp" flush="true" />
