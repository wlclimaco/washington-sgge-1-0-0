...
<sec:authorize access="hasAnyRole('ROLE_EPM_SERVICE_ELECTRIC', 'ROLE_EPM_SERVICE_WATER', 'ROLE_EPM_SERVICE_GAS') and 
	...
	<div class="summary demand-read-sumary">
		...
		<div class="selected-points selected-point hide">
			...
			<table class="small-table" id="tableDemandRead">
				<thead>
					<tr>
						...
						<th><spring:message code="commons.pages.readValue"/></th>
						<th><spring:message code="commons.pages.readTime"/></th>
					</tr>
				</thead>
				<tbody>
				</tbody>
