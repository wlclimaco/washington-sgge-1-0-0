...
<sec:authorize access="hasAnyRole('ROLE_EPM_SERVICE_ELECTRIC', 'ROLE_EPM_SERVICE_WATER', 'ROLE_EPM_SERVICE_GAS') and 
	...
	<div>
		<div id="summary-description" class="highlight clear">
			<p>
				<em>
		...
		<div id="detail-header-container" class="ss-widget-table-summary-kpi">
			<table id="informationTable" class="summary-kpi">
				<tbody>
					<tr>
						<td>
							<span class="title"><spring:message code="filter.status.processsuccess.label"/></span>
							<strong class="value"></strong>
							<small class="sub-head"></small>
						</td>
						<td>
							<span class="title"><spring:message code="commons.pages.failed"/></span>
							<strong class="value"></strong>
							<small class="sub-head"></small>
						</td>
