package com.sensus.dm.common.suplemento.bcf.impl;
...
import com.sensus.dm.common.suplemento.bcf.ISuplementoBCF;
...
public class SuplementoBCFImpl implements ISuplementoBCF
{
	...
	public InquirySuplementoResponse fetchAllSuplementos(InquirySuplementoRequest inquirySuplementoRequest)
	{
		...
		try
		{
			...
			context.putObjectToBeValidated(BaseSearch.class.getSimpleName(),
					inquirySuplementoRequest.getDeviceSearch());
	...
	@Override
	public DeviceResponse fetchDevicesBySuplemento(SuplementoRequest suplementoRequest)
	{
