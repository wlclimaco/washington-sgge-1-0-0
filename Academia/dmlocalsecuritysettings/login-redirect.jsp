...
.fancy input[type='text']:hover, .fancy input[type='password']:hover {
...
document.getElementById("current-year").innerHTML = dToday.getFullYear();
	...
	if (msg.indexOf("notenant") != -1){
		...
		elementMsg.innerHTML = "User does not belong to any group.";
	}
	if (msg.indexOf("error") != -1 || msg.indexOf("failed") != -1 || msg.indexOf("Invalid") != -1 || msg.indexOf("User is already logged in on another computer") != -1
	...
	}else if (msg.indexOf("Maximum sessions of 1 for this principal exceeded") != -1) {
	...
	<div class="content">
		<fieldset class="two-line fancy">
			...
			<ul>
				...
				<li class="submit-row">
					<input type="submit" id="jasso_signin" tabindex="3" value="Log in to Device Manager">
				</li>
			</ul>
		</fieldset>
	</div>
...
<div><span class="locality"></span>
<span class="region"></span> <span
	class="postal-code"></span></div>
