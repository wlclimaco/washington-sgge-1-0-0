...
* Generate file csv.
*
* @param inquiryLfserieRequest the inquiry lfserie request
* @return the inquiry lfserie response
*/
public InternalResponse generateFileCSV(InquiryLfserieRequest inquiryLfserieRequest);
...
* @return the lfserie response
*/
public LfserieResponse fetchAllLfserieTypes(Request request);
...
* @return the lfserie response
*/
public LfserieResponse fetchAllLfserieFilial(Request request);
