...
public class Parameter extends SensusModel
{
	...
	/** The property valid value id. */
	private Integer propertyValidValueId;
	...
	/**
	 * Gets the property valid value id.
	 * 
	 * @return the property valid value id
	 */
	public Integer getPropertyValidValueId()
	{
		return this.propertyValidValueId;
	}

	/**
	 * Sets the property valid value id.
	 * 
	 * @param propertyValidValueId the new property valid value id
	 */
	public void setPropertyValidValueId(Integer propertyValidValueId)
	{
		this.propertyValidValueId = propertyValidValueId;
	}
