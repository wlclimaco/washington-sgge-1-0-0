...
/** The LOG. */  
private static transient Log LOG = LogFactory.getLog(EmbalagensBCLImpl.class)
 
/** The Embalagens dac. */ 
private IEmbalagensDAC EmbalagensDAC // injected by Spring through setter 
...
SearchParameter EmbalagensParameter =  
new SearchParameter(PropertyEnum.EMPRESA_ID, String.valueOf(Embalagens.getCodemp()))
EmbalagensRequest.getSearchLight().addSearchParameter(EmbalagensParameter)
InternalResultsResponse<Process> processResponse =   
insertProcess(EmbalagensRequest, LCActionTypeEnum.INSERT_EMPRESA, null)
...
InternalResultsResponse<Embalagens> internalResultsResponse = getEmbalagensDAC().updateEmbalagens(EmbalagensRequest)
...
InternalResultsResponse<Embalagens> tagResponse =  
(InternalResultsResponse<Embalagens>)getEmbalagensDAC().deleteEmbalagens(EmbalagensRequest)
InternalResponse response = new InternalResponse()
...
Embalagens Embalagens = tagResponse.getFirstResult()
EmbalagensRequest.setEmbalagens(Embalagens)
 
SearchParameter tagParameter =  
new SearchParameter(PropertyEnum.EMPRESA_ID, String.valueOf(Embalagens.getCodemp()))
EmbalagensRequest.getSearchLight().addSearchParameter(tagParameter)
 
InternalResultsResponse<Process> processResponse = 
insertProcess(EmbalagensRequest, LCActionTypeEnum.DELETE_TAG, null)
EmbalagensRequest.getSearchLight().getSearchParameters().remove(tagParameter)
...
public void setEmbalagensDAC(IEmbalagensDAC EmbalagensDAC) 
{ 
this.EmbalagensDAC = EmbalagensDAC
}  
...
private InternalResultsResponse<Process> insertProcess(EmbalagensRequest EmbalagensRequest,  
LCActionTypeEnum lcActionType, 
String processDescription)   
{ 
...
* @return the internal results response  
*/         
private InternalResultsResponse<Process> insertProcess(EmbalagensRequest tagRequest, LCActionTypeEnum lcActionType,  
String processDescription, List<Light> deactivatedLights) 
{
Embalagens Embalagens = tagRequest.getEmbalagens()
 
List<LCActionParameter> actionParameters = new ArrayList<LCActionParameter>()
actionParameters.add(new LCActionParameter(PropertyEnum.TAG_ID, String.valueOf(Embalagens.getCodemp())))
actionParameters.add(new LCActionParameter(PropertyEnum.TAG_NAME, Embalagens.getCnpjemp()))
...
process.setIsProcessComplete(true)
process.setIsSubmitted(true)
process.setDescription("insert Embalagens")
process.setRniCorrelationId("")
