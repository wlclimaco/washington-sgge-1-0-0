...
/**
 * Criteria member used for doing a lookup on a payer zipcode in the SendSolv system.
 * <p>
...
public class PayerZipcodeCriteria implements Serializable
{
	private Integer id;
	...
	{
		return "PayerZipcodeCriteria [getId()=" + getId() + ", getCity()="
