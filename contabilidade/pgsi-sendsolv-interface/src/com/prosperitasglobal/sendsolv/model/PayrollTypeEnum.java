 ...
 */
public enum PayrollTypeEnum implements IIntegerEnum, II18nEnum
{
	 ...
	 */
	private PayrollTypeEnum(Integer value, String labelKeyParam)
	{
		code = value;
	 ...
	 */
	public static PayrollTypeEnum enumForValue(Integer value)
	{
		for (PayrollTypeEnum e : values())
		{
	...
	public static String getValidValues()
	{
		...
		for (PayrollTypeEnum i : PayrollTypeEnum.class.getEnumConstants())
		{
