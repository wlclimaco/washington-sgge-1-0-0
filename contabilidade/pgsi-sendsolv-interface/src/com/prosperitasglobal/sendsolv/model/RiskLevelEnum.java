 ...
 */
public enum RiskLevelEnum implements IIntegerEnum, II18nEnum
{
	 ...
	 */
	private RiskLevelEnum(Integer value, String labelKeyParam)
	{
		code = value;
	 ...
	 */
	public static RiskLevelEnum enumForValue(Integer value)
	{
	...
	public static String getValidValues()
	{
		...
		for (RiskLevelEnum i : RiskLevelEnum.class.getEnumConstants())
		{
