...
public final class PGSiDateUtil
{
	...
	/**
	 * This method will subtract the number of day (<code>numberOfDays</code>) from the date passed in and return the
	 * new dates UTC milliseconds. Date passed in is assumed to be UTC time zone.
	 *
	 * @param dateTime The date/time UTC represented in UTC milliseconds to add to.
	 * @param numberOfDays The number of days to subtract from the UTC date passed in.
	 * @return The UTC date/time milliseconds.
	 */
	public static long subtractDays(long dateTime, int numberOfDays)
	{
		return subtractDays(dateTime, UTC_TZ, numberOfDays);
	}

	/**
	 * This method will subtract the number of day (<code>numberOfDays</code>) from the date passed in and return the
	 * new dates UTC milliseconds.
	 *
	 * @param dateTime The date/time UTC represented in UTC milliseconds to add to.
	 * @param timeZone The time zone of the date/time.
	 * @param numberOfDays The number of days to subtract from the UTC date passed in.
	 * @return The UTC date/time milliseconds.
	 */
	public static long subtractDays(long dateTime, String timeZone, int numberOfDays)
	{
		DateTime newDateTime = new DateTime(dateTime, DateTimeZone.forID(timeZone));
		newDateTime = newDateTime.minusDays(numberOfDays);
		return newDateTime.toDate().getTime();
	}
