...
public final class MoneyTransferBAD
{
	...
	// * <p>
	// * The action due date is calculated by adding the {@link Location#getFundsTransferDayLimit()} to the pay date
	// event
	...
	// *
	// * The payroll received date is calculated by adding the {@link Location#getFundsTransferDayLimit()} to the pay
	// date
	// * event date {@link FrequencyBasedEventCalendar#getEventDate()}. The day limit should be stored on the database
	// as
	// * a negative number, representing the days before the pay date.
	// *
	// * @param location The {@link Location} containing the day limit.
	// * @param payDate The {@link FrequencyBasedEventCalendar} containing the pay date.
	// * @return The payroll received date. If the pay date is <code>null</code>, the current date will be returned.
	// Also,
	...
	// *
	// * @param transferSetting The {@link TransferSetting} containing the {@link Account} which will be used to to
	// build
	...
	// */
	// private static MoneyTransferAmount createMoneyTransferAmount(BigDecimal amount, Currency currency, Country
	// country)
	// {
	// MoneyTransferAmount moneyTransferAmount = new MoneyTransferAmount();
	...
	// * @return The money transfer amount.
	// */
	// private static MoneyTransferAmount createOriginAmount(MoneyTransfer moneyTransfer, TransferSetting
	// transferSetting,
	...
	// * <br>
	// * NOTE: If the {@link DailyCurrencyRateDetail} is <code>null</code> and the {@link MoneyTransfer} is for a
	// transfer
