 ...
 */
public class SdnMatchRecipientValidator extends PersonValidator
{
	...
	public void validate(ValidationContext validationContext)
	{
		...
		SdnCheckerRequest<Recipient> request =
				(SdnCheckerRequest<Recipient>)validationContext.getObjectToBeValidated(Recipient.class
						.getSimpleName());
