...
<jsp:include page="../../scripts/pages/banco/banco_main.js.jsp" flush="true" />
<jsp:include page="../../scripts/pages/banco/banco_actions.js.jsp" flush="true" />
<jsp:include page="../../scripts/pages/banco/banco_init.js.jsp" flush="true" />
