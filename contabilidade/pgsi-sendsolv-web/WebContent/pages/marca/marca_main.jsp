										...
										<nav class="navbar navbar-default" role="navigation">
											...
											<div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
												...
												<ul class="nav navbar-nav navbar-right">
													...
													<li class="dropdown">
														<a href="javascript:;" class="navbar1" id="add" class="add">Adicionar marca</a>
													</li>
												</ul>
											</div>
                                ...
                                <div class="row" id="rowTable">
									<div class="panel panel-primary filterable">
										<div class="panel-heading">
										 <h3 class="panel-title">Cadastro marca</h3>
...
<jsp:include page="../../scripts/pages/marca/marca_main.js.jsp" flush="true" />
<jsp:include page="../../scripts/pages/marca/marca_actions.js.jsp" flush="true" />
<jsp:include page="../../scripts/pages/marca/marca_init.js.jsp" flush="true" />
