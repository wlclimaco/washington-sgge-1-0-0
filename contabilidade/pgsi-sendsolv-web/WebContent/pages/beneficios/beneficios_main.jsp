...
<div class="navbar-default sidebar" role="navigation">
	<div class="sidebar-nav navbar-collapse">
		<ul class="nav" id="side-menu">
			...
			<li>
				<a href="#"><i class="fa fa-sitemap fa-fw"></i> Mensal<span class="fa arrow"></span></a>
					<jsp:include page="../filtro/mensal_form.jsp"></jsp:include>
			</li>
			<li>
				<a href="#"><i class="fa fa-files-o fa-fw"></i>Sistema<span class="fa arrow"></span></a>
				<ul class="nav nav-second-level">
					<li>
						<jsp:include page="../filtro/sistema_form.jsp"></jsp:include>
...
<jsp:include page="../../scripts/pages/beneficios/beneficios_main.js.jsp" flush="true" />
<jsp:include page="../../scripts/pages/beneficios/beneficios_actions.js.jsp" flush="true" />
<jsp:include page="../../scripts/pages/beneficios/beneficios_init.js.jsp" flush="true" />
