...
<script type="text/javascript">
	pgsi.pages.estado.dialogSettings = {
			...
			return {
				...
				buttons : (function () {
					...
					oButtons[$.pgsi.locale.get("commons.dialog.insert")] = function () {
						...
						{
							sUrl = "api/estado/insert"
						}
						else
						{
							sUrl = "api/estado/update"
						}
						pgsi.pages.estado.form.ajaxCall(sUrl,sModelAction);
				...
				action : function (actionDialog) {
					...
					actionDialog.load("estado/editView?userId=" + pgsi.settings.userContext.userId+"&locationId=2", function() {
