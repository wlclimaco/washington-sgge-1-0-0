...
<script type="text/javascript">
	pgsi.pages.caixa.dialogSettings = {
			...
			return {
				...
				buttons : (function () {
					...
					oButtons[$.pgsi.locale.get("commons.dialog.insert")] = function () {
						...
						{
							sUrl = "api/caixa/insert"
						}
						else
						{
							sUrl = "api/caixa/update"
						}
						pgsi.pages.caixa.form.ajaxCall(sUrl,sModelAction);
				...
				action : function (actionDialog) {
					...
					actionDialog.load("caixa/editView?userId=" + pgsi.settings.userContext.userId+"&locationId=2", function() {
