...
$(document).ready(function()
{
	...
	var iLocationId = pgsi.util.page.fnCheckXSS($.address.parameter("clienteId")) ? null : $.address.parameter("clienteId");

	//Attach Links to tabs
	$("#infoTab").attr('href', "cliente/view/info?clienteId=" + iLocationId);
	$('#pricingTab').attr('href',"funcionario/?clienteId=" + iLocationId);
