...
<script type="text/javascript">
	pgsi.pages.cliente.dialogSettings = {
			...
			return {
				...
				buttons : (function () {
					...
					oButtons[$.pgsi.locale.get("commons.dialog.insert")] = function () {
						...
						{
							sUrl = "api/cliente/insert"
						}
						else
						{
							sUrl = "api/cliente/update"
						}
						pgsi.pages.cliente.form.ajaxCall(sUrl,sModelAction);
				...
				action : function (actionDialog) {
					...
					actionDialog.load("cliente/editView?userId=" + pgsi.settings.userContext.userId+"&locationId=2", function() {
