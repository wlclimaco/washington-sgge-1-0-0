...
<script type="text/javascript">
	pgsi.pages.funcionario.dialogSettings = {
			...
			return {
				...
				buttons : (function () {
					...
					oButtons[$.pgsi.locale.get("commons.dialog.insert")] = function () {
						...
						{
							sUrl = "api/funcionario/insert"
						}
						else
						{
							sUrl = "api/funcionario/update"
						}
						pgsi.pages.funcionario.form.ajaxCall(sUrl,sModelAction);
				...
				action : function (actionDialog) {
					...
					actionDialog.load("funcionario/editView?userId=" + pgsi.settings.userContext.userId+"&locationId=2", function() {
