...
$(document).ready(function()
{
	...
	pgsi.pages.condpg.locationTable = $('#data_list').dataTable($.pgsi.table.setTable(
	{
		id 			: "#data_list",
		sAjaxSource : "api/pessoa/fetchall/condpg",
		bPreLoad	: true,
		...
		[
		{
			headerData 		: "CNPJ",
			order			: "name",
			mRender         : pgsi.pages.condpg.fnCreateEmpresaNameLink,
			sDefaultContent : "",
			bSortable 		: false,
			sClass          : "name-col"
		},
		{
			...
			mRender 		: pgsi.pages.condpg.fnCreateNomeLink,
			sDefaultContent : "",
			bSortable 		: false
		},
		{
			headerData 		: "Cnae",
			order			: "city_column",
			mRender 		: pgsi.pages.condpg.fnCnae,
			mData	 		: "null",
			sDefaultContent : "",
			bSortable 		: false
		},
		{
			headerData 		: "Email",
			order			: "state_column",
			mRender 		: pgsi.pages.condpg.fnEmail,
			sDefaultContent : "",
			bSortable 		: false
		},
		{
			...
			mRender 		: pgsi.pages.condpg.fnTelefone,
			sDefaultContent : "",
			bSortable 		: false
		},
		{
			...
			mRender 		: pgsi.pages.condpg.fnRegime,
			sDefaultContent : "",
			bSortable 		: false
		},
		{
			headerData 		: "Endereco",
			order			: "phone_column",
			mRender 		: pgsi.pages.condpg.fnEndereco,
			sDefaultContent : "",
			bSortable 		: false
		},
		{
			...
			order			: "phone_column",
			mRender 		: pgsi.pages.condpg.fnDocumento,
			sDefaultContent : "",
			bSortable 		: false
		},
		{
			headerData 		: "Status",
			order			: "phone_column",
			mRender 		: pgsi.pages.condpg.fnStatus,
			sDefaultContent : "",
			bSortable 		: false
		},
		],
