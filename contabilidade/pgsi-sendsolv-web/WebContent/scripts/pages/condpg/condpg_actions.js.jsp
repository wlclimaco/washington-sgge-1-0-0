...
<script type="text/javascript">
	pgsi.pages.condpg.dialogSettings = {
			...
			return {
				...
				buttons : (function () {
					...
					oButtons[$.pgsi.locale.get("commons.dialog.insert")] = function () {
						...
						{
							sUrl = "api/condpg/insert"
						}
						else
						{
							sUrl = "api/condpg/update"
						}
						pgsi.pages.condpg.form.ajaxCall(sUrl,sModelAction);
				...
				action : function (actionDialog) {
					...
					actionDialog.load("condpg/editView?userId=" + pgsi.settings.userContext.userId+"&locationId=2", function() {
