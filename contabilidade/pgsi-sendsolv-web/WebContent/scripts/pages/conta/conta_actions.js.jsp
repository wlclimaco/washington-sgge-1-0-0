...
<script type="text/javascript">
	pgsi.pages.conta.dialogSettings = {
			...
			return {
				...
				buttons : (function () {
					...
					oButtons[$.pgsi.locale.get("commons.dialog.insert")] = function () {
						...
						{
							sUrl = "api/conta/insert"
						}
						else
						{
							sUrl = "api/conta/update"
						}
						pgsi.pages.conta.form.ajaxCall(sUrl,sModelAction);
				...
				action : function (actionDialog) {
					...
					actionDialog.load("conta/editView?userId=" + pgsi.settings.userContext.userId+"&locationId=2", function() {
