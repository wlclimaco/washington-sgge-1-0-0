...
<script type="text/javascript">
	pgsi.pages.agencia.dialogSettings = {
			...
			return {
				...
				buttons : (function () {
					...
					oButtons[$.pgsi.locale.get("commons.dialog.insert")] = function () {
						...
						{
							sUrl = "api/agencia/insert"
						}
						else
						{
							sUrl = "api/agencia/update"
						}
						pgsi.pages.agencia.form.ajaxCall(sUrl,sModelAction);
				...
				action : function (actionDialog) {
					...
					actionDialog.load("agencia/editView?userId=" + pgsi.settings.userContext.userId+"&locationId=2", function() {
