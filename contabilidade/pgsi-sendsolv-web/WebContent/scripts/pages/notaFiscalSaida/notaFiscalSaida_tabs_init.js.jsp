...
$(document).ready(function()
{
	...
	var iFornecedorId = pgsi.util.page.fnCheckXSS($.address.parameter("notaFiscalSaidaId")) ? null : $.address.parameter("notaFiscalSaidaId");

	//Attach Links to tabs
	$("#infoTab").attr('href', "notaFiscalSaida/view/info?notaFiscalSaidaId=" + iFornecedorId);
	$('#pricingTab').attr('href',"notaFiscalSaida/?notaFiscalSaidaId=" + iFornecedorId);
