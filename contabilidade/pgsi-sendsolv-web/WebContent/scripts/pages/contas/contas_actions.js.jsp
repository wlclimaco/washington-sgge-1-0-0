...
<script type="text/javascript">
	pgsi.pages.contas.dialogSettings = {
			...
			return {
				...
				buttons : (function () {
					...
					oButtons[$.pgsi.locale.get("commons.dialog.insert")] = function () {
						...
						{
							sUrl = "api/contas/insert"
						}
						else
						{
							sUrl = "api/contas/update"
						}
						pgsi.pages.contas.form.ajaxCall(sUrl,sModelAction);
				...
				action : function (actionDialog) {
					...
					actionDialog.load("contas/editView?userId=" + pgsi.settings.userContext.userId+"&locationId=2", function() {
