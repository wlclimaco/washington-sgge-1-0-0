...
$(document).ready(function()
{
	...
	pgsi.pages.contas.locationTable = $('#data_list').dataTable($.pgsi.table.setTable(
	{
		id 			: "#data_list",
		sAjaxSource : "api/pessoa/fetchall/contas",
		bPreLoad	: true,
		...
		[
		{
			headerData 		: "CNPJ",
			order			: "name",
			mRender         : pgsi.pages.contas.fnCreateEmpresaNameLink,
			sDefaultContent : "",
			bSortable 		: false,
			sClass          : "name-col"
		},
		{
			...
			mRender 		: pgsi.pages.contas.fnCreateNomeLink,
			sDefaultContent : "",
			bSortable 		: false
		},
		{
			headerData 		: "Cnae",
			order			: "city_column",
			mRender 		: pgsi.pages.contas.fnCnae,
			mData	 		: "null",
			sDefaultContent : "",
			bSortable 		: false
		},
		{
			headerData 		: "Email",
			order			: "state_column",
			mRender 		: pgsi.pages.contas.fnEmail,
			sDefaultContent : "",
			bSortable 		: false
		},
		{
			...
			mRender 		: pgsi.pages.contas.fnTelefone,
			sDefaultContent : "",
			bSortable 		: false
		},
		{
			...
			mRender 		: pgsi.pages.contas.fnRegime,
			sDefaultContent : "",
			bSortable 		: false
		},
		{
			headerData 		: "Endereco",
			order			: "phone_column",
			mRender 		: pgsi.pages.contas.fnEndereco,
			sDefaultContent : "",
			bSortable 		: false
		},
		{
			...
			order			: "phone_column",
			mRender 		: pgsi.pages.contas.fnDocumento,
			sDefaultContent : "",
			bSortable 		: false
		},
		{
			headerData 		: "Status",
			order			: "phone_column",
			mRender 		: pgsi.pages.contas.fnStatus,
			sDefaultContent : "",
			bSortable 		: false
		},
		],
