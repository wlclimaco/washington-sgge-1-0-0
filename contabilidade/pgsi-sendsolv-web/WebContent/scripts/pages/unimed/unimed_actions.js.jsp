...
<script type="text/javascript">
	pgsi.pages.unimed.dialogSettings = {
			...
			return {
				...
				buttons : (function () {
					...
					oButtons[$.pgsi.locale.get("commons.dialog.insert")] = function () {
						...
						{
							sUrl = "api/unimed/insert"
						}
						else
						{
							sUrl = "api/unimed/update"
						}
						pgsi.pages.unimed.form.ajaxCall(sUrl,sModelAction);
				...
				action : function (actionDialog) {
					...
					actionDialog.load("unimed/editView?userId=" + pgsi.settings.userContext.userId+"&locationId=2", function() {
