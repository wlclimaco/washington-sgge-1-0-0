...
$(document).ready(function()
{
	...
	var iFornecedorId = pgsi.util.page.fnCheckXSS($.address.parameter("orcamentoId")) ? null : $.address.parameter("orcamentoId");

	//Attach Links to tabs
	$("#infoTab").attr('href', "orcamento/view/info?orcamentoId=" + iFornecedorId);
	$('#pricingTab').attr('href',"orcamento/?orcamentoId=" + iFornecedorId);
