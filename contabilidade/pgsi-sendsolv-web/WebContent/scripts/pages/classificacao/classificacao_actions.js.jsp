...
<script type="text/javascript">
	pgsi.pages.classificacao.dialogSettings = {
			...
			return {
				...
				buttons : (function () {
					...
					oButtons[$.pgsi.locale.get("commons.dialog.insert")] = function () {
						...
						{
							sUrl = "api/classificacao/insert"
						}
						else
						{
							sUrl = "api/classificacao/update"
						}
						pgsi.pages.classificacao.form.ajaxCall(sUrl,sModelAction);
				...
				action : function (actionDialog) {
					...
					actionDialog.load("classificacao/editView?userId=" + pgsi.settings.userContext.userId+"&locationId=2", function() {
