...
<script type="text/javascript">
	pgsi.pages.beneficios.dialogSettings = {
			...
			return {
				...
				buttons : (function () {
					...
					oButtons[$.pgsi.locale.get("commons.dialog.insert")] = function () {
						...
						{
							sUrl = "api/beneficios/insert"
						}
						else
						{
							sUrl = "api/beneficios/update"
						}
						pgsi.pages.beneficios.form.ajaxCall(sUrl,sModelAction);
				...
				action : function (actionDialog) {
					...
					actionDialog.load("beneficios/editView?userId=" + pgsi.settings.userContext.userId+"&locationId=2", function() {
