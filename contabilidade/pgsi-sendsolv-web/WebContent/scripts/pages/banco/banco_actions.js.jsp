...
<script type="text/javascript">
	pgsi.pages.banco.dialogSettings = {
			...
			return {
				...
				buttons : (function () {
					...
					oButtons[$.pgsi.locale.get("commons.dialog.insert")] = function () {
						...
						{
							sUrl = "api/banco/insert"
						}
						else
						{
							sUrl = "api/banco/update"
						}
						pgsi.pages.banco.form.ajaxCall(sUrl,sModelAction);
				...
				action : function (actionDialog) {
					...
					actionDialog.load("banco/editView?userId=" + pgsi.settings.userContext.userId+"&locationId=2", function() {
