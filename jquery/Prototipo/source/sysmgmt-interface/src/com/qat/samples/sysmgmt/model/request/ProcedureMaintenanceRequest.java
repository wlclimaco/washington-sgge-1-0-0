 ...
 */
public class ProcedureMaintenanceRequest extends MaintenanceRequest
{
	...
	{
		return "ProcedureMaintenanceRequest [getProcedure()=" + getProcedure() + ", getReturnList()=" + getReturnList() + ", getReturnListPaged()=" + getReturnListPaged()
