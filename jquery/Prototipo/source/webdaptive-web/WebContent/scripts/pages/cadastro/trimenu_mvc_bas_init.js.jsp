...
var ploaderTri = new Slick.Data.RemoteModel();
$(document).ready(function ()
{
	...
	pgrid = new Slick.Grid($("#trimenuGrid"), ploaderTri.data, columns, options);
	...
	gridPager = new Slick.Controls.Pager(ploaderTri, $("#pager"));
	gridPager.init();
	setTimeout('pgrid.init()', 250);

	//this events fires to blockui while the data is retrieved
	ploaderTri.onProcDataLoading.subscribe(function()
	{
	...
	ploaderTri.onProcDataLoaded.subscribe(function()
	{
		aRowChg.length=0;
