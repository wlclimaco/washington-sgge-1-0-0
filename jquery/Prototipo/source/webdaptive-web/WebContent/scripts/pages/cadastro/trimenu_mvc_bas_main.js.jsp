...
columns[3] = {id:"nome", name:submenu.grid.psubmenu.title, field:"nome",  width:135, editable:true, cssClass:"pad-4-left", sortable:true, editor:AutoCompleteEditor},
...
(function($)
{
	function RemoteModel()
	{
		...
		{
			onProcDataLoading.notify({});
			rest_post_call('qat-sysmgmt-sample/services/rest/ProdutoService/fetchAllCadastros',{cadastro:{type:5,userId:'rod'}}, fill_data, process_error,true);
		}
		</sec:authorize>
