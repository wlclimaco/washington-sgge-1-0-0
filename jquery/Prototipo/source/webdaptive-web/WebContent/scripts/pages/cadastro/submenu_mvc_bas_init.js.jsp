...
$(document).ready(function ()
{
	...
	pgrid = new Slick.Grid($("#submenuGrid"), ploaderSub.data, columns, options);
	...
	gridPager = new Slick.Controls.Pager(ploaderSub, $("#pager"));
	gridPager.init();
	setTimeout('pgrid.init()', 250);

	//this events fires to blockui while the data is retrieved
	ploaderSub.onProcDataLoading.subscribe(function()
	{
	...
	ploaderSub.onProcDataLoaded.subscribe(function()
	{
		aRowChg.length=0;
