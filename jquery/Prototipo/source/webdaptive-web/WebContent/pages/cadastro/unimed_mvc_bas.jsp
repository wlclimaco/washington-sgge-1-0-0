...
<body>
	<div style="width:100%;height:100%;float:left;">
		<div class="grid-header" style="width:100%">
		    <span id="listunimed" style="float:left; width: 16px; height: 16px; background-image:url('../images/text_list.png')" title="List Procedures"></span>
			<sec:authorize access="hasAnyRole('ROLE_DOMAIN USERS', 'ROLE_DOMAIN ADMINS')">
		    <span id="refreshunimed" style="float:right" class="ui-icon ui-icon-refresh" title="Rebuild Procedures"></span>
			</sec:authorize>
		</div>
		<div id="unimedGrid" style="width:100%; height:95%;" class="wdgrid" ></div>
...
<jsp:include page="../../scripts/pages/cadastro/unimed_mvc_bas_main.js.jsp" flush="true"/>
<jsp:include page="../../scripts/pages/cadastreo/unimed_mvc_bas_init.js.jsp" flush="true"/>
</body>
</html>