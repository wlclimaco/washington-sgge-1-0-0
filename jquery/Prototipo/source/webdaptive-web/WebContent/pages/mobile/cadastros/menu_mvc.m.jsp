...
<body>
<div data-role="page" id="menu_mvc.m">
  <div data-theme="b" data-role="header">
    <h1>Menu</h1>
    <a href="../pages/mobile/wd_main.m.jsp#menu" rel="external" data-icon="back" data-iconpos="left" data-direction="reverse" class="ui-btn-right">Voltar</a></div>
