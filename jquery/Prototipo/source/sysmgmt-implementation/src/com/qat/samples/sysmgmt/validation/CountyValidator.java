 ...
 */
public class CountyValidator implements IValidator
{
	...
	{
		County county = (County)validationContext.getObjectToBeValidated(County.class.getSimpleName());
	...
	{
		ValidationUtil.isNullOrEmpty(county.getDescription(), SYSMGMT_BASE_COUNTYVALIDATOR_DESC_REQUIRED, list);
