package com.qat.samples.sysmgmt.cidade.bai.impl;
 ...
 */
public class CidadeBAIImpl implements ICidadeBAI
{
	...
	private static final String CLASS_NAME = CidadeBAIImpl.class.getName();

	/** The Constant LOG. */
	private static final Logger LOG = LoggerFactory.getLogger(CidadeBAIImpl.class);
