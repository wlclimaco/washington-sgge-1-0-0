...
public class DrugValidator implements IValidator
{
	...
	{
		Drug drug = (Drug)validationContext.getObjectToBeValidated(Drug.class.getSimpleName());
	...
	{
		ValidationUtil.isNullOrEmpty(drug.getDrugPrices(), SYSMGMT_BASE_DRUGVALIDATOR_DRUGPRICES_REQUIRED, list);
	}
	...
	{
		ValidationUtil.isNullOrEmpty(drug.getDescription(), SYSMGMT_BASE_DRUGVALIDATOR_NDCDESC_REQUIRED, list);
	}
}
