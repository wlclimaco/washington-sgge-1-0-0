package com.sensus.mlc.wui.nfe;
...
public class NfeAPIController extends BaseController
{
	...
	/** The Constant LOG. */
	private static final Logger LOG = LoggerFactory.getLogger(NfeAPIController.class);
