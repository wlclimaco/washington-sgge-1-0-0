				...
				<!-- START : summary data -->
					<thead>
						<tr>
							...
							<th><span id="consumption_ecomode"><s:message code="smartpoint.detail.ecoMode.EcoMode" /></span></th>
						</tr>
					</thead>
					<!-- END : summary data -->
					   <tbody>
...
<%@ include file="../../scripts/pages/light_detail_eco_mode_main.js.jsp" %>
<%@ include file="../../scripts/pages/light_detail_actions.js.jsp" %>
<%@ include file="../../scripts/pages/light_detail_eco_mode_init.js.jsp" %>
