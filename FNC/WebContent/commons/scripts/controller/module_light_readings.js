sensus.commons.modules.content.lightReadings = {
	...
	loadReadings : function(aData) {
		...
		var sMaskToFormat = sensus.settings.dateFormatMask + " " + $.sc.locale("smartpointdetail.page.at") + " h:i:s.fff A";
		...
		var fnDateFormat = function(sDateVal) {
			return sDateVal == '--' ? "" : "<span class='right time-stamp'>" + $.sc.dateFormat( sDateVal, sMaskToFormat) + "</span>";
		};
