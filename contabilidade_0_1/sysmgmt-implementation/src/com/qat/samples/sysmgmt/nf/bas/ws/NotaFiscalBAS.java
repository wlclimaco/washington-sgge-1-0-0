package com.qat.samples.sysmgmt.nf.bas.ws;
...
import com.qat.samples.sysmgmt.nf.bas.INotaFiscalBAS;
...
public class NotaFiscalBAS implements INotaFiscalBAS
{

	/** The bundle bai. */
	private INotaFiscalBAI pessoaBAI;
