...
function Menu(caller, options) {
	...
	var options = jQuery.extend( {
		content : null,
		width : 210, // width of menu container, must be set or passed in to
		// calculate widths of child menus
		maxHeight : 210, // max height of menu (if a drilldown: height does
		...
		crumbDefaultText : sensus.locale.get("components.ui.action"),
...
Number.prototype.pxToEm = String.prototype.pxToEm = function(settings) {
	...
	if (settings.scope == 'body' && head.browser.ie && (parseFloat($('body').css('font-size')) / getWindowWidth()).toFixed(1) > 0.0) {
