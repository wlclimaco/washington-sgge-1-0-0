...
<div class="navbar-default sidebar" role="navigation">
	<div class="sidebar-nav navbar-collapse">
		<ul class="nav" id="side-menu">
			...
			<li>
				<a href="#"><i class="fa fa-sitemap fa-fw"></i> Profissao<span class="fa arrow"></span></a>
					<jsp:include page="../filtro/profissao_form.jsp"></jsp:include>
			</li>
			<li>
			...
			<li>
				<a href="#"><i class="fa fa-files-o fa-fw"></i>Eventos<span class="fa arrow"></span></a>
				<ul class="nav nav-second-level">
					<li>
						<jsp:include page="../filtro/evento_form.jsp"></jsp:include>
			...
			<li>
				<a href="#"><i class="fa fa-files-o fa-fw"></i>Beneficios<span class="fa arrow"></span></a>
				<ul class="nav nav-second-level">
					<li>
						<jsp:include page="../filtro/beneficio_form.jsp"></jsp:include>
