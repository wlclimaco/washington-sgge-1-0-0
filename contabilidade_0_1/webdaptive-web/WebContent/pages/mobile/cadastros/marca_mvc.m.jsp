...
<body>
<div data-role="page" id="marca_mvc.m">
  <div data-theme="b" data-role="header">
    <h1>Marca</h1>
    <a href="../pages/mobile/wd_main.m.jsp#marca" rel="external" data-icon="back" data-iconpos="left" data-direction="reverse" class="ui-btn-right">Voltar</a></div>
    <div data-role="content">
        <div class="ui-grid-a">
            <div class="ui-block-a ui-bar-b">Id</div>
            <div class="ui-block-b ui-bar-b">Marca</div>
            <div class="ui-block-b ui-bar-b">Descrição</div>
