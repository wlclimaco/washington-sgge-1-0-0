...
<div id="wdcontent" class="wdcontent">
	...
	<div class="ui-layout-west">
                ...
                <div class="sidebar-nav navbar-collapse">
                    <ul class="nav" id="side-menu">
                        ...
                        <li>
                            <a href="index.html"><i class="fa fa-dashboard fa-fw"></i> Pagina Principal</a>
                        </li>
                        <li>
                            ...
                            <ul class="nav nav-second-level">
                                ...
                                <li>
                                    <a href="morris.html">Fornecedores</a>
                                </li>
								<li>
                                    <a href="morris.html">Funcionarios<span class="fa arrow"></span></a>
                        ...
                        <li>
                            <a href="qat_marc_tabs.jsp"><i class="fa fa-table fa-fw"></i> Financeiro</a>
							<ul class="nav nav-second-level">
                                <li>
                                    <a href="flot.html">Contas Pagar</a>
                                </li>
                                <li>
                                    <a href="morris.html">Contas Receber</a>
                                </li>
                            </ul>
                        </li>
                        <li>
						...
						<li>
                            <a href="qat_marc_tabs.jsp"><i class="fa fa-table fa-fw"></i> Nota Fiscal</a>
							<ul class="nav nav-second-level">
                                <li>
                                    <a href="flot.html">Entrada</a>
                                </li>
                                <li>
                                    <a href="morris.html">Saida</a>
                                </li>
                            </ul>
                        </li>
						<li>
                            <a href="forms.html"><i class="fa fa-edit fa-fw"></i> Guias a Pagar</a>
                        </li>
                        <li>
                            <a href="#"><i class="fa fa-wrench fa-fw"></i> Sistema<span class="fa arrow"></span></a>
                            <ul class="nav nav-second-level">
                                <li>
                                    <a href="panels-wells.html">Serviços</a>
                                </li>
                                <li>
                                    <a href="buttons.html">Historico</a>
                                </li>
                                <li>
                                    <a href="notifications.html">Ordem de Serviço</a>
                                </li>
                                <li>
                                    <a href="typography.html">Exportar</a>
                                </li>
                                <li>
                                    <a href="icons.html"> Importar</a>
                                </li>
                                <li>
                                    <a href="grid.html">Imagens</a>
                                </li>
                            </ul>
                            <!-- /.nav-second-level -->
                        </li>
	...
	<div class="ui-layout-center style={visibility:'hidden!important'}">
