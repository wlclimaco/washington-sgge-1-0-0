...
var ploaderUni = new Slick.Data.RemoteModel();
$(document).ready(function ()
{
	...
	pgrid = new Slick.Grid($("#unimedGrid"), ploaderUni.data, columns, options);
	...
	gridPager = new Slick.Controls.Pager(ploaderUni, $("#pager"));
	gridPager.init();
	setTimeout('pgrid.init()', 250);

	//this events fires to blockui while the data is retrieved
	ploaderUni.onProcDataLoading.subscribe(function()
	{
	...
	ploaderUni.onProcDataLoaded.subscribe(function()
	{
		aRowChg.length=0;
