package com.qat.webdaptive.controller.tabela;
...
public class TabelaViewController extends TabelaBaseController
{
	...
	private static final String VIEW_EMPRESA_MAIN = "/tabela/tabela_main";

	/** The Constant VIEW_EMPRESA_ADD. */
	private static final String VIEW_EMPRESA_ADD = "/tabela/tabela_create";

	/** The Constant VIEW_EMPRESA_VIEW. */
	private static final String VIEW_EMPRESA_VIEW = "/tabela/tabela_view";

	private static final String VIEW_EMPRESA_TABS = "/tabela/tabela_tabs";

	/** The Constant VIEW_EMPRESA_DIALOG_ADD. */
	private static final String VIEW_EMPRESA_DIALOG_ADD = "/tabela/tabela_dialog_create";
	...
	public ModelAndView loadUpdate(@RequestParam(value = TABELA_ID, required = false) Integer locationId,
	...
	public ModelAndView loadTabs(@RequestParam(value = TABELA_ID, required = true) Integer locationId,
			HttpServletRequest request)
	{
	...
	public ModelAndView loadView(@RequestParam(value = TABELA_ID, required = true) Integer locationId,
			HttpServletRequest request)
	{
	...
	public ModelAndView loadViewUpdate(@RequestParam(value = TABELA_ID, required = false) Integer locationId,
			HttpServletRequest request)
	{
