...
import com.qat.samples.sysmgmt.util.Exame;
import com.qat.samples.sysmgmt.util.ExameTypeEnum;
...
public class ExameDACTest extends AbstractTransactionalJUnit4SpringContextTests
{
	...
	public void testupdateExame() throws Exception
	{
		...
		InternalResultsResponse<Exame> funcionarioResponse = getExameDAC().updateExame(funcionario);
	...
	public void testinsertExame() throws Exception
	{
		...
		InternalResultsResponse<Exame> funcionarioResponse = getExameDAC().insertExame(funcionario);
		assertEquals(funcionarioResponse.getStatus(), Status.OperationSuccess);
	...
	public void testdeleteExame() throws Exception
	{
		...
		InternalResponse funcionarioResponse = getExameDAC().deleteExame(funcionario);
		assertEquals(funcionarioResponse.getStatus(), Status.OperationSuccess);
	}
