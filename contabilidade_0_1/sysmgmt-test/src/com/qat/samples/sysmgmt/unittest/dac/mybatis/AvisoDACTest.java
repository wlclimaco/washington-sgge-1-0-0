...
import com.qat.samples.sysmgmt.util.dac.IAvisosDAC;
...
public class AvisoDACTest extends AbstractTransactionalJUnit4SpringContextTests
{
	...
	public IAvisosDAC getAvisoDAC()
	{
		return avisosDAC;
	}

	@Resource
	public void setAvisoDAC(IAvisosDAC avisosDAC)
	{
	...
	public void testupdateAviso() throws Exception
	{
		...
		Integer a = getAvisoDAC().updateAvisos(funcionario, response);
	...
	public void testinsertAviso() throws Exception
	{
		...
		InternalResultsResponse<Avisos> response = new InternalResultsResponse<Avisos>();
		Integer a = getAvisoDAC().insertAvisos(funcionario, "insert", response);
	...
	public void testdeleteAviso() throws Exception
	{
		...
		InternalResultsResponse<Avisos> response = new InternalResultsResponse<Avisos>();
		Integer a = getAvisoDAC().deleteAvisos(funcionario, response);
	...
	public void testfetchAvisoById() throws Exception
	{
		...
		InternalResultsResponse<Avisos> response = getAvisoDAC().fetchAvisosById(request);
	...
	public void testfetchAvisoByRequest() throws Exception
	{
		...
		InternalResultsResponse<Avisos> response = getAvisoDAC().fetchAvisoByRequest(request);
