	...
	<div class="yui-u first">
	   <ul class="tabs tab-saved hide" id="tabs-list">
		   ...
		   <%-- <li><a id="ajax-button" href="search/ajax.advanced.action" class="gradient-vert alist"><s:message code="search.tabs.advanced" /></a></li> --%>
	        <li><a id="ajax-button" href="search/ajax.list.action" class="gradient-vert alist"><s:message code="search.tabs.saved" /></a></li>
	    </ul>
	</div>
</div>
<!-- Messaging -->
		...
		<span class='message rounded'><span	id="checked-count" class="checked-count">0</span>&nbsp; <s:message code="table.filter.of" /> <span id="general-total">0</span> <s:message code="smartpoint.table.checkedcount" /></span>
			...
			<div class="result-count">
				<p class="info rounded">
					...
					<a id="lights-select-all" class="select-all" href="#"><s:message code="table.filter.all"/></a>,
			...
			<div class="icon-container">
				...
				<span id="toolbar"
					...
					value="list" /><label for="list_toggle"><s:message code="smartpoint.filter.list" /></label> <input type="radio" id="map_toggle"
					name="view_toggle" class="map" value="map" /><label for="map_toggle"
					class="map"><s:message code="smartpoint.filter.map" /></label> </span> </span>
			</div>
		</div>
	</div>
...
<%@ include file="../../scripts/pages/light_main.js.jsp" %>
<%@ include file="../../scripts/pages/light_actions.js.jsp" %>
<%@ include file="../../scripts/pages/light_init.js.jsp" %>