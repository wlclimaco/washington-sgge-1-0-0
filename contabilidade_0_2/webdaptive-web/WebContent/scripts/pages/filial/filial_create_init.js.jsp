...
$(document).ready(function()
{
	...
	$("#Button1").on("click", function() {
		...
		s = '<div class="test" style="position:absolute;left:30px;top:'+sTop+'px;width:55px;height:16px;z-index:3;text-align:left;">'
			...
			+'</div>'
			+'<input type="text" id="Editbox1" style="position:absolute;left:99px;top:'+sTop+'px;width:94px;height:19px;line-height:19px;z-index:4;" name="cnae" value="">'
			+'<input type="text" id="Editbox2" style="position:absolute;left:334px;top:'+sTop+'px;width:381px;height:19px;line-height:19px;z-index:5;" name="descricao" value="">'
			...
			+'</div>'
			+'<input type="button" id="Button1" name="" value="+" style="position:absolute;left:729px;top:'+sTop+'px;width:34px;height:25px;z-index:50;">'
			+'<input type="button" id="Button7" name="" value="..." style="position:absolute;left:195px;top:'+sTop+'px;width:29px;height:23px;z-index:40;">'
		$('#emails').append(s);
	...
	$("#Button3").on("click", function() {
		...
		s = '<div id="wb_Text12" class="test001" style="position:absolute;left:45px;top:'+sTop+'px;width:40px;height:16px;z-index:23;text-align:left;">'
			...
			+'</div>'
			+'<input type="text" id="Editbox9" style="position:absolute;left:99px;top:'+sTop+'px;width:74px;height:19px;line-height:19px;z-index:24;" name="nome" value="">'
			+'<div id="wb_Text12" style="position:absolute;left:259px;top:'+sTop+'px;width:40px;height:16px;z-index:23;text-align:left;">'
			+'<span style="color:#000000;font-family:Arial;font-size:13px;">DDD :</span>'
			+'</div>'
			+'<input type="text" id="Editboxd9" style="position:absolute;left:299px;top:'+sTop+'px;width:74px;height:19px;line-height:19px;z-index:24;" name="nome" value="">'
			+'<input type="button" id="Button3" name="" value="+" style="position:absolute;left:702px;top:'+sTop+'px;width:34px;height:23px;z-index:25;">'
			...
			+'</div>'
			+'<input type="text" id="Editbox10" style="position:absolute;left:523px;top:'+sTop+'px;width:157px;height:19px;line-height:19px;z-index:27;" name="nome" value="">'
		$('#telefones').append(s);
	...
	$("#Button4").on("click", function() {
		...
		s = '<div id="wb_Text14" class="test002" style="position:absolute;left:30px;top:'+sTop+'px;width:55px;height:16px;z-index:29;text-align:left;">'
			...
			+'</div>'
			+'<input type="text" id="Editbox11" style="position:absolute;left:99px;top:'+sTop+'px;width:291px;height:19px;line-height:19px;z-index:30;" name="nome" value="">'
			...
			+'</div>'
			+'<input type="text" id="Editbox12" style="position:absolute;left:453px;top:'+sTop+'px;width:57px;height:19px;line-height:19px;z-index:32;" name="nome" value="">'
			...
			+'</div>'
			+'<input type="text" id="Editbox13" style="position:absolute;left:619px;top:'+sTop+'px;width:57px;height:19px;line-height:19px;z-index:35;" name="nome" value="">'
