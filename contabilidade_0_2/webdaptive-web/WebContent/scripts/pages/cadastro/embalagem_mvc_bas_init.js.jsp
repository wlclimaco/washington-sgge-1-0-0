...
var ploaderEmb = new Slick.Data.RemoteModel();
$(document).ready(function ()
{
	...
	pgrid = new Slick.Grid($("#marcaGrid"), ploaderEmb.data, columns, options);
	...
	gridPager = new Slick.Controls.Pager(ploaderEmb, $("#pager"));
	gridPager.init();
	setTimeout('pgrid.init()', 250);

	//this events fires to blockui while the data is retrieved
	ploaderEmb.onMarcaDataLoading.subscribe(function()
	{
	...
	ploaderEmb.onMarcaDataLoaded.subscribe(function()
	{
		aRowChg.length=0;
