...
<jsp:include page="../../scripts/pages/classificacao/classificacao_mvc_bas_main.js.jsp" flush="true"/>
<jsp:include page="../../scripts/pages/classificacao/classificacao_mvc_bas_init.js.jsp" flush="true"/>
</body>
</html>