...
<jsp:include page="../../scripts/pages/notaFiscalSaida/notaFiscalSaida_main.js.jsp" flush="true" />
<jsp:include page="../../scripts/pages/notaFiscalSaida/notaFiscalSaida_init.js.jsp" flush="true" />
