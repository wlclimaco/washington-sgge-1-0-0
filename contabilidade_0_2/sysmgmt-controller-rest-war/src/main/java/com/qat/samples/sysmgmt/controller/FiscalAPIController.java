...
public class FiscalAPIController extends BaseController {
	...
	// "sysmgmt.base.fiscalcontrollerrest.defaultexception";
	//
	// /** The Constant LOG. */
	// private static final Logger LOG =
	// LoggerFactory.getLogger(FiscalAPIController.class);
	//
	// /** The fiscal bac. */
	...
	// @ResponseBody
	// public RegimeResponse refreshRegimes(@RequestParam("refreshInt") Integer
	// refreshInt,
	...
	// retPaged);
	// InternalResultsResponse<Regime> internalResponse =
	// getFiscalBAC().refreshRegimes(request);
	// ResponseHandler.handleOperationStatusAndMessages(regimeResponse,
	// internalResponse, true);
	// } catch (Exception ex) {
	// ResponseHandler.handleException(LOG, regimeResponse, ex,
	...
	// @ResponseBody
	// public RegimeResponse fetchRegimePaged(@RequestBody RegimeInquiryRequest
	// request) {
	// RegimeResponse regimeResponse = new RegimeResponse();
	// try {
	// InternalResultsResponse<Regime> internalResponse =
	// getFiscalBAC().fetchRegimesByRequest(request);
	// ResponseHandler.handleOperationStatusAndMessages(regimeResponse,
	// internalResponse, true);
	// } catch (Exception ex) {
	// ResponseHandler.handleException(LOG, regimeResponse, ex,
	...
	// @ResponseBody
	// public RegimeResponse insertRegime(@RequestBody RegimeMaintenanceRequest
	// request) {
	// RegimeResponse regimeResponse = new RegimeResponse();
	// try {
	// InternalResultsResponse<Regime> internalResponse =
	// getFiscalBAC().insertRegime(request);
	// ResponseHandler.handleOperationStatusAndMessages(regimeResponse,
	// internalResponse, true);
	// } catch (Exception ex) {
	// ResponseHandler.handleException(LOG, regimeResponse, ex,
	...
	// @ResponseBody
	// public RegimeResponse updateRegime(@RequestBody RegimeMaintenanceRequest
	// request) {
	// RegimeResponse regimeResponse = new RegimeResponse();
	// try {
	// InternalResultsResponse<Regime> internalResponse =
	// getFiscalBAC().updateRegime(request);
	// ResponseHandler.handleOperationStatusAndMessages(regimeResponse,
	// internalResponse, true);
	// } catch (Exception ex) {
	// ResponseHandler.handleException(LOG, regimeResponse, ex,
	...
	// @ResponseBody
	// public RegimeResponse deleteRegime(@RequestBody RegimeMaintenanceRequest
	// request) {
	// RegimeResponse regimeResponse = new RegimeResponse();
	//
	// try {
	// InternalResultsResponse<Regime> internalResponse =
	// getFiscalBAC().deleteRegime(request);
	// ResponseHandler.handleOperationStatusAndMessages(regimeResponse,
	// internalResponse, true);
	// } catch (Exception ex) {
	// ResponseHandler.handleException(LOG, regimeResponse, ex,
	...
	// @RequestMapping(value = "/refresh", method = RequestMethod.GET)
	// @ResponseBody
	// public CfopResponse refreshCfops(@RequestParam("refreshInt") Integer
	// refreshInt,
	// @RequestParam("retList") Boolean retList, @RequestParam("retPaged")
	// Boolean retPaged) {
	...
	// RefreshRequest request = new RefreshRequest(refreshInt, retList,
	// retPaged);
	// InternalResultsResponse<Cfop> internalResponse =
	// getFiscalBAC().refreshCfops(request);
	// ResponseHandler.handleOperationStatusAndMessages(cfopResponse,
	// internalResponse, true);
	// } catch (Exception ex) {
	// ResponseHandler.handleException(LOG, cfopResponse, ex,
	// DEFAULT_EXCEPTION_MSG,
	// new Object[] { ex.toString() });
	// }
	// return cfopResponse;
	...
	// @RequestMapping(value = "/fetchPage", method = RequestMethod.POST)
	// @ResponseBody
	// public CfopResponse fetchCfopPaged(@RequestBody CfopInquiryRequest
	// request) {
	// CfopResponse cfopResponse = new CfopResponse();
	// try {
	// InternalResultsResponse<Cfop> internalResponse =
	// getFiscalBAC().fetchCfopsByRequest(request);
	// ResponseHandler.handleOperationStatusAndMessages(cfopResponse,
	// internalResponse, true);
	// } catch (Exception ex) {
	// ResponseHandler.handleException(LOG, cfopResponse, ex,
	...
	// @RequestMapping(value = "/insert", method = RequestMethod.POST)
	// @ResponseBody
	// public CfopResponse insertCfop(@RequestBody CfopMaintenanceRequest
	// request) {
	// CfopResponse cfopResponse = new CfopResponse();
	// try {
	// InternalResultsResponse<Cfop> internalResponse =
	// getFiscalBAC().insertCfop(request);
	// ResponseHandler.handleOperationStatusAndMessages(cfopResponse,
	// internalResponse, true);
	// } catch (Exception ex) {
	// ResponseHandler.handleException(LOG, cfopResponse, ex,
	...
	// @RequestMapping(value = "/update", method = RequestMethod.POST)
	// @ResponseBody
	// public CfopResponse updateCfop(@RequestBody CfopMaintenanceRequest
	// request) {
	// CfopResponse cfopResponse = new CfopResponse();
	// try {
	// InternalResultsResponse<Cfop> internalResponse =
	// getFiscalBAC().updateCfop(request);
	// ResponseHandler.handleOperationStatusAndMessages(cfopResponse,
	// internalResponse, true);
	// } catch (Exception ex) {
	// ResponseHandler.handleException(LOG, cfopResponse, ex,
	...
	// @RequestMapping(value = "/delete", method = RequestMethod.POST)
	// @ResponseBody
	// public CfopResponse deleteCfop(@RequestBody CfopMaintenanceRequest
	// request) {
	// CfopResponse cfopResponse = new CfopResponse();
	//
	// try {
	// InternalResultsResponse<Cfop> internalResponse =
	// getFiscalBAC().deleteCfop(request);
	// ResponseHandler.handleOperationStatusAndMessages(cfopResponse,
	// internalResponse, true);
	// } catch (Exception ex) {
	// ResponseHandler.handleException(LOG, cfopResponse, ex,
	...
	// @RequestMapping(value = "/refresh", method = RequestMethod.GET)
	// @ResponseBody
	// public CnaeResponse refreshCnaes(@RequestParam("refreshInt") Integer
	// refreshInt,
	// @RequestParam("retList") Boolean retList, @RequestParam("retPaged")
	// Boolean retPaged) {
	...
	// getFiscalBAC().refreshCnaes(request);
	// ResponseHandler.handleOperationStatusAndMessages(cnaeResponse,
	// internalResponse, true);
	// } catch (Exception ex) {
	// ResponseHandler.handleException(LOG, cnaeResponse, ex,
	// DEFAULT_EXCEPTION_MSG,
	// new Object[] { ex.toString() });
	// }
	// return cnaeResponse;
	...
	// @RequestMapping(value = "/fetchPage", method = RequestMethod.POST)
	// @ResponseBody
	// public CnaeResponse fetchCnaePaged(@RequestBody CnaeInquiryRequest
	// request) {
	// CnaeResponse cnaeResponse = new CnaeResponse();
	// try {
	// InternalResultsResponse<Cnae> internalResponse =
	// getFiscalBAC().fetchCnaesByRequest(request);
	// ResponseHandler.handleOperationStatusAndMessages(cnaeResponse,
	// internalResponse, true);
	// } catch (Exception ex) {
	// ResponseHandler.handleException(LOG, cnaeResponse, ex,
	...
	// @RequestMapping(value = "/insert", method = RequestMethod.POST)
	// @ResponseBody
	// public CnaeResponse insertCnae(@RequestBody CnaeMaintenanceRequest
	// request) {
	// CnaeResponse cnaeResponse = new CnaeResponse();
	// try {
	// InternalResultsResponse<Cnae> internalResponse =
	// getFiscalBAC().insertCnae(request);
	// ResponseHandler.handleOperationStatusAndMessages(cnaeResponse,
	// internalResponse, true);
	// } catch (Exception ex) {
	// ResponseHandler.handleException(LOG, cnaeResponse, ex,
	...
	// @RequestMapping(value = "/update", method = RequestMethod.POST)
	// @ResponseBody
	// public CnaeResponse updateCnae(@RequestBody CnaeMaintenanceRequest
	// request) {
	// CnaeResponse cnaeResponse = new CnaeResponse();
	// try {
	// InternalResultsResponse<Cnae> internalResponse =
	// getFiscalBAC().updateCnae(request);
	// ResponseHandler.handleOperationStatusAndMessages(cnaeResponse,
	// internalResponse, true);
	// } catch (Exception ex) {
	// ResponseHandler.handleException(LOG, cnaeResponse, ex,
	...
	// @RequestMapping(value = "/delete", method = RequestMethod.POST)
	// @ResponseBody
	// public CnaeResponse deleteCnae(@RequestBody CnaeMaintenanceRequest
	// request) {
	// CnaeResponse cnaeResponse = new CnaeResponse();
	//
	// try {
	// InternalResultsResponse<Cnae> internalResponse =
	// getFiscalBAC().deleteCnae(request);
	// ResponseHandler.handleOperationStatusAndMessages(cnaeResponse,
	// internalResponse, true);
	// } catch (Exception ex) {
	// ResponseHandler.handleException(LOG, cnaeResponse, ex,
