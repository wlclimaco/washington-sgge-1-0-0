...
public class OrdemServicoAPIController extends BaseController {
	...
	private static final String DEFAULT_EXCEPTION_MSG = "sysmgmt.base.ordemservicocontrollerrest.defaultexception";
	...
	public OrdemServicoResponse fetchOrdemServicoPaged(@RequestBody OrdemServicoInquiryRequest request) {
		OrdemServicoResponse ordemservicoResponse = new OrdemServicoResponse();
		try {
			InternalResultsResponse<OrdemServico> internalResponse = getOrdemServicoBAC()
	...
	// refreshOrdemServicoTypes(@RequestParam("refreshInt") Integer refreshInt,
	...
	// @RequestMapping(value = "/fetchPage", method = RequestMethod.POST)
	// @ResponseBody
	// public OrdemServicoTypeResponse fetchOrdemServicoTypePaged(@RequestBody
	...
	// refreshOrdemServicoItenss(@RequestParam("refreshInt") Integer refreshInt,
	// @RequestParam("retList") Boolean retList, @RequestParam("retPaged")
	// Boolean retPaged) {
	...
	// @RequestMapping(value = "/fetchPage", method = RequestMethod.POST)
	// @ResponseBody
	// public OrdemServicoItensResponse fetchOrdemServicoItensPaged(@RequestBody
