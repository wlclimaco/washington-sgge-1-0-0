...
public class CondominioAPIController extends BaseController {
	...
	// "sysmgmt.base.condominiocontrollerrest.defaultexception";
	//
	// /** The Constant LOG. */
	// private static final Logger LOG =
	// LoggerFactory.getLogger(CondominioAPIController.class);
	//
	// /** The condominio bac. */
	...
	// @ResponseBody
	// public AvisoResponse refreshAvisoss(@RequestParam("refreshInt") Integer
	// refreshInt,
	...
	// retPaged);
	// InternalResultsResponse<Avisos> internalResponse =
	// getCondominioBAC().refreshAvisos(request);
	// ResponseHandler.handleOperationStatusAndMessages(avisosResponse,
	// internalResponse, true);
	// } catch (Exception ex) {
	// ResponseHandler.handleException(LOG, avisosResponse, ex,
	...
	// @ResponseBody
	// public AvisoResponse fetchAvisosPaged(@RequestBody AvisoInquiryRequest
	// request) {
	// AvisoResponse avisosResponse = new AvisoResponse();
	// try {
	// InternalResultsResponse<Avisos> internalResponse =
	// getCondominioBAC().fetchAvisosByRequest(request);
	// ResponseHandler.handleOperationStatusAndMessages(avisosResponse,
	// internalResponse, true);
	// } catch (Exception ex) {
	// ResponseHandler.handleException(LOG, avisosResponse, ex,
	...
	// @ResponseBody
	// public AvisoResponse insertAvisos(@RequestBody AvisoMaintenanceRequest
	// request) {
	// AvisoResponse avisosResponse = new AvisoResponse();
	// try {
	// InternalResultsResponse<Avisos> internalResponse =
	// getCondominioBAC().insertAvisos(request);
	// ResponseHandler.handleOperationStatusAndMessages(avisosResponse,
	// internalResponse, true);
	// } catch (Exception ex) {
	// ResponseHandler.handleException(LOG, avisosResponse, ex,
	...
	// @ResponseBody
	// public AvisoResponse updateAvisos(@RequestBody AvisoMaintenanceRequest
	// request) {
	// AvisoResponse avisosResponse = new AvisoResponse();
	// try {
	// InternalResultsResponse<Avisos> internalResponse =
	// getCondominioBAC().updateAvisos(request);
	// ResponseHandler.handleOperationStatusAndMessages(avisosResponse,
	// internalResponse, true);
	// } catch (Exception ex) {
	// ResponseHandler.handleException(LOG, avisosResponse, ex,
	...
	// @ResponseBody
	// public AvisoResponse deleteAvisos(@RequestBody AvisoMaintenanceRequest
	// request) {
	// AvisoResponse avisosResponse = new AvisoResponse();
	//
	// try {
	// InternalResultsResponse<Avisos> internalResponse =
	// getCondominioBAC().deleteAvisos(request);
	// ResponseHandler.handleOperationStatusAndMessages(avisosResponse,
	// internalResponse, true);
	// } catch (Exception ex) {
	// ResponseHandler.handleException(LOG, avisosResponse, ex,
