...
public class DicionarioAPIController extends BaseController {
	...
	// "sysmgmt.base.dicionariocontrollerrest.defaultexception";
	//
	// /** The Constant LOG. */
	// private static final Logger LOG =
	// LoggerFactory.getLogger(DicionarioAPIController.class);
	//
	// /** The dicionario bac. */
	...
	// @ResponseBody
	// public ClassesResponse refreshClassess(@RequestParam("refreshInt")
	// Integer refreshInt,
	...
	// retPaged);
	// InternalResultsResponse<Classes> internalResponse =
	// getDicionarioBAC().refreshClassess(request);
	// ResponseHandler.handleOperationStatusAndMessages(classesResponse,
	// internalResponse, true);
	// } catch (Exception ex) {
	// ResponseHandler.handleException(LOG, classesResponse, ex,
	...
	// @ResponseBody
	// public ClassesResponse fetchClassesPaged(@RequestBody
	// ClassesInquiryRequest request) {
	// ClassesResponse classesResponse = new ClassesResponse();
	// try {
	// InternalResultsResponse<Classes> internalResponse =
	// getDicionarioBAC().fetchClassessByRequest(request);
	// ResponseHandler.handleOperationStatusAndMessages(classesResponse,
	// internalResponse, true);
	// } catch (Exception ex) {
	// ResponseHandler.handleException(LOG, classesResponse, ex,
	...
	// @ResponseBody
	// public ClassesResponse insertClasses(@RequestBody
	// ClassesMaintenanceRequest request) {
	// ClassesResponse classesResponse = new ClassesResponse();
	// try {
	// InternalResultsResponse<Classes> internalResponse =
	// getDicionarioBAC().insertClasses(request);
	// ResponseHandler.handleOperationStatusAndMessages(classesResponse,
	// internalResponse, true);
	// } catch (Exception ex) {
	// ResponseHandler.handleException(LOG, classesResponse, ex,
	...
	// @ResponseBody
	// public ClassesResponse updateClasses(@RequestBody
	// ClassesMaintenanceRequest request) {
	// ClassesResponse classesResponse = new ClassesResponse();
	// try {
	// InternalResultsResponse<Classes> internalResponse =
	// getDicionarioBAC().updateClasses(request);
	// ResponseHandler.handleOperationStatusAndMessages(classesResponse,
	// internalResponse, true);
	// } catch (Exception ex) {
	// ResponseHandler.handleException(LOG, classesResponse, ex,
	...
	// @ResponseBody
	// public ClassesResponse deleteClasses(@RequestBody
	// ClassesMaintenanceRequest request) {
	// ClassesResponse classesResponse = new ClassesResponse();
	//
	// try {
	// InternalResultsResponse<Classes> internalResponse =
	// getDicionarioBAC().deleteClasses(request);
	// ResponseHandler.handleOperationStatusAndMessages(classesResponse,
	// internalResponse, true);
	// } catch (Exception ex) {
	// ResponseHandler.handleException(LOG, classesResponse, ex,
	...
	// @RequestMapping(value = "/refresh", method = RequestMethod.GET)
	// @ResponseBody
	// public InterfaceResponse refreshInterfaces(@RequestParam("refreshInt")
	// Integer refreshInt,
	// @RequestParam("retList") Boolean retList, @RequestParam("retPaged")
	// Boolean retPaged) {
	...
	// RefreshRequest request = new RefreshRequest(refreshInt, retList,
	// retPaged);
	// InternalResultsResponse<Interface> internalResponse =
	// getDicionarioBAC().refreshInterfaces(request);
	// ResponseHandler.handleOperationStatusAndMessages(interfaceResponse,
	// internalResponse, true);
	// } catch (Exception ex) {
	// ResponseHandler.handleException(LOG, interfaceResponse, ex,
	// DEFAULT_EXCEPTION_MSG,
	// new Object[] { ex.toString() });
	// }
	...
	// @RequestMapping(value = "/fetchPage", method = RequestMethod.POST)
	// @ResponseBody
	// public InterfaceResponse fetchInterfacePaged(@RequestBody
	// InterfaceInquiryRequest request) {
	// InterfaceResponse interfaceResponse = new InterfaceResponse();
	// try {
	// InternalResultsResponse<Interface> internalResponse =
	// getDicionarioBAC().fetchInterfacesByRequest(request);
	// ResponseHandler.handleOperationStatusAndMessages(interfaceResponse,
	// internalResponse, true);
	// } catch (Exception ex) {
	// ResponseHandler.handleException(LOG, interfaceResponse, ex,
	...
	// @RequestMapping(value = "/insert", method = RequestMethod.POST)
	// @ResponseBody
	// public InterfaceResponse insertInterface(@RequestBody
	// InterfaceMaintenanceRequest request) {
	// InterfaceResponse interfaceResponse = new InterfaceResponse();
	// try {
	// InternalResultsResponse<Interface> internalResponse =
	// getDicionarioBAC().insertInterface(request);
	// ResponseHandler.handleOperationStatusAndMessages(interfaceResponse,
	// internalResponse, true);
	// } catch (Exception ex) {
	// ResponseHandler.handleException(LOG, interfaceResponse, ex,
	...
	// @RequestMapping(value = "/update", method = RequestMethod.POST)
	// @ResponseBody
	// public InterfaceResponse updateInterface(@RequestBody
	// InterfaceMaintenanceRequest request) {
	// InterfaceResponse interfaceResponse = new InterfaceResponse();
	// try {
	// InternalResultsResponse<Interface> internalResponse =
	// getDicionarioBAC().updateInterface(request);
	// ResponseHandler.handleOperationStatusAndMessages(interfaceResponse,
	// internalResponse, true);
	// } catch (Exception ex) {
	// ResponseHandler.handleException(LOG, interfaceResponse, ex,
	...
	// @RequestMapping(value = "/delete", method = RequestMethod.POST)
	// @ResponseBody
	// public InterfaceResponse deleteInterface(@RequestBody
	// InterfaceMaintenanceRequest request) {
	// InterfaceResponse interfaceResponse = new InterfaceResponse();
	//
	// try {
	// InternalResultsResponse<Interface> internalResponse =
	// getDicionarioBAC().deleteInterface(request);
	// ResponseHandler.handleOperationStatusAndMessages(interfaceResponse,
	// internalResponse, true);
	// } catch (Exception ex) {
	// ResponseHandler.handleException(LOG, interfaceResponse, ex,
	...
	// getDicionarioBAC().refreshFields(request);
	...
	// try {
	// InternalResultsResponse<Field> internalResponse =
	// getDicionarioBAC().fetchFieldsByRequest(request);
	// ResponseHandler.handleOperationStatusAndMessages(fieldResponse,
	// internalResponse, true);
	// } catch (Exception ex) {
	// ResponseHandler.handleException(LOG, fieldResponse, ex,
	...
	// try {
	// InternalResultsResponse<Field> internalResponse =
	// getDicionarioBAC().insertField(request);
	// ResponseHandler.handleOperationStatusAndMessages(fieldResponse,
	// internalResponse, true);
	// } catch (Exception ex) {
	// ResponseHandler.handleException(LOG, fieldResponse, ex,
	...
	// try {
	// InternalResultsResponse<Field> internalResponse =
	// getDicionarioBAC().updateField(request);
	// ResponseHandler.handleOperationStatusAndMessages(fieldResponse,
	// internalResponse, true);
	// } catch (Exception ex) {
	// ResponseHandler.handleException(LOG, fieldResponse, ex,
	...
	// try {
	// InternalResultsResponse<Field> internalResponse =
	// getDicionarioBAC().deleteField(request);
	// ResponseHandler.handleOperationStatusAndMessages(fieldResponse,
	// internalResponse, true);
	// } catch (Exception ex) {
	// ResponseHandler.handleException(LOG, fieldResponse, ex,
