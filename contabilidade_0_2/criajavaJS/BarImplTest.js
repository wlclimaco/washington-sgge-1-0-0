...
text = text + "	{\n";
text = text + '		'+nomeM+' '+nome+' = insert'+nomeM+'(4, TabelaEnum.'+nomeM.toUpperCase()+', PersistenceActionEnum.INSERT);\n';
...
text = text + "	{\n";
text = text + '		'+nomeM+' '+nome+' = insert'+nomeM+'(1, TabelaEnum.'+nomeM.toUpperCase()+', PersistenceActionEnum.UPDATE);\n';
text = text + "		FetchByIdRequest request = new FetchByIdRequest();\n";
