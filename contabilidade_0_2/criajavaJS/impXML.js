...
Repositorio = function(teste, bar, local) {
    ...
    text = text + '\n';
    text = text + '@Query("SELECT u  FROM ' + bar + ' u WHERE u.id = :id")\n';
...
Servico = function(teste, name, local) {
    ...
    text = text + 'public ' + name + ' delete' + name + '(' + name + ' ' + name.toLowerCase() + ');\n';
    text = text + '\n';
    text = text + '}\n';
    return text;
}
...
ServicoImp = function(teste, name, local) {
    ...
    text = text + '\n';
    text = text + '@Service("' + name.toLowerCase() + 'Service")\n';
    ...
    text = text + '      @Override\n';
    text = text + '      public List < ' + name + ' > find' + name + 'All(PaginationFilter filter) {\n';
    text = text + '          return ' + name.toLowerCase() + 'Repository.findAll();\n';
    text = text + '      }\n';
    text = text + '\n';
    text = text + '@Override\n';
    text = text + 'public ' + name + ' delete' + name + '(' + name + ' ' + name.toLowerCase() + ') {\n';
    text = text + '     ' + name.toLowerCase() + 'Repository.delete(' + name.toLowerCase() + ');\n';
    text = text + '	    return ' + name.toLowerCase() + ';\n';
    text = text + '	\n';
    text = text + '}\n';
    text = text + '\n';
    text = text + '\n';
