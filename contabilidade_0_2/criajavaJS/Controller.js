...
ControllerSpringBoot = function(teste, bar) {
    ...
    text = text + "\n";
    text = text + "import javax.annotation.Resource;\n";
    text = text + "import com.nouhoun.springboot.jwt.integration.controller.Request;\n";
    text = text + "\n";
    text = text + "import org.slf4j.Logger;\n";
    text = text + "import org.slf4j.LoggerFactory;\n";
    text = text + "import org.springframework.stereotype.Controller;\n";
    ...
    for (i = 0; i < teste.length; i++) {
        ...
        nomeM = titleize(teste[i].classe)
        text = text + "\n";
        text = text + "	/** The " + nomeM.toLowerCase() + " Service. */\n";
        text = text + "@Autowired\n";
        text = text + "private " + nomeM + "Service " + nomeM.toLowerCase() + "Service;\n";
        text = text + "\n";
    }
    for (i = 0; i < teste.length; i++) {
        ...
        text = text + '	@RequestMapping(value = "/' + nomeM.toLowerCase() + '/refresh", method = RequestMethod.GET)\n';
        text = text + '	@ResponseBody\n';
        text = text + ' public ResponseEntity<List<' + nomeM + '>> refresh' + nomeM + 'Paged(@RequestBody PaginationFilter requestString)\n';
        text = text + ' {\n';
        text = text + '     return new ResponseEntity<List<' + nomeM + '>>(' + nomeM.toLowerCase() + 'Service.find' + nomeM + 'All(requestString), HttpStatus.OK);\n';
        text = text + ' }\n';
        text = text + "\n";
        text = text + '	/**\n';
        text = text + '	 * Fetch ' + nomeM.toLowerCase() + ' paged.\n';
        ...
        text = text + '	 * @return the ' + nomeM.toLowerCase() + ' response\n';
        text = text + '	 */\n';
        text = text + '	@RequestMapping(value = "/' + nomeM.toLowerCase() + '/fetchPage", method = RequestMethod.POST)\n';
        text = text + '	@ResponseBody\n';
        text = text + '	public ResponseEntity<List<' + nomeM + '>> fetch' + nomeM + 'Paged(@RequestBody PaginationFilter requestString)\n';
        text = text + '	 {\n';
        text = text + '     return new ResponseEntity<List<' + nomeM + '>>(' + nomeM.toLowerCase() + 'Service.find' + nomeM + 'All(requestString), HttpStatus.OK);\n';
        text = text + ' }\n';
        text = text + "\n";
        ...
        text = text + '@CrossOrigin(origins = "*")\n';
        text = text + '@RequestMapping(value = "/' + nomeM.toLowerCase() + '/insert", method = RequestMethod.POST)\n';
        text = text + 'public ResponseEntity<' + nomeM + '> insert' + nomeM + '(@RequestBody String ' + nomeM.toLowerCase() + 's,\n';
        text = text + '        HttpServletRequest request)\n';
        text = text + '        throws JsonParseException, JsonMappingException, IOException {\n';
        text = text + '    \n';
        text = text + '     ObjectMapper mapper = new ObjectMapper();\n';
        text = text + '     ' + nomeM + ' ' + nomeM.toLowerCase() + ' = mapper.readValue(' + nomeM.toLowerCase() + 's, ' + nomeM + '.class);\n';
        text = text + '    return new ResponseEntity<' + nomeM + '>(' + nomeM.toLowerCase() + 'Service.save' + nomeM + '(' + nomeM.toLowerCase() + '), HttpStatus.OK);\n';
        text = text + '}\n';


        text = text + '@CrossOrigin(origins = "*")\n';
        text = text + '@RequestMapping(value = "/' + nomeM.toLowerCase() + '/update", method = RequestMethod.POST)\n';
        text = text + 'public ResponseEntity<' + nomeM + '> update' + nomeM + '(@RequestBody ' + nomeM + ' ' + nomeM.toLowerCase() + ',\n';
        text = text + '        HttpServletRequest request)\n';
        text = text + '        throws JsonParseException, JsonMappingException, IOException {\n';
        text = text + '    \n';
        text = text + '    return new ResponseEntity<' + nomeM + '>(' + nomeM.toLowerCase() + 'Service.update' + nomeM + '(' + nomeM.toLowerCase() + '), HttpStatus.OK);\n';
        text = text + '}\n';

        text = text + '@CrossOrigin(origins = "*")\n';
        text = text + '@RequestMapping(value = "/' + nomeM.toLowerCase() + '/delete", method = RequestMethod.POST)\n';
        text = text + 'public ResponseEntity<' + nomeM + '> delete' + nomeM + '(@RequestBody ' + nomeM + ' ' + nomeM.toLowerCase() + ',\n';
        text = text + '        HttpServletRequest request)\n';
        text = text + '        throws JsonParseException, JsonMappingException, IOException {\n';
        text = text + '    \n';
        text = text + '    return new ResponseEntity<' + nomeM + '>(' + nomeM.toLowerCase() + 'Service.delete' + nomeM + '(' + nomeM.toLowerCase() + '), HttpStatus.OK);\n';
        text = text + '}\n';
        text = text + "\n";
    }
    text = text + "}\n";
