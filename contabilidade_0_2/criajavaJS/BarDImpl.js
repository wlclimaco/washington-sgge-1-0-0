...
text = text + '	public static Integer maintain'+bar+'Associations('+bar+' '+bar.toLowerCase()+',\n';
text = text + '			InternalResponse response, Integer parentId, TypeEnum type, AcaoEnum acaoType,\n';
...
text = text + '		if (ValidationUtil.isNull('+bar.toLowerCase()+'))\n';
text = text + '		{\n';
text = text + '			return 0;\n';
text = text + '		}\n';
