 ...
 */
public enum OrdemServicoTypeEnum implements IIntegerEnum, II18nEnum
{
	 ...
	 */
	private OrdemServicoTypeEnum(Integer value, String labelKeyParam)
	{
		code = value;
	 ...
	 */
	public static OrdemServicoTypeEnum enumForValue(Integer value)
	{
		for (OrdemServicoTypeEnum e : values())
		{
	...
	public static String getValidValues()
	{
		...
		for (OrdemServicoTypeEnum i : OrdemServicoTypeEnum.class.getEnumConstants())
		{
