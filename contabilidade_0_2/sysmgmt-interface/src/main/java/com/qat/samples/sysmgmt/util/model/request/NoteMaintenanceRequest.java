 ...
 */
public class NoteMaintenanceRequest extends Request
{
	/** The note. */
	...
	/**
	 * Instantiates a new note maintenance request.
	 *
	 * @param note the note
	 * @param returnList the return list
	 * @param returnListPaged the return list paged
	 */
	public NoteMaintenanceRequest(Note note, Boolean returnList, Boolean returnListPaged)
	{
		this.note = note;
	...
	{
		return "NoteMaintenanceRequest [getNote()=" + getNote() + ", getReturnList()=" + getReturnList() + ", getReturnListPaged()=" + getReturnListPaged()
