 ...
 */
public class StatusMaintenanceRequest extends Request
{
	/** The status. */
	 ...
	 */
	public StatusMaintenanceRequest(Status status, Boolean returnList, Boolean returnListPaged)
	{
		this.status = status;
	...
	{
		return "StatusMaintenanceRequest [getStatus()=" + getStatus() + ", getReturnList()=" + getReturnList() + ", getReturnListPaged()=" + getReturnListPaged()
