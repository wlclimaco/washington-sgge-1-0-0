...
/**
 * The Class TarefaMaintenanceRequest.
 */
public class TarefaMaintenanceRequest extends Request
{
	/** The tarefa. */
	...
	/**
	 * Instantiates a new tarefa maintenance request.
	 *
	 * @param tarefa the tarefa
	 * @param returnList the return list
	 * @param returnListPaged the return list paged
	 */
	public TarefaMaintenanceRequest(Tarefa tarefa, Boolean returnList, Boolean returnListPaged)
	{
		this.tarefa = tarefa;
	 ...
	 * Instantiates a new tarefa maintenance request.
	 */
	public TarefaMaintenanceRequest()
	{
	}
	...
	{
		return "TarefaMaintenanceRequest [getTarefa()=" + getTarefa() + ", getReturnList()=" + getReturnList() + ", getReturnListPaged()=" + getReturnListPaged()
