...
/**
 * The Model Object FieldRequest.
 */
public class FieldMaintenanceRequest extends Request
{
	...
	/**
	 * Instantiates a new field maintenance request.
	 *
	 * @param field the field
	 * @param returnList the return list
	 * @param returnListPaged the return list paged
	 */
	public FieldMaintenanceRequest(Field field, Boolean returnList, Boolean returnListPaged)
	{
		this.field = field;
	...
	{
		return "FieldMaintenanceRequest [getField()=" + getField() + ", getReturnList()=" + getReturnList() + ", getReturnListPaged()=" + getReturnListPaged() + ", getUserContext()="
				+ getRequestContext() + "]";
	}
