 ...
 */
public class DoisValoresMaintenanceRequest extends Request
{
	/** The doisValor. */
	 ...
	 * Gets the doisValor.
	 *
	 * @return the doisValor
	 */
	public DoisValores getDoisValores()
	{
		return doisValor;
	}
	 ...
	 * Sets the doisValor.
	 *
	 * @param doisValor the new doisValor
	 */
	public void setDoisValores(DoisValores doisValor)
	{
		this.doisValor = doisValor;
	}
	...
	{
		return "DoisValoresMaintenanceRequest [getDoisValores()=" + getDoisValores() + ", getReturnList()=" + getReturnList() + ", getReturnListPaged()=" + getReturnListPaged()
