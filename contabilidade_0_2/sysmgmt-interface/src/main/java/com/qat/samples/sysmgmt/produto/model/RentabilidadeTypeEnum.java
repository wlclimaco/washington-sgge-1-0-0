 ...
 */
public enum RentabilidadeTypeEnum implements IIntegerEnum, II18nEnum
{
	 ...
	 */
	private RentabilidadeTypeEnum(Integer value, String labelKeyParam)
	{
		code = value;
	 ...
	 */
	public static RentabilidadeTypeEnum enumForValue(Integer value)
	{
		for (RentabilidadeTypeEnum e : values())
		{
	...
	public static String getValidValues()
	{
		...
		for (RentabilidadeTypeEnum i : RentabilidadeTypeEnum.class.getEnumConstants())
		{
