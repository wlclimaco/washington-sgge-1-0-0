...
/**
 * The Model Object AjudaRequest.
 */
public class AjudaMaintenanceRequest extends Request
{
	...
	/**
	 * Instantiates a new ajuda maintenance request.
	 *
	 * @param ajuda the ajuda
	 * @param returnList the return list
	 * @param returnListPaged the return list paged
	 */
	public AjudaMaintenanceRequest(Ajuda ajuda, Boolean returnList, Boolean returnListPaged)
	{
		this.ajuda = ajuda;
	 ...
	 * Instantiates a new ajuda maintenance request.
	 */
	public AjudaMaintenanceRequest()
	{
	...
	{
		return "AjudaMaintenanceRequest [getAjuda()=" + getAjuda() + ", getReturnList()=" + getReturnList() + ", getReturnListPaged()=" + getReturnListPaged() + ", getUserContext()="
				+ getRequestContext() + "]";
	}
