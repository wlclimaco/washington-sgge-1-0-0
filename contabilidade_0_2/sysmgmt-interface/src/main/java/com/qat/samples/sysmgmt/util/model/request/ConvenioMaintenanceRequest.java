...
/**
 * The Class ConvenioMaintenanceRequest.
 */
public class ConvenioMaintenanceRequest extends Request
{
	/** The convenio. */
	...
	/**
	 * Instantiates a new convenio maintenance request.
	 *
	 * @param convenio the convenio
	 * @param returnList the return list
	 * @param returnListPaged the return list paged
	 */
	public ConvenioMaintenanceRequest(Convenio convenio, Boolean returnList, Boolean returnListPaged)
	{
	 ...
	 * Instantiates a new convenio maintenance request.
	 */
	public ConvenioMaintenanceRequest()
	{
	}
	...
	{
		return "ConvenioMaintenanceRequest [getConvenio()=" + getConvenio() + ", getReturnList()=" + getReturnList() + ", getReturnListPaged()=" + getReturnListPaged()
