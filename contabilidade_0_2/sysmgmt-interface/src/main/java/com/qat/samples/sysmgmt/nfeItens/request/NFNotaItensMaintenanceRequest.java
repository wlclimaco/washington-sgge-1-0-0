package com.qat.samples.sysmgmt.nfeItens.request;
 ...
 */
public class NFNotaItensMaintenanceRequest extends Request
{
	/** The county. */
	 ...
	 */
	public NFNotaItensMaintenanceRequest(NFNota county, Boolean returnList, Boolean returnListPaged)
	{
		this.county = county;
	 ...
	 * Instantiates a new county maintenance request.
	 */
	public NFNotaItensMaintenanceRequest()
	{
	}
