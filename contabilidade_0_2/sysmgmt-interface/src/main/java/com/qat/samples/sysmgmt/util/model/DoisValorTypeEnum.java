...
public enum DoisValorTypeEnum implements IIntegerEnum, II18nEnum
{
	 ...
	 */
	private DoisValorTypeEnum(Integer value, String labelKeyParam)
	{
		code = value;
	 ...
	 */
	public static DoisValorTypeEnum enumForValue(Integer value)
	{
		for (DoisValorTypeEnum e : values())
		{
	...
	public static String getValidValues()
	{
		...
		for (DoisValorTypeEnum i : DoisValorTypeEnum.class.getEnumConstants())
		{
