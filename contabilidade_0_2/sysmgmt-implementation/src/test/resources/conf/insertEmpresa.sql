...
(1004,'nome_1', 1, 1, 1, 1, 1,'system',1462134312648,'rod',1462134312648);

INSERT INTO entidade(id ,nome, processId, entidadeId, emprId, entidadeEnumValue, regime,create_user,create_date,modify_user,modify_date)values
(1005,'nome_1', 2, 2, 2, 1, 2,'system',1462134312648,'rod',1462134312648);

INSERT INTO entidade(id ,nome, processId, entidadeId, emprId, entidadeEnumValue, regime,create_user,create_date,modify_user,modify_date)values
(1006,'nome_1', 3, 3, 3, 1, 3,'system',1462134312648,'rod',1462134312648);
...
( 1004, 1, 1, 'logradouro_4', 'bairro_5', 'numero_6', 1, 'cep_8', 'complemento_9', 1,'system',1462031573997,'rod',1462031573997);

INSERT INTO Endereco( parentId, tabelaEnumValue, processId, logradouro, bairro, numero, enderecoTypeValue, cep, complemento, cidade,create_user,create_date,modify_user,modify_date)values
( 2, 1, 2, 'logradouro_4', 'bairro_5', 'numero_6', 2, 'cep_8', 'complemento_9', 2,'system',1462031573997,'rod',1462031573997);

INSERT INTO Endereco(parentId, tabelaEnumValue, processId, logradouro, bairro, numero, enderecoTypeValue, cep, complemento, cidade,create_user,create_date,modify_user,modify_date)values
( 1004, 1, 3, 'logradouro_4', 'bairro_5', 'numero_6', 3, 'cep_8', 'complemento_9', 3,'system',1462031573998,'rod',1462031573998);
...
(1, 1004, 1, 1, 'numero_5', 1461352331960,'system',1461352331960,'rod',1461352331960);
...
(1, 1004, 1, 'email_4', 1,'system',1461944907888,'rod',1461944907888);
...
INSERT INTO Telefone(typeValue, parentId, tabelaEnumValue, ddd, numero, telefoneTypeEnumValue, processId,create_user,create_date,modify_user,modify_date)values
(2, 1004, 2, 'ddd_4', 'numero_5', 2, 2,'system',1462040163912,'rod',1462040163912);
...
( 1004, 1, 1, 1,'system',1462055653173,'rod',1462055653173);
...
(  1461530094517, 1004, 1, 1, 1, 'note_6','system',1461530094517,'rod',1461530094517);
...
(  1004, 'noteText_2', 1,'system',1462035712489,'rod',1462035712489);
