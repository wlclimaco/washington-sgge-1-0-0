...
import com.qat.samples.sysmgmt.bar.IEnderecoBAR;
import com.qat.samples.sysmgmt.model.Endereco;
import com.qat.samples.sysmgmt.model.request.FetchByIdRequest;
import com.qat.samples.sysmgmt.model.request.PagedInquiryRequest;

@ContextConfiguration(locations = {
		"classpath:conf/unittest-base-context.xml",
		"classpath:conf/enderecobartest-context.xml"
})
...
@Test
	...
	{
		Endereco endereco = new Endereco(999, "Endereco_999");
	...
	Endereco endereco = new Endereco();
		List<Endereco> response = getEnderecoBAR().fetchAllEnderecos().getResultsList();
	...
	{
		Endereco endereco = new Endereco(1234, "NATIVE INSERT UPDATE");
		FetchByIdRequest request = new FetchByIdRequest();
		request.setFetchId(1234);
		Endereco enderecoResponse = getEnderecoBAR().fetchEnderecoById(request);
		Assert.assertEquals(enderecoResponse.getDescription(), "NATIVE INSERT");
		getEnderecoBAR().updateEndereco(endereco);
		enderecoResponse = getEnderecoBAR().fetchEnderecoById(request);
		Assert.assertEquals(enderecoResponse.getDescription(), "NATIVE INSERT UPDATE");
	}
