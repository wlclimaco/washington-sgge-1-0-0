...
import com.qat.samples.sysmgmt.bar.ITelefoneBAR;
import com.qat.samples.sysmgmt.model.Telefone;
...
@Test
	...
	{
		Telefone telefone = new Telefone(999, "Telefone_999");
	...
	Telefone telefone = new Telefone();
		List<Telefone> response = getTelefoneBAR().fetchAllTelefones().getResultsList();
	...
	{
		Telefone telefone = new Telefone(1234, "NATIVE INSERT UPDATE");
		FetchByIdRequest request = new FetchByIdRequest();
		request.setFetchId(1234);
		Telefone telefoneResponse = getTelefoneBAR().fetchTelefoneById(request);
		Assert.assertEquals(telefoneResponse.getDescription(), "NATIVE INSERT");
		getTelefoneBAR().updateTelefone(telefone);
		telefoneResponse = getTelefoneBAR().fetchTelefoneById(request);
		Assert.assertEquals(telefoneResponse.getDescription(), "NATIVE INSERT UPDATE");
	}
