 ...
 */
public final class NFNotaInfoAvulsaBARD extends SqlSessionDaoSupport
{
	...
	public static Integer maintainNFNotaInfoAvulsaAssociations(NFNotaInfoAvulsa nfnotainfotransporte,
			...
			String UserId, Integer processId, Integer historicoId)
	{
		...
		//	}
			...
			{
				case INSERT:
					count = nfnotainfotransporteDAC.insertNFNotaInfoAvulsa(nfnotainfotransporte).hasSystemError();
					if (count == true)
					{
					...
					break;
				case UPDATE:
					count = nfnotainfotransporteDAC.updateNFNotaInfoAvulsa(nfnotainfotransporte).hasSystemError();
					if (count == true)
					{
						count =
					...
					break;
				case DELETE:
					count = nfnotainfotransporteDAC.deleteNFNotaInfoAvulsaById(nfnotainfotransporte).hasSystemError();
					Status status = new Status();
