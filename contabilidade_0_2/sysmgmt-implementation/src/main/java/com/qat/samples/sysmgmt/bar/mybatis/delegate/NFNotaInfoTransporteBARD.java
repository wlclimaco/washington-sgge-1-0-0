 ...
 */
public final class NFNotaInfoTransporteBARD extends SqlSessionDaoSupport
{
	...
	public static Integer maintainNFNotaInfoTransporteAssociations(NFNotaInfoTransporte nfnotainfotransporte,
			...
			String UserId, Integer processId, Integer historicoId)
	{
		...
		//	}
			...
			{
				case INSERT:
					count = nfnotainfotransporteDAC.insertNFNotaInfoTransporte(nfnotainfotransporte).hasSystemError();
					if (count == true)
					{
					...
					break;
				case UPDATE:
					count = nfnotainfotransporteDAC.updateNFNotaInfoTransporte(nfnotainfotransporte).hasSystemError();
					if (count == true)
					{
						count =
					...
					break;
				case DELETE:
					count = nfnotainfotransporteDAC.deleteNFNotaInfoTransporteById(nfnotainfotransporte).hasSystemError();
					Status status = new Status();
