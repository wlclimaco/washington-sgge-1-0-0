 ...
 */
public final class NFNotaInfoCanaFornecimentoDiarioBARD extends SqlSessionDaoSupport
{
	...
	public static Integer maintainNFNotaInfoCanaFornecimentoDiarioAssociations(List<NFNotaInfoCanaFornecimentoDiario> nfpessoaautorizadadownloadnfeList,
			...
			String UserId, Integer processId, Integer historicoId)
	{
		...
		for (NFNotaInfoCanaFornecimentoDiario nfpessoaautorizadadownloadnfe : nfpessoaautorizadadownloadnfeList)
		{
		...
		//	}
			...
			{
				case INSERT:
					count = nfpessoaautorizadadownloadnfeDAC.insertNFNotaInfoCanaFornecimentoDiario(nfpessoaautorizadadownloadnfe).hasSystemError();
					if (count == true)
					{
					...
					break;
				case UPDATE:
					count = nfpessoaautorizadadownloadnfeDAC.updateNFNotaInfoCanaFornecimentoDiario(nfpessoaautorizadadownloadnfe).hasSystemError();
					if (count == true)
					{
						count =
					...
					break;
				case DELETE:
					count = nfpessoaautorizadadownloadnfeDAC.deleteNFNotaInfoCanaFornecimentoDiarioById(nfpessoaautorizadadownloadnfe).hasSystemError();
					Status status = new Status();
