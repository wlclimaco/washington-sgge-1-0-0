 ...
 */
public final class NFNotaInfoEmitenteBARD extends SqlSessionDaoSupport
{
	...
	public static Integer maintainNFNotaInfoEmitenteAssociations(NFNotaInfoEmitente nfnotainfotransporte,
			...
			String UserId, Integer processId, Integer historicoId)
	{
		...
		//	}
			...
			{
				case INSERT:
					count = nfnotainfotransporteDAC.insertNFNotaInfoEmitente(nfnotainfotransporte).hasSystemError();
					if (count == true)
					{
					...
					break;
				case UPDATE:
					count = nfnotainfotransporteDAC.updateNFNotaInfoEmitente(nfnotainfotransporte).hasSystemError();
					if (count == true)
					{
						count =
					...
					break;
				case DELETE:
					count = nfnotainfotransporteDAC.deleteNFNotaInfoEmitenteById(nfnotainfotransporte).hasSystemError();
					Status status = new Status();
