 ...
 */
public final class NFNotaInfoItemImpostoICMS00BARD extends SqlSessionDaoSupport
{
	...
	public static Integer maintainNFNotaInfoItemImpostoICMS00Associations(NFNotaInfoItemImpostoICMS00 nfnotainfoitemimpostoicms00,
			InternalResponse response, Integer parentId, TypeEnum type, AcaoEnum acaoType,
			TabelaEnum tabelaEnum, INFNotaInfoItemBAR nfnotainfoitemimpostoicms00DAC, IStatusBAR statusDAC, IHistoricoBAR historicoDAC, Integer empId,
			String UserId, Integer processId, Integer historicoId)
	{
		Boolean count = false;
		// First Maintain Empresa
		if (ValidationUtil.isNull(nfnotainfoitemimpostoicms00))
		{
			return 0;
		}
		// For Each Contact...
			// Make sure we set the parent key
			nfnotainfoitemimpostoicms00.setParentId(parentId);
			nfnotainfoitemimpostoicms00.setTabelaEnum(tabelaEnum);
			nfnotainfoitemimpostoicms00.setProcessId(processId);

		//	if (ValidationUtil.isNull(nfnotainfoitemimpostoicms00.getModelAction()))
		//	{
		//		continue;
		//	}
			switch (nfnotainfoitemimpostoicms00.getModelAction())
			{
				case INSERT:
