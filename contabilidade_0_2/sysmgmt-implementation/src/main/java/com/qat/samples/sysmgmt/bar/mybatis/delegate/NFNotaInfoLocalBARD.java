 ...
 */
public final class NFNotaInfoLocalBARD extends SqlSessionDaoSupport
{
	...
	public static Integer maintainNFNotaInfoLocalAssociations(NFNotaInfoLocal nfnotainfotransporte,
			...
			String UserId, Integer processId, Integer historicoId)
	{
		...
		//	}
			...
			{
				case INSERT:
					count = nfnotainfotransporteDAC.insertNFNotaInfoLocal(nfnotainfotransporte).hasSystemError();
					if (count == true)
					{
					...
					break;
				case UPDATE:
					count = nfnotainfotransporteDAC.updateNFNotaInfoLocal(nfnotainfotransporte).hasSystemError();
					if (count == true)
					{
						count =
					...
					break;
				case DELETE:
					count = nfnotainfotransporteDAC.deleteNFNotaInfoLocalById(nfnotainfotransporte).hasSystemError();
					Status status = new Status();
