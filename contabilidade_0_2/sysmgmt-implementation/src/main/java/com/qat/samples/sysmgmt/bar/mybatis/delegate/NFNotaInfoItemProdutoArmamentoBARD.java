		...
		//	}
			switch (nfnotainfoitemprodutoarmamento.getModelAction())
			{
					...
					if (count == true)
					{
						...
						count =
								StatusBARD.maintainStatusAssociations(statusList, response, parentId, null,
										AcaoEnum.INSERT, UserId, empId, TabelaEnum.NFNOTAINFOITEMPRODUTOARMAMENTO, statusDAC, historicoDAC,
				...
				case UPDATE:
					...
					{
						count =
								StatusBARD.maintainStatusAssociations(nfnotainfoitemprodutoarmamento.getStatusList(), response, nfnotainfoitemprodutoarmamento.getId(),
										null,
										AcaoEnum.UPDATE, UserId, empId, TabelaEnum.NFNOTAINFOITEMPRODUTOARMAMENTO, statusDAC, historicoDAC,
										processId, historicoId);
					}
					break;
				case DELETE:
					...
					statusList.add(status);
					count =
							StatusBARD.maintainStatusAssociations(statusList, response, nfnotainfoitemprodutoarmamento.getId(), null,
									AcaoEnum.DELETE, UserId, empId, TabelaEnum.NFNOTAINFOITEMPRODUTOARMAMENTO, statusDAC, historicoDAC,
									processId, historicoId);
