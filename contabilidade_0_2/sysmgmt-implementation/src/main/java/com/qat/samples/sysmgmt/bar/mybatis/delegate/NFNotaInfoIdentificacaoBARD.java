 ...
 */
public final class NFNotaInfoIdentificacaoBARD extends SqlSessionDaoSupport
{
	...
	public static Integer maintainNFNotaInfoIdentificacaoAssociations(NFNotaInfoIdentificacao nfnotainfotransporte,
			...
			String UserId, Integer processId, Integer historicoId)
	{
		...
		//	}
			...
			{
				case INSERT:
					count = nfnotainfotransporteDAC.insertNFNotaInfoIdentificacao(nfnotainfotransporte).hasSystemError();
					if (count == true)
					{
					...
					break;
				case UPDATE:
					count = nfnotainfotransporteDAC.updateNFNotaInfoIdentificacao(nfnotainfotransporte).hasSystemError();
					if (count == true)
					{
						count =
					...
					break;
				case DELETE:
					count = nfnotainfotransporteDAC.deleteNFNotaInfoIdentificacaoById(nfnotainfotransporte).hasSystemError();
					Status status = new Status();
