...
public class FinanceiroBARImpl extends SqlSessionDaoSupport implements IFinanceiroBAR {
	...
	private static final String STMT_FETCH_CONTASPAGAR_ALL_REQUEST = NAMESPACE_CONTASPAGAR
			+ "fetchAllContasPagarsRequest";
	...
	private static final String STMT_FETCH_BAIXATITULO_ALL_REQUEST = NAMESPACE_BAIXATITULO
			+ "fetchAllBaixaTitulosRequest";
	...
	private static final String STMT_FETCH_CONTASRECEBER_ALL_REQUEST = NAMESPACE_CONTASRECEBER
			+ "fetchAllContasRecebersRequest";
	...
	private static final String STMT_FETCH_CONTACORRENTE_ALL_REQUEST = NAMESPACE_CONTACORRENTE
			+ "fetchAllContaCorrentesRequest";
	...
	public InternalResponse insertContasPagar(ContasPagar contaspagar) {
		...
		if (!ValidationUtil.isNullOrEmpty(contaspagar.getListBaixa())) {
			...
			BaixaTituloBARD.maintainBaixaTituloAssociations(contaspagar.getListBaixa(), response, contaspagar.getId(),
					TypeEnum.HIGH, AcaoTypeEnum.INSERT, TabelaEnum.CONTASPAGAR, getFinanceiroBAR(), statusBAR,
					historicoBAR, contaspagar.getEmprId(), contaspagar.getUserId(), historicoId, historicoId);
		}
		Double valor = 0.0;
	 ...
	 *
	 * @see
	 * com.qat.samples.sysmgmt.base.bar.IContasPagarBAR#updateContasPagar(com.
	 * qat.samples.sysmgmt.base.model.ContasPagar)
	 */
	@Override
	 ...
	 *
	 * @see
	 * com.qat.samples.sysmgmt.base.bar.IContasPagarBAR#deleteContasPagar(com.
	 * qat.samples.sysmgmt.base.model.ContasPagar)
	 */
	@Override
	 ...
	 *
	 * @see
	 * com.qat.samples.sysmgmt.base.bar.IContasPagarBAR#deleteAllContasPagars()
	 */
	@Override
	 ...
	 *
	 * @see
	 * com.qat.samples.sysmgmt.bar.IContasPagarBAR#fetchContasPagarById(com.qat.
	 * samples.sysmgmt.model.request.FetchByIdRequest)
	 */
	@Override
	public ContasPagar fetchContasPagarById(FetchByIdRequest request) {
		return (ContasPagar) MyBatisBARHelper.doQueryForObject(getSqlSession(), STMT_FETCH_CONTASPAGAR,
				request.getFetchId());
	 ...
	 * (non-Javadoc)
	 *
	 * @see com.qat.samples.sysmgmt.base.bar.IContasPagarBAR#
	 * fetchAllContasPagarsCache()
	 */
	@Override
	 ...
	 *
	 * @see
	 * com.qat.samples.sysmgmt.bar.IContasPagarBAR#fetchContasPagarsByRequest(
	...
	public InternalResultsResponse<ContasPagar> fetchContasPagarsByRequest(ContasPagarInquiryRequest request) {
		InternalResultsResponse<ContasPagar> response = new InternalResultsResponse<ContasPagar>();
		fetchContasPagarsByRequest(getSqlSession(), request, STMT_FETCH_CONTASPAGAR_COUNT,
				STMT_FETCH_CONTASPAGAR_ALL_REQUEST, response);
		return response;
	}
	...
	public static void fetchContasPagarsByRequest(SqlSession sqlSession, ContasPagarInquiryRequest request,
	 ...
	 *
	 * @see
	 * com.qat.samples.sysmgmt.base.bar.ITituloBAR#updateTitulo(com.qat.samples.
	 * sysmgmt.base.model.Titulo)
	 */
	@Override
	 ...
	 *
	 * @see
	 * com.qat.samples.sysmgmt.base.bar.ITituloBAR#deleteTitulo(com.qat.samples.
	 * sysmgmt.base.model.Titulo)
	 */
	@Override
	 ...
	 *
	 * @see
	 * com.qat.samples.sysmgmt.bar.ITituloBAR#fetchTituloById(com.qat.samples.
	 ...
	 *
	 * @see
	 * com.qat.samples.sysmgmt.bar.ITituloBAR#fetchTitulosByRequest(com.qat.
	...
	public InternalResponse insertBaixaTitulo(BaixaTitulo baixatitulo) {
		...
		// Integer historicoId =
		// InsertHistBARD.maintainInsertHistorico(TabelaEnum.CONTA,
		// getHistoricoBAR(), response);

		// baixatitulo.setProcessId(historicoId);

		// BaixaTituloBARD.maintainBaixaTituloAssociations(baixa, response,
		// baixatitulo.getId(), TypeEnum.HIGH, AcaoTypeEnum.INSERT,
		// TabelaEnum.CONTASPAGAR, getFinanceiroBAR(), statusBAR, historicoBAR,
		// baixatitulo.getEmprId(), baixatitulo.getUserId(), historicoId,
		// historicoId);
	...
	public InternalResponse insertBaixaTitulo2(BaixaTitulo baixatitulo) {
		...
		InternalResponse response = new InternalResponse();
		// MyBatisBARHelper.doInsert(getSqlSession(), STMT_INSERT_BAIXATITULO,
		// baixatitulo, response);
		List<BaixaTitulo> baixa = new ArrayList<BaixaTitulo>();
		baixa.add(baixatitulo);
		Integer historicoId = InsertHistBARD.maintainInsertHistorico(TabelaEnum.CONTA, getHistoricoBAR(), response);
		...
		BaixaTituloBARD.maintainBaixaTituloAssociations(baixa, response, baixatitulo.getId(), TypeEnum.HIGH,
				AcaoTypeEnum.INSERT, TabelaEnum.CONTASPAGAR, getFinanceiroBAR(), statusBAR, historicoBAR,
				baixatitulo.getEmprId(), baixatitulo.getUserId(), historicoId, historicoId);
	 ...
	 *
	 * @see
	 * com.qat.samples.sysmgmt.base.bar.IBaixaTituloBAR#updateBaixaTitulo(com.
	 * qat.samples.sysmgmt.base.model.BaixaTitulo)
	 */
	@Override
	 ...
	 *
	 * @see
	 * com.qat.samples.sysmgmt.base.bar.IBaixaTituloBAR#deleteBaixaTitulo(com.
	 * qat.samples.sysmgmt.base.model.BaixaTitulo)
	 */
	@Override
	 ...
	 *
	 * @see
	 * com.qat.samples.sysmgmt.base.bar.IBaixaTituloBAR#deleteAllBaixaTitulos()
	 */
	@Override
	 ...
	 *
	 * @see
	 * com.qat.samples.sysmgmt.bar.IBaixaTituloBAR#fetchBaixaTituloById(com.qat.
	 * samples.sysmgmt.model.request.FetchByIdRequest)
	 */
	@Override
	public BaixaTitulo fetchBaixaTituloById(FetchByIdRequest request) {
		return (BaixaTitulo) MyBatisBARHelper.doQueryForObject(getSqlSession(), STMT_FETCH_BAIXATITULO,
				request.getFetchId());
	 ...
	 * (non-Javadoc)
	 *
	 * @see com.qat.samples.sysmgmt.base.bar.IBaixaTituloBAR#
	 * fetchAllBaixaTitulosCache()
	 */
	@Override
	 ...
	 *
	 * @see
	 * com.qat.samples.sysmgmt.bar.IBaixaTituloBAR#fetchBaixaTitulosByRequest(
	 * com.qat.samples.sysmgmt.model.request. PagedInquiryRequest)
	 */
	@Override
	public InternalResultsResponse<BaixaTitulo> fetchBaixaTitulosByRequest(PagedInquiryRequest request) {
		InternalResultsResponse<BaixaTitulo> response = new InternalResultsResponse<BaixaTitulo>();
		fetchBaixaTitulosByRequest(getSqlSession(), request, STMT_FETCH_BAIXATITULO_COUNT,
				STMT_FETCH_BAIXATITULO_ALL_REQUEST, response);
		return response;
	}
	...
	public static void fetchBaixaTitulosByRequest(SqlSession sqlSession, PagedInquiryRequest request,
			String countStatement, String fetchPagedStatement, InternalResultsResponse<?> response) {
	 ...
	 *
	 * @see
	 * com.qat.samples.sysmgmt.base.bar.ITipoBaixaBAR#updateTipoBaixa(com.qat.
	 * samples.sysmgmt.base.model.TipoBaixa)
	 */
	@Override
	 ...
	 *
	 * @see
	 * com.qat.samples.sysmgmt.base.bar.ITipoBaixaBAR#deleteTipoBaixa(com.qat.
	 * samples.sysmgmt.base.model.TipoBaixa)
	 */
	@Override
	 ...
	 *
	 * @see
	 * com.qat.samples.sysmgmt.bar.ITipoBaixaBAR#fetchTipoBaixaById(com.qat.
	 * samples.sysmgmt.model.request.FetchByIdRequest)
	 */
	@Override
	public TipoBaixa fetchTipoBaixaById(FetchByIdRequest request) {
		return (TipoBaixa) MyBatisBARHelper.doQueryForObject(getSqlSession(), STMT_FETCH_TIPOBAIXA,
				request.getFetchId());
	 ...
	 *
	 * @see
	 * com.qat.samples.sysmgmt.base.bar.ITipoBaixaBAR#fetchAllTipoBaixasCache()
	 */
	@Override
	 ...
	 *
	 * @see
	 * com.qat.samples.sysmgmt.bar.ITipoBaixaBAR#fetchTipoBaixasByRequest(com.
	...
	public static void fetchTipoBaixasByRequest(SqlSession sqlSession, PagedInquiryRequest request,
			String countStatement, String fetchPagedStatement, InternalResultsResponse<?> response) {
	...
	public InternalResponse insertContasReceber(ContasReceber contasreceber) {
		...
		if (!ValidationUtil.isNullOrEmpty(contasreceber.getListBaixa())) {
			...
			BaixaTituloBARD.maintainBaixaTituloAssociations(contasreceber.getListBaixa(), response,
					contasreceber.getId(), TypeEnum.HIGH, AcaoTypeEnum.INSERT, TabelaEnum.CONTASRECEBER,
					getFinanceiroBAR(), statusBAR, historicoBAR, contasreceber.getEmprId(), contasreceber.getUserId(),
	 ...
	 *
	 * @see
	 * com.qat.samples.sysmgmt.base.bar.IContasReceberBAR#updateContasReceber(
	 * com.qat.samples.sysmgmt.base.model.ContasReceber)
	 */
	@Override
	 ...
	 *
	 * @see
	 * com.qat.samples.sysmgmt.base.bar.IContasReceberBAR#deleteContasReceber(
	 * com.qat.samples.sysmgmt.base.model.ContasReceber)
	 */
	@Override
	 ...
	 * (non-Javadoc)
	 *
	 * @see com.qat.samples.sysmgmt.base.bar.IContasReceberBAR#
	 * deleteAllContasRecebers()
	 */
	@Override
	 ...
	 *
	 * @see
	 * com.qat.samples.sysmgmt.bar.IContasReceberBAR#fetchContasReceberById(com.
	 * qat.samples.sysmgmt.model.request.FetchByIdRequest)
	 */
	@Override
	public ContasReceber fetchContasReceberById(FetchByIdRequest request) {
		return (ContasReceber) MyBatisBARHelper.doQueryForObject(getSqlSession(), STMT_FETCH_CONTASRECEBER,
				request.getFetchId());
	...
	public InternalResultsResponse<ContasReceber> fetchAllContasRecebers(ContasReceber contasreceber) {
		...
		response.getResultsList()
				.addAll(MyBatisBARHelper.doQueryForList(getSqlSession(), STMT_FETCH_CONTASRECEBER_ALL));
		return response;
	}
	 ...
	 * (non-Javadoc)
	 *
	 * @see com.qat.samples.sysmgmt.bar.IContasReceberBAR#
	 * fetchContasRecebersByRequest(com.qat.samples.sysmgmt.model.request.
	 * PagedInquiryRequest)
	 */
	@Override
	public InternalResultsResponse<ContasReceber> fetchContasRecebersByRequest(ContasReceberInquiryRequest request) {
		InternalResultsResponse<ContasReceber> response = new InternalResultsResponse<ContasReceber>();
		fetchContasRecebersByRequest(getSqlSession(), request, STMT_FETCH_CONTASRECEBER_COUNT,
				STMT_FETCH_CONTASRECEBER_ALL_REQUEST, response);
		return response;
	}
	...
	public static void fetchContasRecebersByRequest(SqlSession sqlSession, ContasReceberInquiryRequest request,
			String countStatement, String fetchPagedStatement, InternalResultsResponse<?> response) {
	 ...
	 * (non-Javadoc)
	 *
	 * @see com.qat.samples.sysmgmt.base.bar.ICondPagBAR#updateCondPag(com.qat.
	 * samples.sysmgmt.base.model.CondPag)
	 */
	@Override
	 ...
	 * (non-Javadoc)
	 *
	 * @see com.qat.samples.sysmgmt.base.bar.ICondPagBAR#deleteCondPag(com.qat.
	 * samples.sysmgmt.base.model.CondPag)
	 */
	@Override
	 ...
	 *
	 * @see
	 * com.qat.samples.sysmgmt.bar.ICondPagBAR#fetchCondPagById(com.qat.samples.
	 * sysmgmt.model.request.FetchByIdRequest)
	 */
	@Override
	 ...
	 *
	 * @see
	 * com.qat.samples.sysmgmt.bar.ICondPagBAR#fetchCondPagsByRequest(com.qat.
	 * samples.sysmgmt.model.request. PagedInquiryRequest)
	 */
	@Override
	...
	public static void fetchCondPagsByRequest(SqlSession sqlSession, CondPagInquiryRequest request,
			String countStatement, String fetchPagedStatement, InternalResultsResponse<?> response) {
	 ...
	 * (non-Javadoc)
	 *
	 * @see com.qat.samples.sysmgmt.base.bar.IFormaPgBAR#updateFormaPg(com.qat.
	 * samples.sysmgmt.base.model.FormaPg)
	 */
	@Override
	 ...
	 * (non-Javadoc)
	 *
	 * @see com.qat.samples.sysmgmt.base.bar.IFormaPgBAR#deleteFormaPg(com.qat.
	 * samples.sysmgmt.base.model.FormaPg)
	 */
	@Override
	 ...
	 *
	 * @see
	 * com.qat.samples.sysmgmt.bar.IFormaPgBAR#fetchFormaPgById(com.qat.samples.
	 * sysmgmt.model.request.FetchByIdRequest)
	 */
	@Override
	 ...
	 *
	 * @see
	 * com.qat.samples.sysmgmt.bar.IFormaPgBAR#fetchFormaPgsByRequest(com.qat.
	 * samples.sysmgmt.model.request. PagedInquiryRequest)
	 */
	@Override
	...
	public static void fetchFormaPgsByRequest(SqlSession sqlSession, FormaPgInquiryRequest request,
			String countStatement, String fetchPagedStatement, InternalResultsResponse<?> response) {
	 ...
	 *
	 * @see
	 * com.qat.samples.sysmgmt.base.bar.IBancoBAR#updateBanco(com.qat.samples.
	 * sysmgmt.base.model.Banco)
	 */
	@Override
	 ...
	 *
	 * @see
	 * com.qat.samples.sysmgmt.base.bar.IBancoBAR#deleteBanco(com.qat.samples.
	 * sysmgmt.base.model.Banco)
	 */
	@Override
	 ...
	 *
	 * @see
	 * com.qat.samples.sysmgmt.bar.IBancoBAR#fetchBancoById(com.qat.samples.
	 * sysmgmt.model.request.FetchByIdRequest)
	 */
	@Override
	 ...
	 * (non-Javadoc)
	 *
	 * @see com.qat.samples.sysmgmt.bar.IBancoBAR#fetchBancosByRequest(com.qat.
	 * samples.sysmgmt.model.request. PagedInquiryRequest)
	 */
	@Override
	public InternalResultsResponse<Banco> fetchBancosByRequest(BancoInquiryRequest request) {
		InternalResultsResponse<Banco> response = new InternalResultsResponse<Banco>();
		fetchBancosByRequest(getSqlSession(), request, STMT_FETCH_BANCO_COUNT, STMT_FETCH_BANCO_ALL_REQUEST, response);
		return response;
	}
	 ...
	 *
	 * @see
	 * com.qat.samples.sysmgmt.base.bar.IContaCorrenteBAR#updateContaCorrente(
	 * com.qat.samples.sysmgmt.base.model.ContaCorrente)
	 */
	@Override
	 ...
	 *
	 * @see
	 * com.qat.samples.sysmgmt.base.bar.IContaCorrenteBAR#deleteContaCorrente(
	 * com.qat.samples.sysmgmt.base.model.ContaCorrente)
	 */
	@Override
	 ...
	 * (non-Javadoc)
	 *
	 * @see com.qat.samples.sysmgmt.base.bar.IContaCorrenteBAR#
	 * deleteAllContaCorrentes()
	 */
	@Override
	 ...
	 *
	 * @see
	 * com.qat.samples.sysmgmt.bar.IContaCorrenteBAR#fetchContaCorrenteById(com.
	 * qat.samples.sysmgmt.model.request.FetchByIdRequest)
	 */
	@Override
	public ContaCorrente fetchContaCorrenteById(FetchByIdRequest request) {
		return (ContaCorrente) MyBatisBARHelper.doQueryForObject(getSqlSession(), STMT_FETCH_CONTACORRENTE,
				request.getFetchId());
	...
	public InternalResultsResponse<ContaCorrente> fetchAllContaCorrentes(ContaCorrente contacorrente) {
		...
		response.getResultsList()
				.addAll(MyBatisBARHelper.doQueryForList(getSqlSession(), STMT_FETCH_CONTACORRENTE_ALL));
		return response;
	}
	 ...
	 * (non-Javadoc)
	 *
	 * @see com.qat.samples.sysmgmt.bar.IContaCorrenteBAR#
	 * fetchContaCorrentesByRequest(com.qat.samples.sysmgmt.model.request.
	 * PagedInquiryRequest)
	 */
	@Override
	public InternalResultsResponse<ContaCorrente> fetchContaCorrentesByRequest(ContaCorrenteInquiryRequest request) {
		InternalResultsResponse<ContaCorrente> response = new InternalResultsResponse<ContaCorrente>();
		fetchContaCorrentesByRequest(getSqlSession(), request, STMT_FETCH_CONTACORRENTE_COUNT,
				STMT_FETCH_CONTACORRENTE_ALL_REQUEST, response);
		return response;
	}
	...
	public static void fetchContaCorrentesByRequest(SqlSession sqlSession, ContaCorrenteInquiryRequest request,
			String countStatement, String fetchPagedStatement, InternalResultsResponse<?> response) {
	 ...
	 *
	 * @see
	 * com.qat.samples.sysmgmt.base.bar.IContaBAR#updateConta(com.qat.samples.
	 * sysmgmt.base.model.Conta)
	 */
	@Override
	 ...
	 *
	 * @see
	 * com.qat.samples.sysmgmt.base.bar.IContaBAR#deleteConta(com.qat.samples.
	 * sysmgmt.base.model.Conta)
	 */
	@Override
	 ...
	 *
	 * @see
	 * com.qat.samples.sysmgmt.bar.IContaBAR#fetchContaById(com.qat.samples.
	 * sysmgmt.model.request.FetchByIdRequest)
	 */
	@Override
	 ...
	 * (non-Javadoc)
	 *
	 * @see com.qat.samples.sysmgmt.bar.IContaBAR#fetchContasByRequest(com.qat.
	 * samples.sysmgmt.model.request. PagedInquiryRequest)
	 */
	@Override
	public InternalResultsResponse<Conta> fetchContasByRequest(ContaInquiryRequest request) {
		InternalResultsResponse<Conta> response = new InternalResultsResponse<Conta>();
		fetchContasByRequest(getSqlSession(), request, STMT_FETCH_CONTA_COUNT, STMT_FETCH_CONTA_ALL_REQUEST, response);
		return response;
	}
	 ...
	 *
	 * @see
	 * com.qat.samples.sysmgmt.base.bar.ICaixaBAR#updateCaixa(com.qat.samples.
	 * sysmgmt.base.model.Caixa)
	 */
	@Override
	 ...
	 *
	 * @see
	 * com.qat.samples.sysmgmt.base.bar.ICaixaBAR#deleteCaixa(com.qat.samples.
	 * sysmgmt.base.model.Caixa)
	 */
	@Override
	 ...
	 *
	 * @see
	 * com.qat.samples.sysmgmt.bar.ICaixaBAR#fetchCaixaById(com.qat.samples.
	 * sysmgmt.model.request.FetchByIdRequest)
	 */
	@Override
	 ...
	 * (non-Javadoc)
	 *
	 * @see com.qat.samples.sysmgmt.bar.ICaixaBAR#fetchCaixasByRequest(com.qat.
	 * samples.sysmgmt.model.request. PagedInquiryRequest)
	 */
	@Override
	public InternalResultsResponse<Caixa> fetchCaixasByRequest(CaixaInquiryRequest request) {
		InternalResultsResponse<Caixa> response = new InternalResultsResponse<Caixa>();
		fetchCaixasByRequest(getSqlSession(), request, STMT_FETCH_CAIXA_COUNT, STMT_FETCH_CAIXA_ALL_REQUEST, response);
		return response;
	}
	 ...
	 * (non-Javadoc)
	 *
	 * @see com.qat.samples.sysmgmt.base.bar.IAgenciaBAR#updateAgencia(com.qat.
	 * samples.sysmgmt.base.model.Agencia)
	 */
	@Override
	 ...
	 * (non-Javadoc)
	 *
	 * @see com.qat.samples.sysmgmt.base.bar.IAgenciaBAR#deleteAgencia(com.qat.
	 * samples.sysmgmt.base.model.Agencia)
	 */
	@Override
	 ...
	 *
	 * @see
	 * com.qat.samples.sysmgmt.bar.IAgenciaBAR#fetchAgenciaById(com.qat.samples.
	 * sysmgmt.model.request.FetchByIdRequest)
	 */
	@Override
	 ...
	 *
	 * @see
	 * com.qat.samples.sysmgmt.bar.IAgenciaBAR#fetchAgenciasByRequest(com.qat.
	 * samples.sysmgmt.model.request. PagedInquiryRequest)
	 */
	@Override
	...
	public static void fetchAgenciasByRequest(SqlSession sqlSession, AgenciaInquiryRequest request,
			String countStatement, String fetchPagedStatement, InternalResultsResponse<?> response) {
	...
	public boolean insertPessoa(Agencia pessoa, InternalResponse response, TabelaEnum tabela, Integer historicoId) {
		...
		if (!ValidationUtil.isNullOrEmpty(pessoa.getEnderecos())) {
			count += EnderecoBARD.maintainEnderecoAssociations(pessoa.getEnderecos(), response, pessoa.getId(), null,
					null, tabela, enderecoBAR, statusBAR, historicoBAR, pessoa.getId(), pessoa.getCreateUser(),
					historicoId, historicoId);
		}

		if (!ValidationUtil.isNullOrEmpty(pessoa.getEmails())) {
			count += EmailBARD.maintainEmailAssociations(pessoa.getEmails(), response, pessoa.getId(), null, null,
					tabela, emailBAR, statusBAR, historicoBAR, pessoa.getId(), pessoa.getCreateUser(), historicoId,
					historicoId);
		}
		if (!ValidationUtil.isNullOrEmpty(pessoa.getTelefones())) {
			count += TelefoneBARD.maintainTelefoneAssociations(pessoa.getTelefones(), response, pessoa.getId(), null,
					null, tabela, telefoneBAR, statusBAR, historicoBAR, pessoa.getId(), pessoa.getCreateUser(),
					historicoId, historicoId);
		}
		...
		if (count > 0) {
			...
			count1 = StatusBARD.maintainStatusAssociations(statusList, response, pessoa.getId(), null, AcaoEnum.INSERT,
					pessoa.getCreateUser(), pessoa.getId(), tabela, statusBAR, historicoBAR, historicoId, historicoId);
