...
public final class NFNotaInfoItemProdutoDeclaracaoImportacaoAdicaoBARD extends SqlSessionDaoSupport
{
	...
	public static Integer maintainNFNotaInfoItemProdutoDeclaracaoImportacaoAdicaoAssociations(NFNotaInfoItemProdutoDeclaracaoImportacaoAdicao nfnotainfoitemprodutodeclaracaoimportacaoadicao,
			...
			String UserId, Integer processId, Integer historicoId)
	{
		...
		if (ValidationUtil.isNull(nfnotainfoitemprodutodeclaracaoimportacaoadicao))
		{
			return 0;
		}
		// For Each Contact...
		...
		//	}
			switch (nfnotainfoitemprodutodeclaracaoimportacaoadicao.getModelAction())
			{
					...
					if (count == true)
					{
						...
						count =
								StatusBARD.maintainStatusAssociations(statusList, response, parentId, null,
										AcaoEnum.INSERT, UserId, empId, TabelaEnum.NFNOTAINFOITEMPRODUTODECLARACAOIMPORTACAOADICAO, statusDAC, historicoDAC,
				...
				case UPDATE:
					...
					{
						count =
								StatusBARD.maintainStatusAssociations(nfnotainfoitemprodutodeclaracaoimportacaoadicao.getStatusList(), response, nfnotainfoitemprodutodeclaracaoimportacaoadicao.getId(),
										null,
										AcaoEnum.UPDATE, UserId, empId, TabelaEnum.NFNOTAINFOITEMPRODUTODECLARACAOIMPORTACAOADICAO, statusDAC, historicoDAC,
										processId, historicoId);
					}
					break;
				case DELETE:
					...
					statusList.add(status);
					count =
							StatusBARD.maintainStatusAssociations(statusList, response, nfnotainfoitemprodutodeclaracaoimportacaoadicao.getId(), null,
									AcaoEnum.DELETE, UserId, empId, TabelaEnum.NFNOTAINFOITEMPRODUTODECLARACAOIMPORTACAOADICAO, statusDAC, historicoDAC,
									processId, historicoId);
