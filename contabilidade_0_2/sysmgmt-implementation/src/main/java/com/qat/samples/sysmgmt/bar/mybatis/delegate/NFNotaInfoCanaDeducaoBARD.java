 ...
 */
public final class NFNotaInfoCanaDeducaoBARD extends SqlSessionDaoSupport
{
	...
	public static Integer maintainNFNotaInfoCanaDeducaoAssociations(List<NFNotaInfoCanaDeducao> nfpessoaautorizadadownloadnfeList,
			...
			String UserId, Integer processId, Integer historicoId)
	{
		...
		for (NFNotaInfoCanaDeducao nfpessoaautorizadadownloadnfe : nfpessoaautorizadadownloadnfeList)
		{
		...
		//	}
			...
			{
				case INSERT:
					count = nfpessoaautorizadadownloadnfeDAC.insertNFNotaInfoCanaDeducao(nfpessoaautorizadadownloadnfe).hasSystemError();
					if (count == true)
					{
					...
					break;
				case UPDATE:
					count = nfpessoaautorizadadownloadnfeDAC.updateNFNotaInfoCanaDeducao(nfpessoaautorizadadownloadnfe).hasSystemError();
					if (count == true)
					{
						count =
					...
					break;
				case DELETE:
					count = nfpessoaautorizadadownloadnfeDAC.deleteNFNotaInfoCanaDeducaoById(nfpessoaautorizadadownloadnfe).hasSystemError();
					Status status = new Status();
