		...
		//	}
			switch (nfnotainfoitemimpostoicms.getModelAction())
			{
					...
					if (count == true)
					{
						...
						count =
								StatusBARD.maintainStatusAssociations(statusList, response, parentId, null,
										AcaoEnum.INSERT, UserId, empId, TabelaEnum.NFNOTAINFOITEMIMPOSTOICMS, statusDAC, historicoDAC,
				...
				case UPDATE:
					...
					{
						count =
								StatusBARD.maintainStatusAssociations(nfnotainfoitemimpostoicms.getStatusList(), response, nfnotainfoitemimpostoicms.getId(),
										null,
										AcaoEnum.UPDATE, UserId, empId, TabelaEnum.NFNOTAINFOITEMIMPOSTOICMS, statusDAC, historicoDAC,
										processId, historicoId);
					}
					break;
				case DELETE:
					...
					statusList.add(status);
					count =
							StatusBARD.maintainStatusAssociations(statusList, response, nfnotainfoitemimpostoicms.getId(), null,
									AcaoEnum.DELETE, UserId, empId, TabelaEnum.NFNOTAINFOITEMIMPOSTOICMS, statusDAC, historicoDAC,
									processId, historicoId);
