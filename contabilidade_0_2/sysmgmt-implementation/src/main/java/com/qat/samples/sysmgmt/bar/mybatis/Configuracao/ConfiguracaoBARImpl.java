...
private static final String STMT_DELETE_CONFIGURACAO = NAMESPACE_CONFIGURACAO + "deleteConfiguracaoById";
	...
	private static final String STMT_FETCH_CONFIGURACAO_ALL_REQUEST = NAMESPACE_CONFIGURACAO + "fetchAllConfiguracaosRequest";
...
private static final String STMT_DELETE_CONFIGCARNE = NAMESPACE_CONFIGCARNE + "deleteConfigcarneById";
	...
	private static final String STMT_FETCH_CONFIGCARNE_ALL_REQUEST = NAMESPACE_CONFIGCARNE + "fetchAllConfigcarnesRequest";
...
private static final String STMT_DELETE_CONFIGENTRADA = NAMESPACE_CONFIGENTRADA + "deleteConfigentradaById";
	...
	private static final String STMT_FETCH_CONFIGENTRADA_ALL_REQUEST = NAMESPACE_CONFIGENTRADA + "fetchAllConfigentradasRequest";
...
private static final String STMT_DELETE_CONFIGFISCAL = NAMESPACE_CONFIGFISCAL + "deleteConfigfiscalById";
	...
	private static final String STMT_FETCH_CONFIGFISCAL_ALL_REQUEST = NAMESPACE_CONFIGFISCAL + "fetchAllConfigfiscalsRequest";
...
private static final String STMT_DELETE_CONFIGALERTAS = NAMESPACE_CONFIGALERTAS + "deleteConfigalertasById";
	...
	private static final String STMT_FETCH_CONFIGALERTAS_ALL_REQUEST = NAMESPACE_CONFIGALERTAS + "fetchAllConfigalertassRequest";
...
private static final String STMT_DELETE_CONFIGGERAL = NAMESPACE_CONFIGGERAL + "deleteConfiggeralById";
	...
	private static final String STMT_FETCH_CONFIGGERAL_ALL_REQUEST = NAMESPACE_CONFIGGERAL + "fetchAllConfiggeralsRequest";
...
private static final String STMT_DELETE_CONFIGPRODUTO = NAMESPACE_CONFIGPRODUTO + "deleteConfigprodutoById";
	...
	private static final String STMT_FETCH_CONFIGPRODUTO_ALL_REQUEST = NAMESPACE_CONFIGPRODUTO + "fetchAllConfigprodutosRequest";
...
private static final String STMT_DELETE_CONFIGURACAONFE = NAMESPACE_CONFIGURACAONFE + "deleteConfiguracaonfeById";
	...
	private static final String STMT_DELETE_CONFIGURACAONFE_ALL = NAMESPACE_CONFIGURACAONFE + "deleteAllConfiguracaonfes";
	...
	private static final String STMT_FETCH_CONFIGURACAONFE_COUNT = NAMESPACE_CONFIGURACAONFE + "fetchConfiguracaonfeRowCount";

	/** The Constant STMT_FETCH_CONFIGURACAONFE_ALL_REQUEST. */
	private static final String STMT_FETCH_CONFIGURACAONFE_ALL_REQUEST = NAMESPACE_CONFIGURACAONFE + "fetchAllConfiguracaonfesRequest";
...
private static final String STMT_DELETE_CONFIGVENDAS = NAMESPACE_CONFIGVENDAS + "deleteConfigvendasById";
	...
	private static final String STMT_FETCH_CONFIGVENDAS_ALL_REQUEST = NAMESPACE_CONFIGVENDAS + "fetchAllConfigvendassRequest";
...
/*
 * (non-Javadoc)
 * @see com.qat.samples.sysmgmt.base.bar.IConfiguracaoBAR#updateConfiguracao(com.qat.samples.sysmgmt.base.model.Configuracao)
 */
@Override
...
/*
 * (non-Javadoc)
 * @see com.qat.samples.sysmgmt.base.bar.IConfiguracaoBAR#deleteConfiguracao(com.qat.samples.sysmgmt.base.model.Configuracao)
 */
@Override
...
/*
 * (non-Javadoc)
 * @see com.qat.samples.sysmgmt.base.bar.IConfiguracaoBAR#deleteAllConfiguracaos()
 */
@Override
 ...
 * (non-Javadoc)
 * @see
 * com.qat.samples.sysmgmt.bar.IConfiguracaoBAR#fetchConfiguracaoById(com.qat.samples.sysmgmt.model.request.FetchByIdRequest)
 */
@Override
public Configuracao fetchConfiguracaoById(FetchByIdRequest request)
{
return (Configuracao)MyBatisBARHelper.doQueryForObject(getSqlSession(), STMT_FETCH_CONFIGURACAO, request.getFetchId());
	
}

/*
 * (non-Javadoc)
 * @see com.qat.samples.sysmgmt.base.bar.IConfiguracaoBAR#fetchAllConfiguracaosCache()
 */
@Override
...
/*
 * (non-Javadoc)
 * @see com.qat.samples.sysmgmt.bar.IConfiguracaoBAR#fetchConfiguracaosByRequest(com.qat.samples.sysmgmt.model.request.
 * PagedInquiryRequest)
 */
@Override
...
{
	InternalResultsResponse<Configuracao> response = new InternalResultsResponse<Configuracao>();
	fetchConfiguracaosByRequest(getSqlSession(), request, STMT_FETCH_CONFIGURACAO_COUNT, STMT_FETCH_CONFIGURACAO_ALL_REQUEST,
			response);
	return response;
}
...
public static void fetchConfiguracaosByRequest(SqlSession sqlSession, ConfiguracaoInquiryRequest request, String countStatement,
...
/*
 * (non-Javadoc)
 * @see com.qat.samples.sysmgmt.base.bar.IBoletoBAR#updateBoleto(com.qat.samples.sysmgmt.base.model.Boleto)
 */
@Override
...
/*
 * (non-Javadoc)
 * @see com.qat.samples.sysmgmt.base.bar.IBoletoBAR#deleteBoleto(com.qat.samples.sysmgmt.base.model.Boleto)
 */
@Override
 ...
 * (non-Javadoc)
 * @see
 * com.qat.samples.sysmgmt.bar.IBoletoBAR#fetchBoletoById(com.qat.samples.sysmgmt.model.request.FetchByIdRequest)
 */
@Override
...
/*
 * (non-Javadoc)
 * @see com.qat.samples.sysmgmt.bar.IBoletoBAR#fetchBoletosByRequest(com.qat.samples.sysmgmt.model.request.
 * PagedInquiryRequest)
 */
@Override
...
public static void fetchBoletosByRequest(SqlSession sqlSession, BoletoInquiryRequest request, String countStatement,
			String fetchPagedStatement,
			InternalResultsResponse<?> response)
	{
...
/*
 * (non-Javadoc)
 * @see com.qat.samples.sysmgmt.base.bar.IConfigCarneBAR#updateConfigCarne(com.qat.samples.sysmgmt.base.model.ConfigCarne)
 */
@Override
...
/*
 * (non-Javadoc)
 * @see com.qat.samples.sysmgmt.base.bar.IConfigCarneBAR#deleteConfigCarne(com.qat.samples.sysmgmt.base.model.ConfigCarne)
 */
@Override
...
/*
 * (non-Javadoc)
 * @see com.qat.samples.sysmgmt.base.bar.IConfigCarneBAR#deleteAllConfigCarnes()
 */
@Override
 ...
 * (non-Javadoc)
 * @see
 * com.qat.samples.sysmgmt.bar.IConfigCarneBAR#fetchConfigCarneById(com.qat.samples.sysmgmt.model.request.FetchByIdRequest)
 */
@Override
public ConfigCarne fetchConfigCarneById(FetchByIdRequest request)
{
return (ConfigCarne)MyBatisBARHelper.doQueryForObject(getSqlSession(), STMT_FETCH_CONFIGCARNE, request.getFetchId());
	
}

/*
 * (non-Javadoc)
 * @see com.qat.samples.sysmgmt.base.bar.IConfigCarneBAR#fetchAllConfigCarnesCache()
 */
@Override
...
/*
 * (non-Javadoc)
 * @see com.qat.samples.sysmgmt.bar.IConfigCarneBAR#fetchConfigCarnesByRequest(com.qat.samples.sysmgmt.model.request.
 * PagedInquiryRequest)
 */
@Override
...
{
	InternalResultsResponse<ConfigCarne> response = new InternalResultsResponse<ConfigCarne>();
	fetchConfigCarnesByRequest(getSqlSession(), request, STMT_FETCH_CONFIGCARNE_COUNT, STMT_FETCH_CONFIGCARNE_ALL_REQUEST,
			response);
	return response;
}
...
public static void fetchConfigCarnesByRequest(SqlSession sqlSession, ConfigCarneInquiryRequest request, String countStatement,
			String fetchPagedStatement,
			InternalResultsResponse<?> response)
	{
...
/*
 * (non-Javadoc)
 * @see com.qat.samples.sysmgmt.base.bar.IConfigEntradaBAR#updateConfigEntrada(com.qat.samples.sysmgmt.base.model.ConfigEntrada)
 */
@Override
...
/*
 * (non-Javadoc)
 * @see com.qat.samples.sysmgmt.base.bar.IConfigEntradaBAR#deleteConfigEntrada(com.qat.samples.sysmgmt.base.model.ConfigEntrada)
 */
@Override
...
/*
 * (non-Javadoc)
 * @see com.qat.samples.sysmgmt.base.bar.IConfigEntradaBAR#deleteAllConfigEntradas()
 */
@Override
 ...
 * (non-Javadoc)
 * @see
 * com.qat.samples.sysmgmt.bar.IConfigEntradaBAR#fetchConfigEntradaById(com.qat.samples.sysmgmt.model.request.FetchByIdRequest)
 */
@Override
public ConfigEntrada fetchConfigEntradaById(FetchByIdRequest request)
{
return (ConfigEntrada)MyBatisBARHelper.doQueryForObject(getSqlSession(), STMT_FETCH_CONFIGENTRADA, request.getFetchId());
	
}

/*
 * (non-Javadoc)
 * @see com.qat.samples.sysmgmt.base.bar.IConfigEntradaBAR#fetchAllConfigEntradasCache()
 */
@Override
public InternalResultsResponse<ConfigEntrada> fetchAllConfigEntradas(ConfigEntrada configentrada)
{
	...
	response.getResultsList().addAll(MyBatisBARHelper.doQueryForList(getSqlSession(), STMT_FETCH_CONFIGENTRADA_ALL));
	return response;
}

/*
 * (non-Javadoc)
 * @see com.qat.samples.sysmgmt.bar.IConfigEntradaBAR#fetchConfigEntradasByRequest(com.qat.samples.sysmgmt.model.request.
 * PagedInquiryRequest)
 */
@Override
...
{
	InternalResultsResponse<ConfigEntrada> response = new InternalResultsResponse<ConfigEntrada>();
	fetchConfigEntradasByRequest(getSqlSession(), request, STMT_FETCH_CONFIGENTRADA_COUNT, STMT_FETCH_CONFIGENTRADA_ALL_REQUEST,
			response);
	return response;
}
...
public static void fetchConfigEntradasByRequest(SqlSession sqlSession, ConfigEntradaInquiryRequest request, String countStatement,
			String fetchPagedStatement,
			InternalResultsResponse<?> response)
	{
...
/*
 * (non-Javadoc)
 * @see com.qat.samples.sysmgmt.base.bar.IConfigFiscalBAR#updateConfigFiscal(com.qat.samples.sysmgmt.base.model.ConfigFiscal)
 */
@Override
...
/*
 * (non-Javadoc)
 * @see com.qat.samples.sysmgmt.base.bar.IConfigFiscalBAR#deleteConfigFiscal(com.qat.samples.sysmgmt.base.model.ConfigFiscal)
 */
@Override
...
/*
 * (non-Javadoc)
 * @see com.qat.samples.sysmgmt.base.bar.IConfigFiscalBAR#deleteAllConfigFiscals()
 */
@Override
 ...
 * (non-Javadoc)
 * @see
 * com.qat.samples.sysmgmt.bar.IConfigFiscalBAR#fetchConfigFiscalById(com.qat.samples.sysmgmt.model.request.FetchByIdRequest)
 */
@Override
public ConfigFiscal fetchConfigFiscalById(FetchByIdRequest request)
{
return (ConfigFiscal)MyBatisBARHelper.doQueryForObject(getSqlSession(), STMT_FETCH_CONFIGFISCAL, request.getFetchId());
	
}

/*
 * (non-Javadoc)
 * @see com.qat.samples.sysmgmt.base.bar.IConfigFiscalBAR#fetchAllConfigFiscalsCache()
 */
@Override
...
/*
 * (non-Javadoc)
 * @see com.qat.samples.sysmgmt.bar.IConfigFiscalBAR#fetchConfigFiscalsByRequest(com.qat.samples.sysmgmt.model.request.
 * PagedInquiryRequest)
 */
@Override
...
{
	InternalResultsResponse<ConfigFiscal> response = new InternalResultsResponse<ConfigFiscal>();
	fetchConfigFiscalsByRequest(getSqlSession(), request, STMT_FETCH_CONFIGFISCAL_COUNT, STMT_FETCH_CONFIGFISCAL_ALL_REQUEST,
			response);
	return response;
}
...
public static void fetchConfigFiscalsByRequest(SqlSession sqlSession, ConfigFiscalInquiryRequest request, String countStatement,
			String fetchPagedStatement,
			InternalResultsResponse<?> response)
	{
...
/*
 * (non-Javadoc)
 * @see com.qat.samples.sysmgmt.base.bar.IConfigAlertasBAR#updateConfigAlertas(com.qat.samples.sysmgmt.base.model.ConfigAlertas)
 */
@Override
...
/*
 * (non-Javadoc)
 * @see com.qat.samples.sysmgmt.base.bar.IConfigAlertasBAR#deleteConfigAlertas(com.qat.samples.sysmgmt.base.model.ConfigAlertas)
 */
@Override
...
/*
 * (non-Javadoc)
 * @see com.qat.samples.sysmgmt.base.bar.IConfigAlertasBAR#deleteAllConfigAlertass()
 */
@Override
 ...
 * (non-Javadoc)
 * @see
 * com.qat.samples.sysmgmt.bar.IConfigAlertasBAR#fetchConfigAlertasById(com.qat.samples.sysmgmt.model.request.FetchByIdRequest)
 */
@Override
public ConfigAlertas fetchConfigAlertasById(FetchByIdRequest request)
{
return (ConfigAlertas)MyBatisBARHelper.doQueryForObject(getSqlSession(), STMT_FETCH_CONFIGALERTAS, request.getFetchId());
	
}

/*
 * (non-Javadoc)
 * @see com.qat.samples.sysmgmt.base.bar.IConfigAlertasBAR#fetchAllConfigAlertassCache()
 */
@Override
public InternalResultsResponse<ConfigAlertas> fetchAllConfigAlertass(ConfigAlertas configalertas)
{
	...
	response.getResultsList().addAll(MyBatisBARHelper.doQueryForList(getSqlSession(), STMT_FETCH_CONFIGALERTAS_ALL));
	return response;
}

/*
 * (non-Javadoc)
 * @see com.qat.samples.sysmgmt.bar.IConfigAlertasBAR#fetchConfigAlertassByRequest(com.qat.samples.sysmgmt.model.request.
 * PagedInquiryRequest)
 */
@Override
...
{
	InternalResultsResponse<ConfigAlertas> response = new InternalResultsResponse<ConfigAlertas>();
	fetchConfigAlertassByRequest(getSqlSession(), request, STMT_FETCH_CONFIGALERTAS_COUNT, STMT_FETCH_CONFIGALERTAS_ALL_REQUEST,
			response);
	return response;
}
...
public static void fetchConfigAlertassByRequest(SqlSession sqlSession, ConfigAlertasInquiryRequest request, String countStatement,
			String fetchPagedStatement,
			InternalResultsResponse<?> response)
	{
...
/*
 * (non-Javadoc)
 * @see com.qat.samples.sysmgmt.base.bar.IConfigGeralBAR#updateConfigGeral(com.qat.samples.sysmgmt.base.model.ConfigGeral)
 */
@Override
...
/*
 * (non-Javadoc)
 * @see com.qat.samples.sysmgmt.base.bar.IConfigGeralBAR#deleteConfigGeral(com.qat.samples.sysmgmt.base.model.ConfigGeral)
 */
@Override
...
/*
 * (non-Javadoc)
 * @see com.qat.samples.sysmgmt.base.bar.IConfigGeralBAR#deleteAllConfigGerals()
 */
@Override
 ...
 * (non-Javadoc)
 * @see
 * com.qat.samples.sysmgmt.bar.IConfigGeralBAR#fetchConfigGeralById(com.qat.samples.sysmgmt.model.request.FetchByIdRequest)
 */
@Override
public ConfigGeral fetchConfigGeralById(FetchByIdRequest request)
{
return (ConfigGeral)MyBatisBARHelper.doQueryForObject(getSqlSession(), STMT_FETCH_CONFIGGERAL, request.getFetchId());
	
}

/*
 * (non-Javadoc)
 * @see com.qat.samples.sysmgmt.base.bar.IConfigGeralBAR#fetchAllConfigGeralsCache()
 */
@Override
...
/*
 * (non-Javadoc)
 * @see com.qat.samples.sysmgmt.bar.IConfigGeralBAR#fetchConfigGeralsByRequest(com.qat.samples.sysmgmt.model.request.
 * PagedInquiryRequest)
 */
@Override
...
{
	InternalResultsResponse<ConfigGeral> response = new InternalResultsResponse<ConfigGeral>();
	fetchConfigGeralsByRequest(getSqlSession(), request, STMT_FETCH_CONFIGGERAL_COUNT, STMT_FETCH_CONFIGGERAL_ALL_REQUEST,
			response);
	return response;
}
...
public static void fetchConfigGeralsByRequest(SqlSession sqlSession, ConfigGeralInquiryRequest request, String countStatement,
			String fetchPagedStatement,
			InternalResultsResponse<?> response)
	{
...
/*
 * (non-Javadoc)
 * @see com.qat.samples.sysmgmt.base.bar.IConfigProdutoBAR#updateConfigProduto(com.qat.samples.sysmgmt.base.model.ConfigProduto)
 */
@Override
...
/*
 * (non-Javadoc)
 * @see com.qat.samples.sysmgmt.base.bar.IConfigProdutoBAR#deleteConfigProduto(com.qat.samples.sysmgmt.base.model.ConfigProduto)
 */
@Override
...
/*
 * (non-Javadoc)
 * @see com.qat.samples.sysmgmt.base.bar.IConfigProdutoBAR#deleteAllConfigProdutos()
 */
@Override
 ...
 * (non-Javadoc)
 * @see
 * com.qat.samples.sysmgmt.bar.IConfigProdutoBAR#fetchConfigProdutoById(com.qat.samples.sysmgmt.model.request.FetchByIdRequest)
 */
@Override
public ConfigProduto fetchConfigProdutoById(FetchByIdRequest request)
{
return (ConfigProduto)MyBatisBARHelper.doQueryForObject(getSqlSession(), STMT_FETCH_CONFIGPRODUTO, request.getFetchId());
	
}

/*
 * (non-Javadoc)
 * @see com.qat.samples.sysmgmt.base.bar.IConfigProdutoBAR#fetchAllConfigProdutosCache()
 */
@Override
public InternalResultsResponse<ConfigProduto> fetchAllConfigProdutos(ConfigProduto configproduto)
{
	...
	response.getResultsList().addAll(MyBatisBARHelper.doQueryForList(getSqlSession(), STMT_FETCH_CONFIGPRODUTO_ALL));
	return response;
}

/*
 * (non-Javadoc)
 * @see com.qat.samples.sysmgmt.bar.IConfigProdutoBAR#fetchConfigProdutosByRequest(com.qat.samples.sysmgmt.model.request.
 * PagedInquiryRequest)
 */
@Override
...
{
	InternalResultsResponse<ConfigProduto> response = new InternalResultsResponse<ConfigProduto>();
	fetchConfigProdutosByRequest(getSqlSession(), request, STMT_FETCH_CONFIGPRODUTO_COUNT, STMT_FETCH_CONFIGPRODUTO_ALL_REQUEST,
			response);
	return response;
}
...
public static void fetchConfigProdutosByRequest(SqlSession sqlSession, ConfigProdutoInquiryRequest request, String countStatement,
			String fetchPagedStatement,
			InternalResultsResponse<?> response)
	{
...
/*
 * (non-Javadoc)
 * @see com.qat.samples.sysmgmt.base.bar.IConfigSMTPBAR#updateConfigSMTP(com.qat.samples.sysmgmt.base.model.ConfigSMTP)
 */
@Override
...
/*
 * (non-Javadoc)
 * @see com.qat.samples.sysmgmt.base.bar.IConfigSMTPBAR#deleteConfigSMTP(com.qat.samples.sysmgmt.base.model.ConfigSMTP)
 */
@Override
...
/*
 * (non-Javadoc)
 * @see com.qat.samples.sysmgmt.base.bar.IConfigSMTPBAR#deleteAllConfigSMTPs()
 */
@Override
 ...
 * (non-Javadoc)
 * @see
 * com.qat.samples.sysmgmt.bar.IConfigSMTPBAR#fetchConfigSMTPById(com.qat.samples.sysmgmt.model.request.FetchByIdRequest)
 */
@Override
public ConfigSMTP fetchConfigSMTPById(FetchByIdRequest request)
{
return (ConfigSMTP)MyBatisBARHelper.doQueryForObject(getSqlSession(), STMT_FETCH_CONFIGSMTP, request.getFetchId());
	
}

/*
 * (non-Javadoc)
 * @see com.qat.samples.sysmgmt.base.bar.IConfigSMTPBAR#fetchAllConfigSMTPsCache()
 */
@Override
...
/*
 * (non-Javadoc)
 * @see com.qat.samples.sysmgmt.bar.IConfigSMTPBAR#fetchConfigSMTPsByRequest(com.qat.samples.sysmgmt.model.request.
 * PagedInquiryRequest)
 */
@Override
...
{
	InternalResultsResponse<ConfigSMTP> response = new InternalResultsResponse<ConfigSMTP>();
	fetchConfigSMTPsByRequest(getSqlSession(), request, STMT_FETCH_CONFIGSMTP_COUNT, STMT_FETCH_CONFIGSMTP_ALL_REQUEST,
			response);
	return response;
}
...
public static void fetchConfigSMTPsByRequest(SqlSession sqlSession, ConfigSMTPInquiryRequest request, String countStatement,
			String fetchPagedStatement,
			InternalResultsResponse<?> response)
	{
...
/*
 * (non-Javadoc)
 * @see com.qat.samples.sysmgmt.base.bar.IConfiguracaoNFeBAR#updateConfiguracaoNFe(com.qat.samples.sysmgmt.base.model.ConfiguracaoNFe)
 */
@Override
...
/*
 * (non-Javadoc)
 * @see com.qat.samples.sysmgmt.base.bar.IConfiguracaoNFeBAR#deleteConfiguracaoNFe(com.qat.samples.sysmgmt.base.model.ConfiguracaoNFe)
 */
@Override
...
/*
 * (non-Javadoc)
 * @see com.qat.samples.sysmgmt.base.bar.IConfiguracaoNFeBAR#deleteAllConfiguracaoNFes()
 */
@Override
 ...
 * (non-Javadoc)
 * @see
 * com.qat.samples.sysmgmt.bar.IConfiguracaoNFeBAR#fetchConfiguracaoNFeById(com.qat.samples.sysmgmt.model.request.FetchByIdRequest)
 */
@Override
public ConfiguracaoNFe fetchConfiguracaoNFeById(FetchByIdRequest request)
{
return (ConfiguracaoNFe)MyBatisBARHelper.doQueryForObject(getSqlSession(), STMT_FETCH_CONFIGURACAONFE, request.getFetchId());
	
}

/*
 * (non-Javadoc)
 * @see com.qat.samples.sysmgmt.base.bar.IConfiguracaoNFeBAR#fetchAllConfiguracaoNFesCache()
 */
@Override
public InternalResultsResponse<ConfiguracaoNFe> fetchAllConfiguracaoNFes(ConfiguracaoNFe configuracaonfe)
{
	...
	response.getResultsList().addAll(MyBatisBARHelper.doQueryForList(getSqlSession(), STMT_FETCH_CONFIGURACAONFE_ALL));
	return response;
}

/*
 * (non-Javadoc)
 * @see com.qat.samples.sysmgmt.bar.IConfiguracaoNFeBAR#fetchConfiguracaoNFesByRequest(com.qat.samples.sysmgmt.model.request.
 * PagedInquiryRequest)
 */
@Override
...
{
	InternalResultsResponse<ConfiguracaoNFe> response = new InternalResultsResponse<ConfiguracaoNFe>();
	fetchConfiguracaoNFesByRequest(getSqlSession(), request, STMT_FETCH_CONFIGURACAONFE_COUNT, STMT_FETCH_CONFIGURACAONFE_ALL_REQUEST,
			response);
	return response;
}
...
public static void fetchConfiguracaoNFesByRequest(SqlSession sqlSession, ConfiguracaoNFeInquiryRequest request, String countStatement,
			String fetchPagedStatement,
			InternalResultsResponse<?> response)
	{
...
/*
 * (non-Javadoc)
 * @see com.qat.samples.sysmgmt.base.bar.IConfigVendasBAR#updateConfigVendas(com.qat.samples.sysmgmt.base.model.ConfigVendas)
 */
@Override
...
/*
 * (non-Javadoc)
 * @see com.qat.samples.sysmgmt.base.bar.IConfigVendasBAR#deleteConfigVendas(com.qat.samples.sysmgmt.base.model.ConfigVendas)
 */
@Override
...
/*
 * (non-Javadoc)
 * @see com.qat.samples.sysmgmt.base.bar.IConfigVendasBAR#deleteAllConfigVendass()
 */
@Override
 ...
 * (non-Javadoc)
 * @see
 * com.qat.samples.sysmgmt.bar.IConfigVendasBAR#fetchConfigVendasById(com.qat.samples.sysmgmt.model.request.FetchByIdRequest)
 */
@Override
public ConfigVendas fetchConfigVendasById(FetchByIdRequest request)
{
return (ConfigVendas)MyBatisBARHelper.doQueryForObject(getSqlSession(), STMT_FETCH_CONFIGVENDAS, request.getFetchId());
	
}

/*
 * (non-Javadoc)
 * @see com.qat.samples.sysmgmt.base.bar.IConfigVendasBAR#fetchAllConfigVendassCache()
 */
@Override
...
/*
 * (non-Javadoc)
 * @see com.qat.samples.sysmgmt.bar.IConfigVendasBAR#fetchConfigVendassByRequest(com.qat.samples.sysmgmt.model.request.
 * PagedInquiryRequest)
 */
@Override
...
{
	InternalResultsResponse<ConfigVendas> response = new InternalResultsResponse<ConfigVendas>();
	fetchConfigVendassByRequest(getSqlSession(), request, STMT_FETCH_CONFIGVENDAS_COUNT, STMT_FETCH_CONFIGVENDAS_ALL_REQUEST,
			response);
	return response;
}
...
public static void fetchConfigVendassByRequest(SqlSession sqlSession, ConfigVendasInquiryRequest request, String countStatement,
			String fetchPagedStatement,
			InternalResultsResponse<?> response)
	{
...
public static void insertModulosConfiguracao(Configuracao configuracao){
	...
	if (!ValidationUtil.isNullOrEmpty(configuracao.getConfGeral()))
	{
		a +=
				SociosBARD.maintainSocioAssociations(configuracao.getConfGeral(), response, empresa.getId(), null, null,
	...
	{
		a +=
				SociosBARD.maintainSocioAssociations(configuracao.getConfFiscal(), response, empresa.getId(), null, null,
						TabelaEnum.EMPRESA, getSociosBAR(), getStatusBAR(), getHistoricoBAR(), empresa.getId(),
						empresa.getCreateUser(), historicoId, historicoId, getDocumentosBAR());
	...
	{
		a +=
				SociosBARD.maintainSocioAssociations(configuracao.getConfProd(), response, empresa.getId(), null, null,
						TabelaEnum.EMPRESA, getSociosBAR(), getStatusBAR(), getHistoricoBAR(), empresa.getId(),
						empresa.getCreateUser(), historicoId, historicoId, getDocumentosBAR());
	...
	{
		a +=
				SociosBARD.maintainSocioAssociations(configuracao.getConfVendas(), response, empresa.getId(), null, null,
						TabelaEnum.EMPRESA, getSociosBAR(), getStatusBAR(), getHistoricoBAR(), empresa.getId(),
						empresa.getCreateUser(), historicoId, historicoId, getDocumentosBAR());
	...
	{
		a +=
				SociosBARD.maintainSocioAssociations(empresa.getConfCMTP(), response, empresa.getId(), null, null,
						TabelaEnum.EMPRESA, getSociosBAR(), getStatusBAR(), getHistoricoBAR(), empresa.getId(),
						empresa.getCreateUser(), historicoId, historicoId, getDocumentosBAR());
	...
	{
		a +=
				SociosBARD.maintainSocioAssociations(configuracao.getConfEntrada(), response, empresa.getId(), null, null,
						TabelaEnum.EMPRESA, getSociosBAR(), getStatusBAR(), getHistoricoBAR(), empresa.getId(),
						empresa.getCreateUser(), historicoId, historicoId, getDocumentosBAR());
	...
	{
		a +=
				SociosBARD.maintainSocioAssociations(configuracao.getConfCarne(), response, empresa.getId(), null, null,
						TabelaEnum.EMPRESA, getSociosBAR(), getStatusBAR(), getHistoricoBAR(), empresa.getId(),
						empresa.getCreateUser(), historicoId, historicoId, getDocumentosBAR());
	...
	{
		a +=
				SociosBARD.maintainSocioAssociations(configuracao.getBoletoList(), response, empresa.getId(), null, null,
						TabelaEnum.EMPRESA, getSociosBAR(), getStatusBAR(), getHistoricoBAR(), empresa.getId(),
						empresa.getCreateUser(), historicoId, historicoId, getDocumentosBAR());
