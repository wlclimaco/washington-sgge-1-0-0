 ...
 */
public final class EstadoBARD extends SqlSessionDaoSupport
{
	...
	public static Integer maintainEstadoAssociations(Estado nfnotainfo,
			InternalResponse response, Integer parentId, TypeEnum type, AcaoEnum acaoType,
			TabelaEnum tabelaEnum, ICadastrosBAR nfnotainfoDAC, IStatusBAR statusDAC, IHistoricoBAR historicoDAC, Integer empId,
			String UserId, Integer processId, Integer historicoId)
	{
		...
		//	}
			...
			{
				case INSERT:
					count = nfnotainfoDAC.insertEstado(nfnotainfo).hasSystemError();
					if (count == true)
					{
					...
					break;
				case UPDATE:
					count = nfnotainfoDAC.updateEstado(nfnotainfo).hasSystemError();
					if (count == true)
					{
						count =
					...
					break;
				case DELETE:
					count = nfnotainfoDAC.deleteEstadoById(nfnotainfo).hasSystemError();
					Status status = new Status();
