...
public class SociosBARImpl extends SqlSessionDaoSupport implements ISociosBAR {
	 ...
	 *
	 * @see
	 * com.qat.samples.sysmgmt.base.bar.ISocioBAR#updateSocio(com.qat.samples.
	 * sysmgmt.base.model.Socio)
	 */
	@Override
	 ...
	 *
	 * @see
	 * com.qat.samples.sysmgmt.base.bar.ISocioBAR#deleteSocio(com.qat.samples.
	 * sysmgmt.base.model.Socio)
	 */
	@Override
	 ...
	 *
	 * @see
	 * com.qat.samples.sysmgmt.bar.ISocioBAR#fetchSocioById(com.qat.samples.
	 ...
	 * (non-Javadoc)
	 *
	 * @see com.qat.samples.sysmgmt.bar.ISocioBAR#fetchSociosByRequest(com.qat.
	...
	public InternalResultsResponse<Socio> fetchSociosByRequest(PagedInquiryRequest request) {
		InternalResultsResponse<Socio> response = new InternalResultsResponse<Socio>();
		fetchSociosByRequest(getSqlSession(), request, STMT_FETCH_SOCIO_COUNT, STMT_FETCH_SOCIO_ALL_REQUEST, response);
		return response;
	}
