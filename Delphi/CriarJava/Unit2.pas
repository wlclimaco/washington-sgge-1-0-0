...
uses
  ...
  Dialogs,  Buttons, BrvSpeedButton, ExtCtrls, StdCtrls, DB,
  DBClient, ComCtrls, BrvEditNum, BrvEditDate, BrvEdit,
  BrvComboBox, DBCtrls, BrvRadioGroup, Mask, BrvImage, ImgList,
  BrvImgBot, BrvListParam, BrvCustomEdit, Menus, BrvString, BrvDbNavCop, BrvClientDataSet;
...
procedure TForm2.CarregarFormulario(pNmTabela: String; pNrForDin: Integer);
begin
      gNmTabela := pNmTabela;
      gNrForDin := pNrForDin;
      gNoCompon := 0;
...
procedure TForm2.CarregarOrdenacaoInicial;
var lDsResult : String;
begin

end;

procedure TForm2.CarregarObjetosDinamicos;
...
procedure TForm2.AtribuirLabelsDosObjetos;
...
function TForm2.EncontrarLabelDoObjeto(pNmAtribu : String; pTpLabel : Char) : TStaticText;
var lNrCompon : Integer;
begin
      Result    := nil;
      lNrCompon := 0;
...
function TForm2.EncontraAtributoLista(pNmAtribu : String) : Integer;
...
procedure TForm2.CbxAncEsqClick(Sender: TObject);
begin
      gDsCompon[gDsComCli.Tag].SnAncEsq := CbxAncEsq.Checked;
      SbtSalvar.Enabled := True;
end;

procedure TForm2.CbxAncAbaClick(Sender: TObject);
begin
      gDsCompon[gDsComCli.Tag].SnAncAba := CbxAncAba.Checked;
      SbtSalvar.Enabled := True;
end;

procedure TForm2.CbxAncAciClick(Sender: TObject);
begin
      gDsCompon[gDsComCli.Tag].SnAncAci := CbxAncAci.Checked;
      SbtSalvar.Enabled := True;
end;

procedure TForm2.CbxAncDirClick(Sender: TObject);
begin
      gDsCompon[gDsComCli.Tag].SnAncDir := CbxAncDir.Checked;
      SbtSalvar.Enabled := True;
end;

procedure TForm2.CbxAutIncClick(Sender: TObject);
begin
...
procedure TForm2.CbxSnNuloClick(Sender: TObject);
begin
      if  ChxEnabled.Tag = 0 then
      begin
            SbtSalvar.Enabled := True;
...
procedure TForm2.CbxTpObjetoChange(Sender: TObject);
begin
...
procedure TForm2.TrocarParaComboBox;
...
procedure TForm2.TrocarParaRadioGroup;
...
procedure TForm2.TrocarParaCheckBox;
...
procedure TForm2.ColorirLabelObjeto;
var lCrCor    : TColor;
    lSnAutInc : Boolean;
    lSnNulo   : Boolean;
begin
...
procedure TForm2.CbxVisiblClick(Sender: TObject);
var lCrCor : TColor;
begin
...
procedure TForm2.ChxEnabledClick(Sender: TObject);
begin
      if  ChxEnabled.Tag = 0 then
      begin
            SbtSalvar.Enabled := True;
...
procedure TForm2.ColorirObjeto;
var lCrCor : TColor;
begin
...
procedure TForm2.CarregarAtributosDisponiveis;
var lNrColuna : Integer;
    lDsChaPri : TStrings;
begin
...
procedure TForm2.ExcluirComponente;
var lNoMarcad : Byte;
    lNoCompon : Integer;
begin
...
procedure TForm2.LiberarColunaInclusao;
...
procedure TForm2.ExcluirComponentesFilhos(pNoComPai : Integer);
...
procedure TForm2.PnlMarcadorMouseDown(Sender: TObject; Button: TMouseButton;
                                      Shift: TShiftState; X, Y: Integer);
begin
      if gDsComCli.Tag <> 0 then
      begin
...
procedure TForm2.LbxAtribuMouseDown(Sender: TObject; Button: TMouseButton;
  Shift: TShiftState; X, Y: Integer);
begin
      LbxAtribu.BeginDrag(False);
end;

procedure TForm2.EdtDsCapGriKeyUp(Sender: TObject; var Key: Word; Shift: TShiftState);
begin
      SbtSalvar.Enabled := True;
      gDsCompon[gDsComCli.Tag].DsCapGri := (Sender as TEdit).Text;
end;

procedure TForm2.EdtDsCaptioKeyUp(Sender: TObject; var Key: Word; Shift: TShiftState);
var lDsLabel  : TLabel;
    lDsTabShe : TTabSheet;
    lDsCheBox : TCheckBox;
...
procedure TForm2.EdtVlHeigthChange(Sender: TObject);
begin
...
procedure TForm2.EdtVlLeftChange(Sender: TObject);
begin
...
procedure TForm2.EdtVlTopChange(Sender: TObject);
begin
...
procedure TForm2.EdtVlWidthChange(Sender: TObject);
begin
...
procedure TForm2.EncontrarComponenteClicado(pNoTag : Integer);
begin
      if pNoTag = 0 then
      begin
            gDsComCli :=  SbxFundo;
...
procedure TForm2.SbtConsulClick(Sender: TObject);
...
procedure TForm2.SbtDefaulClick(Sender: TObject);
begin
...
procedure TForm2.SbtForDinClick(Sender: TObject);
begin
//      if SbtSalvar.Enabled then
//      begin
...
procedure TForm2.SbtOrdemClick(Sender: TObject);
var lNrLinha : Integer;
begin
...
procedure TForm2.SbtSalvarClick(Sender: TObject);
var
    lDsResult  : String;
...
procedure TForm2.CarregarDadosDataSetSalvar(pCdsSalva  : TClientDataSet;
                                              pCdsSalCon : TClientDataSet;
                                              pCdsSalRet : TClientDataSet);
var lNrCompon : Integer;
begin
...
procedure TForm2.SalvarAtributosDisplayConsulta(pCdsSalCon : TClientDataset;
                                                  pNrCompon  : Integer);
...
procedure TForm2.SalvarAtributosRestornoConsulta(pCdsSalRet : TClientDataSet;
                                                   pNrCompon  : Integer);
...
function TForm2.BooleanToStr(pVrBoolea : Boolean) : String;
begin
      if pVrBoolea then
      begin
            Result := 'S';
...
procedure TForm2.CriarTabelaSalvarConsulta(pCdsSalCon : TClientDataSet);
begin
      pCdsSalCon.Close;
...
procedure TForm2.CriarTabelaSalvarRetornoConsulta(pCdsSalRet : TClientDataSet);
begin
      pCdsSalRet.Close;
...
procedure TForm2.CriarTabelaSalvar(pCdsSalva : TClientDataSet);
begin
      pCdsSalva.Close;
...
procedure TForm2.SbtTabGriClick(Sender: TObject);
begin
      CarregarTabOrderGrid(True);
      SbtSalvar.Enabled := True;
end;

procedure TForm2.CarregarTabOrderGrid(lSnShow : Boolean);
var lNoCompon  : Integer;
    lDsLinha   : String;
    lNoTabOrd  : Integer;
    lLbxTabOrd : TListBox;
...
procedure TForm2.SbtTabOrdClick(Sender: TObject);
begin
      if (gDsComCli is TPanel) or (gDsComCli is TTabSheet) or
         (gDsComCli is TScrollBox) then
      begin
...
procedure TForm2.CarregarTabOrderComponentes;
var lNoCompon  : Integer;
    lLbxTabOrd : TListBox;
    lDsLinha   : String;
    lNoColuna  : Integer;
...
procedure TForm2.CliqueTabOrder(Sender : TObject);
begin
...
procedure TForm2.SbxFundoDragDrop(Sender, Source: TObject; X, Y: Integer);
var lNrColuna : Integer;
...
function TForm2.Ancoras(pSnAncAci : Boolean; pSnAncAba : Boolean;
...
procedure TForm2.CriarImagem(pNmColuna : String;       pDsParent : TWinControl;
                               pVlLeft   : Integer;      pVlTop    : Integer;
                               pVlWidth  : Integer;      pVlHeight : Integer;
                               pNoTabOrd : Integer;      pNoTabGri : Integer;
                               pSnEnable : Boolean;      pDsCapGri : String;
...
procedure TForm2.CriarCheckBox(pNmColuna : String;  pDsParent : TWinControl;
                                 pVlLeft   : Integer; pVlTop    : Integer;
                                 pVlWidth  : Integer; pVlHeight : Integer;
                                 pDsDomini : String;  pNoTabOrd : Integer;
                                 pNoTabGri : Integer; pSnEnable : Boolean;
...
procedure TForm2.CriarComboBox(pNmColuna : String;  pDsParent : TWinControl;
                                 pVlLeft   : Integer; pVlTop    : Integer;
                                 pVlWidth  : Integer; pVlHeight : Integer;
                                 pDsDomini : String;  pNoTabOrd : Integer;
                                 pNoTabGri : Integer; pSnEnable : Boolean;
...
procedure TForm2.CriarRadioGroup(pNmColuna : String;  pDsParent : TWinControl;
                                 pVlLeft   : Integer; pVlTop    : Integer;
                                 pVlWidth  : Integer; pVlHeight : Integer;
                                 pDsDomini : String;  pNoTabOrd : Integer;
                                 pNoTabGri : Integer; pSnEnable : Boolean;
...
procedure TForm2.CriarMemo(pNmColuna : String;       pDsParent : TWinControl;
                             pVlLeft   : Integer;      pVlTop    : Integer;
                             pVlWidth  : Integer;      pVlHeight : Integer;
                             pNoTabOrd : Integer;      pNoTabGri : Integer;
                             pSnEnable : Boolean;      pDsCapGri : String;
...
function TForm2.CriarLabel(pDsCaptio : String;  pTpCompon : Char;
                              pSnNulo   : Boolean; pSnChaPri : Boolean;
                              pNmColuna : String;  pVlLeft   : Integer;
                              pVlTop    : Integer; pVlHeight : Integer;
                              pVlWidth  : Integer; pDsParent : TWinControl;
...
procedure TForm2.CriarEdit(pNmColuna : String;       pDsParent : TWinControl;
                             pVlLeft   : Integer;      pVlTop    : Integer;
                             pVlWidth  : Integer;      pVlHeight : Integer;
                             pNoTabOrd : Integer;      pNoTabGri : Integer;
                             pSnEnable : Boolean;      pDsCapGri : String;
...
procedure TForm2.CriarEditNumerico(pNmColuna : String;       pDsParent : TWinControl;
                                     pVlLeft   : Integer;      pVlTop    : Integer;
                                     pVlWidth  : Integer;      pVlHeight : Integer;
                                     pNoTabOrd : Integer;      pNoTabGri : Integer;
                                     pSnEnable : Boolean;      pDsCapGri : String;
...
procedure TForm2.CriarEditData(pNmColuna : String;       pDsParent : TWinControl;
                                 pVlLeft   : Integer;      pVlTop    : Integer;
                                 pVlWidth  : Integer;      pVlHeight : Integer;
                                 pNoTabOrd : Integer;      pNoTabGri : Integer;
                                 pSnEnable : Boolean;      pDsCapGri : String;
...
procedure TForm2.PosicionarEdit(
                         pDsEdit   : TEdit;   pNrCompon : Integer; pDsParent : TWinControl;
                         pVlLeft   : Integer; pVlTop    : Integer; pVlWidth  : Integer;
...
procedure TForm2.ConfigurarComponente(pNrCompon : Integer;   pTpCompon : Char;
                    pNmColuna : String;      pDsCaptio : String;  pNoComPai : Integer;
                    pSnEnable : Boolean;     pSnVisibl : Boolean; pSnAutInc : Boolean;
                    pSnNulo   : Boolean;     pDsDomini : String;
                    pNoTabGri : Integer;     pNoTabOrd : Integer; pNoConsul : Integer;
...
procedure TForm2.ComponenteFrenteClick(Sender : TObject);
begin
      EncontrarComponenteClicado((Sender as TComponent).Tag);
      ContornoComponente;
...
procedure TForm2.ContornoComponente;
var lNrMarcad : Byte;
begin
      for lNrMarcad := 0 to 7 do
      begin
...
procedure TForm2.ComponenteMouseDown(Sender: TObject; Button: TMouseButton;
                                             Shift: TShiftState; X, Y: Integer);
begin
...
procedure TForm2.ArrastarComponente(pVlClickX, pVlClickY : Integer);
begin
      gVlClickX := pVlClickX;
      gVlClickY := pVlClickY;
...
procedure TForm2.ComponenteDragOver(Sender, Source: TObject; X, Y: Integer;
                                        State: TDragState; var Accept: Boolean);
begin
      LblPosX.Caption := IntToStr(x);
      LblPosY.Caption := IntToStr(y);
...
procedure TForm2.SbxFundoDragOver(Sender, Source: TObject; X, Y: Integer;
  State: TDragState; var Accept: Boolean);
begin
      LblPosX.Caption := IntToStr(x);
      LblPosY.Caption := IntToStr(y);
...
procedure TForm2.RedimencionarVulto(X, Y : Integer);
...
procedure TForm2.SbxFundoMouseMove(Sender: TObject; Shift: TShiftState; X, Y: Integer);
begin
{
...
procedure TForm2.ShpVultoDragOver(Sender, Source: TObject; X, Y: Integer;
  State: TDragState; var Accept: Boolean);
begin
  inherited;
...
procedure TForm2.ShpVultoEndDrag(Sender, Target: TObject; X, Y: Integer);
begin
  inherited;
...
procedure TForm2.ComponenteFundoClick(Sender : TObject);
begin
      EncontrarComponenteClicado((Sender as TComponent).Tag);
      ContornoComponente;
...
procedure TForm2.CriarPanel(pDsParent : TWinControl; pVlLeft  : Integer;
                              pVlTop    : Integer;     pVlWidth : Integer;
                              pVlHeight : Integer;     pNrCompon : Integer;
                              pSnAncAci : Boolean;     pSnAncAba : Boolean;
                              pSnAncEsq : Boolean;     pSnAncDir : Boolean);
...
procedure TForm2.CriarPageControl(pDsParent : TWinControl; pVlLeft   : Integer;
                                    pVlTop    : Integer;     pVlWidth  : Integer;
                                    pVlHeight : Integer;     pNrCompon : Integer;
                                    pSnAncAci : Boolean;     pSnAncAba : Boolean;
                                    pSnAncEsq : Boolean;     pSnAncDir : Boolean);
...
procedure TForm2.TabSheetOnMouseDown(Sender: TObject; Button: TMouseButton;
                                       Shift: TShiftState; X, Y: Integer);
begin
...
procedure TForm2.AdicionarPgina1Click(Sender: TObject);
begin
      inc(gNoCompon);
      CriarTabSheet(gDsComCli, 'TabSheet', gNoCompon);
end;

procedure TForm2.CriarTabSheet(pDsParent : TWinControl; pDsCaptio : String;
                                 pNrCompon : Integer);
