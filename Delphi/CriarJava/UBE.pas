...
begin
      ...
      memo1.Lines.Add('');
      memo1.Lines.Add('	/** The Constant FETCH_'+UpperCase(Txt)+'_BY_NAME. */ ');
      memo1.Lines.Add('	private static final String FETCH_'+UpperCase(Txt)+'_BY_NAME = '+UpperCase(Txt)+'_NAMESPACE + "fetch'+BrvFuncoesXE.PrimeiraMaiscula(Txt)+'ByName";');
      memo1.Lines.Add('');
      ...
      memo1.Lines.Add('		paramMap.put(ORDERBY, '+BrvFuncoesXE.PrimeiraMaiscula(Txt)+'OrderByEnum.NAME_COLUMN.getValue());');
      memo1.Lines.Add('');
      ...
      memo1.Lines.Add('		{');
      memo1.Lines.Add('			paramMap.put('+UpperCase(Txt)+'_ID, inquiry'+BrvFuncoesXE.PrimeiraMaiscula(Txt)+'Request.get'+BrvFuncoesXE.PrimeiraMaiscula(Txt)+'().getId());');
      memo1.Lines.Add('		}');
      memo1.Lines.Add('');
      ...
      memo1.Lines.Add('	/*');
      memo1.Lines.Add('	 * (non-Javadoc) ');
      memo1.Lines.Add('	 * @see com.sensus.mlc.'+LowerCase(Txt)+'.dao.I'+BrvFuncoesXE.PrimeiraMaiscula(Txt)+'DAO#fetch'+BrvFuncoesXE.PrimeiraMaiscula(Txt)+'ByName(com.sensus.mlc.'+LowerCase(Txt)+'.model.'+BrvFuncoesXE.PrimeiraMaiscula(Txt)+'');
      memo1.Lines.Add('	 */ ');
      memo1.Lines.Add('	@Override');
      memo1.Lines.Add('	public InternalResultsResponse<'+BrvFuncoesXE.PrimeiraMaiscula(Txt)+'> fetch'+BrvFuncoesXE.PrimeiraMaiscula(Txt)+'ByName('+BrvFuncoesXE.PrimeiraMaiscula(Txt)+'Request '+LowerCase(Txt)+'Request)');
      memo1.Lines.Add('	{ ');
      memo1.Lines.Add('		InternalResultsResponse<'+BrvFuncoesXE.PrimeiraMaiscula(Txt)+'> response = new InternalResultsResponse<'+BrvFuncoesXE.PrimeiraMaiscula(Txt)+'>();');
      memo1.Lines.Add('		doQueryForList(getSqlSession(), FETCH_'+UpperCase(Txt)+'_BY_NAME, '+LowerCase(Txt)+'Request, response);');
      memo1.Lines.Add('		return response;');
      memo1.Lines.Add('	}');
      memo1.Lines.Add('');
      memo1.Lines.Add('	/*');
      ...
      memo1.Lines.Add('		paramMap.put('+UpperCase(Txt)+'NAME, '+LowerCase(Txt)+'.getName());');
      memo1.Lines.Add('		paramMap.put(ADDRESS_RELATED, '+LowerCase(Txt)+'.getAddressRelated());');
      memo1.Lines.Add('		paramMap.put(TENANT_ID, '+LowerCase(Txt)+'Request.getTenant().getId());');
      memo1.Lines.Add('		paramMap.put(CREATEUSER, '+LowerCase(Txt)+'Request.getUserContext().getUserId());');
      memo1.Lines.Add('		paramMap.put(AUTO'+UpperCase(Txt)+', false);');
      memo1.Lines.Add('');
      memo1.Lines.Add('		'+LowerCase(Txt)+'.setId((Integer)doQueryForObject(getSqlSession(), INSERT_'+UpperCase(Txt)+', paramMap));');
      memo1.Lines.Add('		InternalResultsResponse<'+BrvFuncoesXE.PrimeiraMaiscula(Txt)+'> response = new InternalResultsResponse<'+BrvFuncoesXE.PrimeiraMaiscula(Txt)+'>();');
      ...
      memo1.Lines.Add('	/* ');
      memo1.Lines.Add('	 * (non-Javadoc)');
      memo1.Lines.Add('	 * @see com.sensus.mlc.'+LowerCase(Txt)+'.dao.I'+BrvFuncoesXE.PrimeiraMaiscula(Txt)+'DAO#fetch'+BrvFuncoesXE.PrimeiraMaiscula(Txt)+'ById(com.sensus.mlc.'+LowerCase(Txt)+'.model.request.'+BrvFuncoesXE.PrimeiraMaiscula(Txt)+'Request)');
      memo1.Lines.Add('	 */ ');
      memo1.Lines.Add('	@Override ');
      ...
      memo1.Lines.Add('	{');
      memo1.Lines.Add('		InternalResultsResponse<'+BrvFuncoesXE.PrimeiraMaiscula(Txt)+'> response = new InternalResultsResponse<'+BrvFuncoesXE.PrimeiraMaiscula(Txt)+'>();');
      memo1.Lines.Add('		doQueryForList(getSqlSession(), FETCH_'+UpperCase(Txt)+'_BY_ID, '+LowerCase(Txt)+'Request.get'+BrvFuncoesXE.PrimeiraMaiscula(Txt)+'(), response);');
      memo1.Lines.Add('		return response;');
      memo1.Lines.Add('	}');
      memo1.Lines.Add('');
      memo1.Lines.Add('	/*');
      memo1.Lines.Add('	 * (non-Javadoc) ');
      memo1.Lines.Add('	 * @see com.sensus.mlc.'+LowerCase(Txt)+'.dac.I'+BrvFuncoesXE.PrimeiraMaiscula(Txt)+'DAC#fetch'+BrvFuncoesXE.PrimeiraMaiscula(Txt)+'NameById(com.sensus.mlc.'+LowerCase(Txt)+'.model.request.'+BrvFuncoesXE.PrimeiraMaiscula(Txt)+'Request)');
      memo1.Lines.Add('	 */ ');
      memo1.Lines.Add('	@Override ');
      memo1.Lines.Add('	public InternalResultsResponse<'+BrvFuncoesXE.PrimeiraMaiscula(Txt)+'> fetch'+BrvFuncoesXE.PrimeiraMaiscula(Txt)+'NameById('+BrvFuncoesXE.PrimeiraMaiscula(Txt)+'Request '+LowerCase(Txt)+'Request)');
      memo1.Lines.Add('	{');
      memo1.Lines.Add('		InternalResultsResponse<'+BrvFuncoesXE.PrimeiraMaiscula(Txt)+'> response = new InternalResultsResponse<'+BrvFuncoesXE.PrimeiraMaiscula(Txt)+'>();');
      memo1.Lines.Add('		doQueryForList(getSqlSession(), FETCH_'+UpperCase(Txt)+'_NAME_BY_ID, '+LowerCase(Txt)+'Request.get'+BrvFuncoesXE.PrimeiraMaiscula(Txt)+'(), response);');
      memo1.Lines.Add('		return response;');
      memo1.Lines.Add('	}');
      memo1.Lines.Add(' ');
      memo1.Lines.Add('	/* ');
      ...
      memo1.Lines.Add('			response.addMessage(SENSUS_MLC_'+UpperCase(Txt)+'VALIDATOR_'+UpperCase(Txt)+'_ALREADY_EXISTS, MessageSeverity.Info, MessageLevel.None);');
      memo1.Lines.Add('		}');
      memo1.Lines.Add('');
      memo1.Lines.Add('		return response;');
      memo1.Lines.Add('	}');
...
begin
      ...
      memo1.Lines.Add('');
      memo1.Lines.Add('	/**  The Constant LIGH_ALREADY_IN_THE_'+UpperCase(Txt)+'. */ ');
      memo1.Lines.Add('	private static final String LIGHT_ALREADY_IN_'+UpperCase(Txt)+' = "sensus.mlc.'+LowerCase(Txt)+'validator.light.already.exist";');
      memo1.Lines.Add('');
      memo1.Lines.Add('	/**  The Constant DESCRIPTION_LABEL_KEY_ADD_SMP_TO_'+UpperCase(Txt)+'. */ ');
      memo1.Lines.Add('	private static final String DESCRIPTION_LABEL_KEY_ADD_SMP_TO_'+UpperCase(Txt)+' = "sensus.mlc.mlc_action.add_smp_to_'+LowerCase(Txt)+'";');
      memo1.Lines.Add('');
      ...
      memo1.Lines.Add('			"sensus.mlc.mlc_action.add_smp_to_'+LowerCase(Txt)+'_by_poleid";');
      memo1.Lines.Add('');
      ...
      memo1.Lines.Add('');
      memo1.Lines.Add('	/**  The Constant '+UpperCase(Txt)+'_BCL_BEAN. */ ');
      memo1.Lines.Add('	private static final String '+UpperCase(Txt)+'_BCL_BEAN = "'+LowerCase(Txt)+'BCLTarget";');
      memo1.Lines.Add('');
      memo1.Lines.Add('	/** ');
      ...
      memo1.Lines.Add('	/* ');
      memo1.Lines.Add('	 * (non-Javadoc) ');
      memo1.Lines.Add('	 * @see com.sensus.mlc.'+LowerCase(Txt)+'.bcl.I'+BrvFuncoesXE.PrimeiraMaiscula(Txt)+'BCL#fetch'+BrvFuncoesXE.PrimeiraMaiscula(Txt)+'ByName(com.sensus.mlc.'+LowerCase(Txt)+'.model.request.'+BrvFuncoesXE.PrimeiraMaiscula(Txt)+'Request)  ');
      memo1.Lines.Add('	 */ ');
      memo1.Lines.Add('	@Override  ');
      memo1.Lines.Add('	public InternalResultsResponse<'+BrvFuncoesXE.PrimeiraMaiscula(Txt)+'> fetch'+BrvFuncoesXE.PrimeiraMaiscula(Txt)+'ByName('+BrvFuncoesXE.PrimeiraMaiscula(Txt)+'Request '+LowerCase(Txt)+'Request) ');
      memo1.Lines.Add('	{  ');
      memo1.Lines.Add('		return get'+BrvFuncoesXE.PrimeiraMaiscula(Txt)+'DAC().fetch'+BrvFuncoesXE.PrimeiraMaiscula(Txt)+'ByName('+LowerCase(Txt)+'Request);');
      memo1.Lines.Add('	} ');
      memo1.Lines.Add('');
      memo1.Lines.Add('	/*  ');
      memo1.Lines.Add('	 * (non-Javadoc)  ');
      ...
      memo1.Lines.Add('');
      memo1.Lines.Add('		InternalResultsResponse<Process> processResponse =  ');
      memo1.Lines.Add('				this.insertProcess('+LowerCase(Txt)+'Request, LCActionTypeEnum.DELETE_'+UpperCase(Txt)+', null);');
      memo1.Lines.Add('		'+LowerCase(Txt)+'Request.getSearchLight().getSearchParameters().remove('+LowerCase(Txt)+'Parameter);');
      memo1.Lines.Add('');
      ...
      memo1.Lines.Add('		Integer lightAmount = getSmartPointAccessorBCL().countLights(lightRequest).getFirstResult();');
      memo1.Lines.Add('');
...
begin
      ...
      memo1.Lines.Add('	 */ ');
      memo1.Lines.Add('	@Override ');
      memo1.Lines.Add('	public '+BrvFuncoesXE.PrimeiraMaiscula(Txt)+'Response fetch'+BrvFuncoesXE.PrimeiraMaiscula(Txt)+'ByName('+BrvFuncoesXE.PrimeiraMaiscula(Txt)+'Request '+LowerCase(Txt)+'Request');
      memo1.Lines.Add('	{  ');
      ...
      memo1.Lines.Add('					&& get'+BrvFuncoesXE.PrimeiraMaiscula(Txt)+'ValidationController().validate(context))   ');
      memo1.Lines.Add('			{   ');
      memo1.Lines.Add('				context.getValidationArguments().put(getSlcActionName(), ADD_SMP_TO_'+UpperCase(Txt)+');');
      memo1.Lines.Add('				context.putObjectToBeValidated(LIGHT_LIST.getValue(), '+LowerCase(Txt)+'Request.get'+BrvFuncoesXE.PrimeiraMaiscula(Txt)+'().getLights());');
      memo1.Lines.Add('   ');
      ...
      memo1.Lines.Add('		catch (Exception ex) ');
      memo1.Lines.Add('		{');
      memo1.Lines.Add('			handleException(LOG, response, ex, DEFAULT_'+UpperCase(Txt)+'_BCF_EXCEPTION_MSG);');
      memo1.Lines.Add('		} ');
      memo1.Lines.Add('');
      memo1.Lines.Add('		return response;');
      memo1.Lines.Add('	}');
