...
Resourcestring
  ...
  rsExportingDataSet = 'Exportação de dados definido';
  ...
  rsTrue = 'True';
  rsFalse = 'False';
  rsExportCaption = 'Exportar';
  rsExport = '&Export';
  rsCancel = '&Cancelar';
  rsCreated = 'Created:';
  rsProcessing = 'Processing...';
  rsSelectFormat = 'Formatos de e&xportação:';
  rsCopiedToClipboard = 'Data was copied to clipboard!';
  rsExportToFile = 'Expor&tar para arquivo';
  rsViewOnly = '&Ver apenas';
  rsTempPrefix = 'MX';
      ...
      Case FExportType Of
        ...
        xtHTML:
          Begin
            ...
            TextOutput.Add( '  <META NAME = "Description" CONTENT = "www.maxcomponents.net" >' );
