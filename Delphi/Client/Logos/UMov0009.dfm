inherited Mov0009: TMov0009
  Left = 459
  Top = 176
  Caption = 'Mov0009 - Entrada de contas'
  ClientHeight = 369
  ClientWidth = 579
  ExplicitWidth = 587
  ExplicitHeight = 396
  ...
  inherited NavBarra: TBrvDbNavCop
    ...
    object BtnAbrEmp: TBrvSpeedButton
      Left = 3
      Top = 2
      Width = 25
      Height = 25
  ...
  inherited PnlFundo: TPanel
    ...
    object EdtNrConta: TBrvEditNum
      ...
      BrOnBeforeConsulta = EdtNrContaBrOnBeforeConsulta
      BrConfigurar.Strings = (
        'EdtNrConta;NrConta;S;S;'
        'LblNmConta;NmConta;S;N;')
    ...
    object EdtCdHistor: TBrvEditNum
      ...
      BrVisibleButton = True
      BrFunctionButton = TpConsulta
      BrOnBeforeConsulta = EdtCdHistorBrOnBeforeConsulta
      BrConfigurar.Strings = (
    ...
    object EdtCdTipo: TBrvEditNum
      ...
      BrFunctionButton = TpConsulta
      BrConfigurar.Strings = (
        'EdtCdTipo;CdForPag;S;S;'
        'LblDsTipo;DsForPag;S;N;'
        'LblTpForPag;TpForPag;S;N;')
      BrDicionario = DmSrvApl.BrvDicionario
      BrQueryCode = 40
      BrRecordar = False
    end
    object LblDsTipo: TBrvRetCon
      Left = 191
      Top = 187
      Width = 314
      Height = 19
    ...
    object EdtNrPreFat: TBrvEditNum
      Left = 96
      Top = 210
      Width = 50
      Height = 21
    ...
    object MetDtEmissa: TBrvEditDate
      Left = 96
      Top = 256
      Width = 87
      Height = 21
    ...
    object MetDtVencim: TBrvEditDate
      Left = 467
      Top = 256
      Width = 87
      Height = 21
  ...
  object PnlCabeca: TPanel [2]
    ...
    object CbxTpLancto: TBrvComboBox
      Left = 61
      Top = 28
      Width = 180
      Height = 21
