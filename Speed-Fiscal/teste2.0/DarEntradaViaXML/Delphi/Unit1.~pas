...
type
  TForm1 = class(TForm)
    ...
    trvwNFe: TTreeView;
    Database1: TDatabase;
    EntradasItens: TTable;
    Entradas: TTable;
    EntradasDcnumero: TFloatField;
    EntradasDcserie: TStringField;
    EntradasDcordem: TStringField;
    EntradasDctipo: TStringField;
    EntradasVlnota: TCurrencyField;
    EntradasVlicms: TCurrencyField;
    EntradasVlipi: TCurrencyField;
    EntradasVlfrete: TCurrencyField;
    EntradasCdfornecedor: TFloatField;
    ...
    EntradasNatureza: TFloatField;
    EntradasIdnfentradas: TIntegerField;
    EntradasVlst: TCurrencyField;
    EntradasTpsituacao: TStringField;
    Query1: TQuery;
    EntradasItensDcnumero: TFloatField;
    EntradasItensDcserie: TStringField;
    EntradasItensDcordem: TStringField;
    EntradasItensDctipo: TStringField;
    EntradasItensCdfornecedor: TFloatField;
    EntradasItensCdproduto: TFloatField;
    EntradasItensQuantidade: TFloatField;
    EntradasItensIpi: TCurrencyField;
    EntradasItensSt: TCurrencyField;
    EntradasItensIcms: TCurrencyField;
    EntradasItensVlunitario: TCurrencyField;
    EntradasItensVldesconto: TCurrencyField;
     ...
     begin
       ...
       trvwNFe.Items.AddChild(Node,'xMotivo= '   +procNFe.xMotivo);
      {
       ...
       //IcmsBase                        := Total.ICMSTot.vBC;
         ...
         query1.Active := False;
         query1.SQL.Text := 'Select *from cliente where cgc = '+Emit.CNPJCPF;
         query1.Active := True;
          ...
          with Det.Items[I] do
           begin
             ...
             try
              ...
              EntradasItensCdfornecedor.AsInteger  := query1.fieldbyname('codcli').AsInteger;
