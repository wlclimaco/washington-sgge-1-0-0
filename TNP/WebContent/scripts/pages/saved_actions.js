...
sensus.pages.saved.renderDeleteMessage = function() {
	...
	$('#delete-search-message').append($.sc.locale("searchdelete.warning.genericmessage", sensus.pages.saved.searchName));
...
sensus.pages.saved.dialogSettings = {
	...
	deleteSearch : {
		 ...
		 * The dialog title.
		 */
		title : $.sc.locale("action.deletesearch.title"),
		...
		buttons : (function() {
			var buttons = {};
			buttons[$.sc.locale("action.deletesearch.submit")] = function() {
				...
				sensus.util.ajaxaction.sendActionDefault($.sc.locale("action.deletesearch.success"), $.sc.locale("action.deletesearch.error"));

				sensus.pages.saved.savedId = 0;
			};
			buttons[$.sc.locale("action.deletesearch.cancel")] = function() {
				sensus.pages.saved.savedId = 0;
