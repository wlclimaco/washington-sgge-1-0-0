...
$(document).ready(function() {
	...
	sensus.pages.smartpoint.smartpointTable = $('#smartpoint-table').dataTable(sensus.widgets.datatable.setTable({
			...
			aColumns       : [
				...
				{sId : "RNI_ID",                        bEffectSortable: true,  sName : $.sc.locale(sMsg + '.flexnetid'),                  propertyRequest : "rniId",                                                                 sWidth : "5%"},
	          	{sId : "LAMP_TYPE",                     bEffectSortable: true,  sName : $.sc.locale(sMsg + '.lamptype'),                   propertyRequest : "lampTypeWattageDimmable",                   sWidth : "5%"},
	          	{sId : "DATE_ADDED",                    bEffectSortable: true,  sName : $.sc.locale(sMsg + '.added'),                      propertyRequest : "dateAdded[fn(sensus.pages.smartpoint.formatDateAdded)]",                                   sWidth : "5%"},
	          	{sId : "CITY_NAME",	                    bEffectSortable: true,  sName : $.sc.locale(sMsg + '.city'),                       propertyRequest : "cityName",                                    sWidth : "5%"},
	          	...
	          	{sId : "STATUS",                        bEffectSortable: true,  sName : $.sc.locale(sMsg + '.alertstatus'),                propertyRequest : "currentStatusMessage[fn(sensus.pages.smartpoint.processLightStatus)]",  sWidth : "5%"},
				{sId : "FIRMWARE_VERSION",              bEffectSortable: true,  sName : $.sc.locale(sMsg + '.firmwareversion'),            propertyRequest : "firmwareVersion",                             sWidth : "5%"},
				{sId : "MODEL_NUMBER",                  bEffectSortable: true,  sName : $.sc.locale(sMsg + '.modalnumber'),                propertyRequest : "modelNumber",                                 sWidth : "5%"},
				{sId : "COLOR_TEMPERATURE",             bEffectSortable: true,  sName : $.sc.locale(sMsg + '.colortemperature'),           propertyRequest : "colorTemperature",                            sWidth : "5%"},
				{sId : "HOUSING_COLOR",                 bEffectSortable: true,  sName : $.sc.locale(sMsg + '.housingcolor'),               propertyRequest : "housingColor",                                sWidth : "5%"},
				{sId : "INPUT_VOLTAGE_RANGE",           bEffectSortable: true,  sName : $.sc.locale(sMsg + '.voltagerange'),               propertyRequest : "inputVoltageRange",                          sWidth : "5%"},
				{sId : "BULB_SERIAL_NUMBER",            bEffectSortable: true,  sName : $.sc.locale(sMsg + '.bulbserialnumber'),           propertyRequest : "bulbSerialNumber",                           sWidth : "5%"},
				{sId : "SERIAL_NUMBER",                 bEffectSortable: true,  sName : $.sc.locale(sMsg + '.lightdriverserialnumber'),    propertyRequest : "lightDriverSerialNumber",                   sWidth : "5%"},
				{sId : "LOWER_ASSEMBLY_SERIAL_NUMBER",  bEffectSortable: true,  sName : $.sc.locale(sMsg + '.lowerassemblyserialnumber'),  propertyRequest : "lowerAssemblySerialNumber",                 sWidth : "5%"},
				{sId : "UPPER_ASSEMBLY_SERIAL_NUMBER",  bEffectSortable: true,  sName : $.sc.locale(sMsg + '.upperassemblyserialnumber'),  propertyRequest : "upperAssemblySerialNumber",                 sWidth : "5%"},
	...
	objViews.find("label").click(function() {
		...
		if ($(this).prev().hasClass("list")) {
			...
			sensus.util.mapopen.oRequest =  new inquiryLightRequest(oSearch) ;
