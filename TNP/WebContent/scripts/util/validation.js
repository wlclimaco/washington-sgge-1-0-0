...
}, $.sc.locale("validation.date.invalidformat", $.format($.parseDate("02/12/2002", sensus.settings.dateFormatMask), "d")));
...
}, $.sc.locale("validation.time.invalidformat", $.format($.parseDate("8:45 pm", "h:mm t"), "t")));