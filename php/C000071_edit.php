...
$templatefile = ($inlineedit == EDIT_INLINE) ? "C000071_inline_edit.htm" : "C000071_edit.htm";
...
if ($IsSaved && no_output_done() && $inlineedit == EDIT_SIMPLE)
{
	...
	// redirect
	header("Location: C000071_".$pageObject->getPageType().".php?".$keyGetQ);
...
//	CONTATO - 
	...
	$showValues["CONTATO"] = $value;
	$showFields[] = "CONTATO";
		$showRawValues["CONTATO"] = substr($data["CONTATO"],0,100);
...
//	DIA_PGTO - 
	...
	$showValues["DIA_PGTO"] = $value;
	$showFields[] = "DIA_PGTO";
		$showRawValues["DIA_PGTO"] = substr($data["DIA_PGTO"],0,100);

//	CNPJ - 
	$value = $pageObject->showDBValue("CNPJ", $data, $keylink);
	$showValues["CNPJ"] = $value;
	$showFields[] = "CNPJ";
		$showRawValues["CNPJ"] = substr($data["CNPJ"],0,100);

//	IE - 
	$value = $pageObject->showDBValue("IE", $data, $keylink);
	$showValues["IE"] = $value;
	$showFields[] = "IE";
		$showRawValues["IE"] = substr($data["IE"],0,100);
...
//	DIA_FECHAMENTO - 
	...
	$showValues["DIA_FECHAMENTO"] = $value;
	$showFields[] = "DIA_FECHAMENTO";
		$showRawValues["DIA_FECHAMENTO"] = substr($data["DIA_FECHAMENTO"],0,100);

//	DIA_PAGAMENTO - 
	$value = $pageObject->showDBValue("DIA_PAGAMENTO", $data, $keylink);
	$showValues["DIA_PAGAMENTO"] = $value;
	$showFields[] = "DIA_PAGAMENTO";
		$showRawValues["DIA_PAGAMENTO"] = substr($data["DIA_PAGAMENTO"],0,100);

//	LIMITE - Number
	$value = $pageObject->showDBValue("LIMITE", $data, $keylink);
	$showValues["LIMITE"] = $value;
	$showFields[] = "LIMITE";
		$showRawValues["LIMITE"] = substr($data["LIMITE"],0,100);
/////////////////////////////////////////////////////////////
//	start inline output
/////////////////////////////////////////////////////////////
...
$xt->assign("viewlink_attrs","id=\"viewButton".$id."\" name=\"viewButton".$id."\" onclick=\"window.location.href='C000071_view.php?".$viewlink."'\"");
