...
$layout->blocks["top"][] = "export";$page_layouts["C000009_export"] = $layout;
...
$xt->display("C000009_export.htm");

function ExportToExcel_old($cipherer)
{
	global $cCharset;
	header("Content-Type: application/vnd.ms-excel");
	header("Content-Disposition: attachment;Filename=C000009.xls");
...
function ExportToWord($cipherer)
{
	...
	header("Content-Disposition: attachment;Filename=C000009.doc");
...
function ExportToXML($cipherer)
{
	...
	header("Content-Disposition: attachment;Filename=C000009.xml");
	...
	while((!$nPageSize || $i<$nPageSize) && $row)
	{
		$values = array();
			...
			$values["FANTASIA"] = $pageObject->showDBValue("FANTASIA", $row);
			...
			$values["CONTATO1"] = $pageObject->showDBValue("CONTATO1", $row);
			$values["CONTATO2"] = $pageObject->showDBValue("CONTATO2", $row);
			$values["CELULAR1"] = $pageObject->showDBValue("CELULAR1", $row);
			$values["CELULAR2"] = $pageObject->showDBValue("CELULAR2", $row);
			$values["EMAIL"] = $pageObject->showDBValue("EMAIL", $row);
			$values["HOMEPAGE"] = $pageObject->showDBValue("HOMEPAGE", $row);
			$values["CNPJ"] = $pageObject->showDBValue("CNPJ", $row);
			$values["IE"] = $pageObject->showDBValue("IE", $row);
			$values["IM"] = $pageObject->showDBValue("IM", $row);
...
function ExportToCSV($cipherer)
{
	...
	header("Content-Disposition: attachment;Filename=C000009.csv");
...
// write data rows
	...
	while((!$nPageSize || $iNumberOfRows < $nPageSize) && $row)
	{
		$values = array();
			...
			$values["FANTASIA"] = $pageObject->getViewControl("FANTASIA")->showDBValue($row, "");
			...
			$values["CONTATO1"] = $pageObject->getViewControl("CONTATO1")->showDBValue($row, "");
			$values["CONTATO2"] = $pageObject->getViewControl("CONTATO2")->showDBValue($row, "");
			$values["CELULAR1"] = $pageObject->getViewControl("CELULAR1")->showDBValue($row, "");
			$values["CELULAR2"] = $pageObject->getViewControl("CELULAR2")->showDBValue($row, "");
			$values["EMAIL"] = $pageObject->getViewControl("EMAIL")->showDBValue($row, "");
			$values["HOMEPAGE"] = $pageObject->getViewControl("HOMEPAGE")->showDBValue($row, "");
			$values["CNPJ"] = $pageObject->getViewControl("CNPJ")->showDBValue($row, "");
			$values["IE"] = $pageObject->getViewControl("IE")->showDBValue($row, "");
			$values["IM"] = $pageObject->getViewControl("IM")->showDBValue($row, "");
		...
		if ($eventRes)
		{
			...
			if($outstr!="")
				$outstr.=",";
			$outstr.='"'.str_replace('"', '""', $values["FANTASIA"]).'"';
			if($outstr!="")
				$outstr.=",";
			...
			if($outstr!="")
				$outstr.=",";
			$outstr.='"'.str_replace('"', '""', $values["CONTATO1"]).'"';
			if($outstr!="")
				$outstr.=",";
			$outstr.='"'.str_replace('"', '""', $values["CONTATO2"]).'"';
			if($outstr!="")
				$outstr.=",";
			$outstr.='"'.str_replace('"', '""', $values["CELULAR1"]).'"';
			if($outstr!="")
				$outstr.=",";
			$outstr.='"'.str_replace('"', '""', $values["CELULAR2"]).'"';
			if($outstr!="")
				$outstr.=",";
			$outstr.='"'.str_replace('"', '""', $values["EMAIL"]).'"';
			if($outstr!="")
				$outstr.=",";
			$outstr.='"'.str_replace('"', '""', $values["HOMEPAGE"]).'"';
			if($outstr!="")
				$outstr.=",";
...
// write header
	...
	if($_REQUEST["type"]=="excel")
	{
		...
		echo '<td style="width: 100" x:str>'.PrepareForExcel("Nome Fantasia").'</td>';	
		...
		echo '<td style="width: 100" x:str>'.PrepareForExcel("Contato1").'</td>';	
		echo '<td style="width: 100" x:str>'.PrepareForExcel("Contato2").'</td>';	
		echo '<td style="width: 100" x:str>'.PrepareForExcel("Celular1").'</td>';	
		echo '<td style="width: 100" x:str>'.PrepareForExcel("Celular2").'</td>';	
		echo '<td style="width: 100" x:str>'.PrepareForExcel("E-Mail").'</td>';	
		echo '<td style="width: 100" x:str>'.PrepareForExcel("HOMEPAGE").'</td>';	
		echo '<td style="width: 100" x:str>'.PrepareForExcel("CNPJ").'</td>';	
		echo '<td style="width: 100" x:str>'.PrepareForExcel("IE").'</td>';	
		echo '<td style="width: 100" x:str>'.PrepareForExcel("IM").'</td>';	
		...
		if ($eventRes)
		{
			...
			echo '</td>';
					...
					echo '<td>';
									...
									if($_REQUEST["type"]=="excel")
						echo PrepareForExcel($values["FANTASIA"]);
					else
						echo $values["FANTASIA"];
			echo '</td>';
							if($_REQUEST["type"]=="excel")
					echo '<td x:str>';
				else
			...
			echo '</td>';
					...
					echo '<td>';
									...
									if($_REQUEST["type"]=="excel")
						echo PrepareForExcel($values["CONTATO1"]);
					else
						echo $values["CONTATO1"];
			echo '</td>';
							if($_REQUEST["type"]=="excel")
					echo '<td x:str>';
				else
					echo '<td>';
									...
									if($_REQUEST["type"]=="excel")
						echo PrepareForExcel($values["CONTATO2"]);
					else
						echo $values["CONTATO2"];
			echo '</td>';
							if($_REQUEST["type"]=="excel")
					echo '<td x:str>';
				else
					echo '<td>';
									...
									if($_REQUEST["type"]=="excel")
						echo PrepareForExcel($values["CELULAR1"]);
					else
						echo $values["CELULAR1"];
			echo '</td>';
							if($_REQUEST["type"]=="excel")
					echo '<td x:str>';
				else
					echo '<td>';
									...
									if($_REQUEST["type"]=="excel")
						echo PrepareForExcel($values["CELULAR2"]);
					else
						echo $values["CELULAR2"];
			echo '</td>';
							if($_REQUEST["type"]=="excel")
					echo '<td x:str>';
				else
			...
			echo '</td>';
					...
					echo '<td>';
									...
									if($_REQUEST["type"]=="excel")
						echo PrepareForExcel($values["HOMEPAGE"]);
					else
						echo $values["HOMEPAGE"];
			echo '</td>';
							if($_REQUEST["type"]=="excel")
					echo '<td x:str>';
				else
			...
			echo '</td>';
					...
					echo '<td>';
									...
									if($_REQUEST["type"]=="excel")
						echo PrepareForExcel($values["IM"]);
					else
						echo $values["IM"];
			echo '</td>';
							if($_REQUEST["type"]=="excel")
