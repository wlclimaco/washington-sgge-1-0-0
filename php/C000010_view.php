...
$layout->blocks["top"][] = "details";$page_layouts["C000010_view"] = $layout;
...
if (!sizeof($data)) {
	header("Location: C000010_list.php?a=return");
	exit();
}
...
$xt->assign("editlink_attrs","id=\"editLink".$id."\" name=\"editLink".$id."\" onclick=\"window.location.href='C000010_edit.php?".$editlink."'\"");
