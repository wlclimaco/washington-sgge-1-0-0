...
$templatefile = ($inlineedit == EDIT_INLINE) ? "C000008_inline_edit.htm" : "C000008_edit.htm";
...
if ($IsSaved && no_output_done() && $inlineedit == EDIT_SIMPLE)
{
	...
	// redirect
	header("Location: C000008_".$pageObject->getPageType().".php?".$keyGetQ);
...
//	FUNCAO - 
	...
	$showValues["FUNCAO"] = $value;
	$showFields[] = "FUNCAO";
		$showRawValues["FUNCAO"] = substr($data["FUNCAO"],0,100);

//	DATA_ADMISSAO - Short Date
	$value = $pageObject->showDBValue("DATA_ADMISSAO", $data, $keylink);
	$showValues["DATA_ADMISSAO"] = $value;
	$showFields[] = "DATA_ADMISSAO";
		$showRawValues["DATA_ADMISSAO"] = substr($data["DATA_ADMISSAO"],0,100);

//	DATA_DEMISSAO - Short Date
	$value = $pageObject->showDBValue("DATA_DEMISSAO", $data, $keylink);
	$showValues["DATA_DEMISSAO"] = $value;
	$showFields[] = "DATA_DEMISSAO";
		$showRawValues["DATA_DEMISSAO"] = substr($data["DATA_DEMISSAO"],0,100);
...
//	COMISSAO - Number
	...
	$showValues["COMISSAO"] = $value;
	$showFields[] = "COMISSAO";
		$showRawValues["COMISSAO"] = substr($data["COMISSAO"],0,100);
...
$xt->assign("viewlink_attrs","id=\"viewButton".$id."\" name=\"viewButton".$id."\" onclick=\"window.location.href='C000008_view.php?".$viewlink."'\"");
