		...
		buttons : [{
				...
				click  : function() {
					...
					if (bValidValue && bValidDate) {
						...
						$.ajaxValidator.fnMonitor("/Dicionario/util/ajax.controlLights.action", oRequest, false, fnCallBack, $.sc.locale("action.longRunningProcessDialog.confirm"), bMonitor);
...
*/
		...
		action : function(actionDialog) {
			...
			if (bLightList) {
				...
				actionDialog.empty().load("/Dicionario/util/include.controlLight.action" + "?_" + Math.random(), function() {
