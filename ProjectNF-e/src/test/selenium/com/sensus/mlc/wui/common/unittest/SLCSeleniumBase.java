...
/**
 * Base level class for all Dicionario Selenium tests.
 * Place common functionality in this class so it can be leveraged by sub-classes.
 */
public class DicionarioSeleniumBase extends SeleniumBase
{

	/** The Constant LOG. */
	private static final Log LOG = LogFactory.getLog(DicionarioSeleniumBase.class);

	/**
	 * Instantiates a new Dicionario selenium base.
	 *
	 * @throws Exception the exception
	 */
	public DicionarioSeleniumBase() throws Exception
	{
		super.setUpSelenium() ;
